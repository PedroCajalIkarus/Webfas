  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>SKU Done by Date Range </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">SKU Done by Date Range</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <section class="col-lg-4 connectedSortable ui-sortable">
            ...
            <div class="card-footer">
                 ...
                 <button type="button" onclick="mostrar_sku_done($('#daterangem').val())" class="btn btn-block btn-outline-primary btn-xs float-right">Search</button>
               </div>
				</div>
			</div>
		...
		<section class="col-lg-8 connectedSortable ui-sortable">
                ...
                <div id="viewdatesku" name="viewdatesku">
              </div>
...
<script type="text/javascript">
   ...
   function mostrar_sku_done(daterange)
{
 

	console.log('recibido:'+ daterange);
	var ressultspli = daterange.split(',');
  console.log('recibido 1:'+ ressultspli[0]);
		$('#msjwaitline ').show();

	var armando_tabla= '';
	var laurl='listskudon.php?fi='+ressultspli[0]+'&ff='+ressultspli[1];
	...
	console.log(laurl);
								$.ajax({
										...
										$('#msjwaitline ').hide();
											$('#viewdatesku').html(""+armando_tabla);
											return false;
										},
										error: function() {
