  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="error-page">
        <h2 class="headline text-warning"> 3008</h2>

        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Access not enabled.</h3>

          <p>
		  <?php
		  echo "the user: ".$_REQUEST["b"]." cannot access the menu: ".$_REQUEST['c'].", contact the webfas administrator";
		    ...
		    /*
					...
					//Set who the message is to be sent to
						$mail->addAddress('agustin.corigliano@fiplex.com', 'DEVELOPMENT');
							  ...
							  $mail->Subject = "WEBFAS::Access not enabled";
							  $mail->Body = "attention,Access not enabled, the user: ".$_REQUEST["b"]." cannot access the menu: ".$_REQUEST['c'];
							//Definimos AltBody por si el destinatario del correo no admite email con formato html 
							  $mail->AltBody = "attention,Access not enabled, the user: ".$_REQUEST["b"]." cannot access the menu: ".$_REQUEST['c'];
