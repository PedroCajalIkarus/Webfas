                                    ...
                                    <div class="card">
                                        <p align="right">
                                            <span align="left">
                                                <a href="#" onclick="createtk()" style="color:#0053a1;">&nbsp;<i
                                                        ...
                                                        style='font-size:22px;color:#FFFF00;'></i>&nbsp;<b>Missing
                                                        WO?</b></a> &nbsp;&nbsp;
                                            </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                            <a href="generawororder.php" style="color:#0053a1;"><i
                                                    class='fas fa-plus-circle'
                                                    style='font-size:24px;color:#0053a1;'></i>Create New Work Orders</a>
                                            &nbsp;&nbsp;
                                        </p>
                                        &nbsp;&nbsp;&nbsp;<b> Enter the PO / WO / SerialNumber to search for and hit enter</b>
                                        ...
                                        <form action="listwordorder.php" method="post" class="form-horizontal"
                                            ...
                                            <input class="form-control" id="poselecmrev" type="hidden"
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputweek" type="text" onkeypress="handleKeyPress(event,1)"  onblur="searchwoweek()" placeholder="Search this week">
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputmonth" type="text" onkeypress="handleKeyPress(event,2)" onblur="searchwomonth()" placeholder="Search this month">
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputall" type="text" onkeypress="handleKeyPress(event,3)" onblur="searchwoall()" placeholder="Search all">
                                                    </div>
                                                </div>
                                            <!--- demo acordion--->
...
<script>
// Script mio
    function searchwoweek() {
    var inputValue = document.getElementById('myInputweek').value;
        date = "  ((prestatus.datestate > now() -' 7 day'::INTERVAL) ) and"
            $.ajax({
                url: 'searchwo.php', 
                type: 'POST',
    ...
    function searchwomonth() {
        var inputValue = document.getElementById('myInputmonth').value;
            date = "  ((prestatus.datestate > now() -' 30 day'::INTERVAL) ) and"
                $.ajax({
                    url: 'searchwo.php', 
                    type: 'POST',
                    data: { search: inputValue, date: date },
                                                                ...
                                                                <ul class="nav nav-pills ml-auto">
                                                                    <li class="nav-item" name="divgeneralinfo"
                                                                        ...
                                                                        <a class="nav-link active" href="#generalinfopo"
                                                                            data-toggle="tab">Info Work Order</a>
                                                                    </li>
                                                                    <li class="nav-item" name="divgeneralinfoparam"
                                                                        id="divgeneralinfoparam">
                                                                        <a class="nav-link" href="#editparampo"
                                                                            data-toggle="tab">Edit Parameters WO</a>
                                                                    </li>
...
function handleKeyPress(event, idtipesarch) {
            if (event.keyCode === 13) {
               if (idtipesarch==1)
               {
                searchwoweek();
