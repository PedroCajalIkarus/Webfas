...
exit();
	...
	{
		if ($rowheadersnomband['modelciu'] =="FIP446")
		{
			$nombreband_0="700 FirstNet";
			$nombreband_1="800";
		}
		if ($rowheadersnomband['modelciu'] =="FIP467")
		{
			$nombreband_0="VHF";
			$nombreband_1="UHF";
													 ...
													 foreach ($datalsgp as $rowlsgp1) 
														  {
																...
																echo "<br>Gain toool:::".$query_lista5a."<br>";
														...
														foreach ($datalsgp as $rowlsgp6) 
														  {
															   ...
															   $arrayfreqpwr[] =round($rowlsgp6['freq'],1); 
																...
																echo "fas_ucmeasures PWR::".$query_lista5b."<br>";
	...
	<td>&nbsp;&nbsp;</td>
		...
		<td class='text-left'>".$array_finalchk_gain_mkrmeasurewr[$mi]." [dBm]</td>
					...
					?>   		  					  
					 	...
					 	<tr>
                      <td class="table-dark text-left">Max Pwr 2222</td>
                      <?php
