...
if (isset($_POST['txtpreguntas110']))
	{
...
//   print_r($_POST);
    ...
    try {
          ...
          $v_resp1 = $_REQUEST['txtpreguntas110'];
          $v_resp2 = $_REQUEST['txtpreguntas111'];
          $v_resp3 = $_REQUEST['txtpreguntas112'];
          $v_resp4 = $_REQUEST['txtpreguntas113'];
          $v_resp5 = $_REQUEST['txtpreguntas114'];
          $v_resp6 = $_REQUEST['txtpreguntas29'];
          $v_resp7 = $_REQUEST['txtpreguntas115'];
          ...
          $search = array("'");
          $v_resp1corre = str_replace($search, "", $_REQUEST['txtcorre110']); 
          $v_resp2corre = str_replace($search, "", $_REQUEST['txtcorre111']); 
          $v_resp3corre = str_replace($search, "", $_REQUEST['txtcorre112']); 
          $v_resp4corre = str_replace($search, "", $_REQUEST['txtcorre113']); 
          $v_resp5corre = str_replace($search, "", $_REQUEST['txtcorre114']); 
          $v_resp6corre = str_replace($search, "", $_REQUEST['txtcorre29']); 
          $v_resp7corre = str_replace($search, "", $_REQUEST['txtcorre115']); 
     ...
     //     echo  $query_lista2;
            ...
            $vdescripaudit="FinalInspection - SN:".$v_sn."-SO:".$v_so."-CIU:".$v_ciu;		
          ...
          //////outcome integral///////////////////////////////////////////////////////////////////////////////
                ...
                $_idruninfo_reference =0;
                  ...
                  $query="call sp_update_runinfo_log (".$_idruninfo_reference.",'  Execute Action PRECHECK - Final Inspection in WEBFAS\n')  "; $querySQL = $connect->prepare($query);	$querySQL->execute();
                  $query="call sp_update_runinfo_log (".$_idruninfo_reference.",'  ----------------------------------------- \n')  "; $querySQL = $connect->prepare($query);	$querySQL->execute();
...
where wo_serialnumber = '". trim($elsn)."' and typeregister in ('WO','SO' )";
//   echo $sqlpdf;
                ...
                //      echo "cant regitro".$cantderegistro;
                  ...
                  ?>
                                    ...
                                    <button name="btnopenrf" id="btnopenrf" type="button"
                                        ...
                                        onclick="opendiv('tablehistotyprecheck')">Show FinalCheck history</button>
                                    <br>
                           ...
                           if ($vidsurveyresponse ==0 && $_REQUEST['eyeid']=="" || $_REQUEST['eyeid']==$row['idsurveyresponse'])
                           {
                            ...
                            ?>
                                                    <tr>
                                                        <td><?php echo  $row['sn']; ?>
                                                            &nbsp;&nbsp; <a
                                                                href='surveyfinalcheck.php?elsn=<?php echo $row['sn']; ?>&elso=<?php echo $row['so']; ?>&elciu=<?php echo $row['modelciu']; ?>&eyeid=<?php echo $row['idsurveyresponse']; ?>'><i
                                                                    class='fas fa-eye'
...
$idnumerador = 1;
    ...
    ?> <tr>
                                                    <th scope="row">
                                                        <?php echo $idnumerador;  $idnumerador = $idnumerador + 1;//$row['idquestion']; ?>
                                                    </th>
                                                    <td><span
...
function enviar_encu(tipostatus) {
    ...
    var hagosubmit = 'S';
    var radioValue1 = $("input[name='txtpreguntas110']:checked").val();
    if (radioValue1) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue2 = $("input[name='txtpreguntas111']:checked").val();
    if (radioValue2) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue3 = $("input[name='txtpreguntas112']:checked").val();
    if (radioValue3) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue4 = $("input[name='txtpreguntas113']:checked").val();
    if (radioValue4) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue5 = $("input[name='txtpreguntas114']:checked").val();
    if (radioValue5) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue6 = $("input[name='txtpreguntas29']:checked").val();
    if (radioValue6) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    }
    var radioValue7 = $("input[name='txtpreguntas115']:checked").val();
    if (radioValue7) {
        ///  alert("Your are a - " + radioValue);
    } else {
        hagosubmit = 'N';
    ...
    ///	toastr["error"]("Questions Bypassed", "Quality Calibration Precheck");
    if (hagosubmit == 'S') {
        document.frma.submit();
    } else {
