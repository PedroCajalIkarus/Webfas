<?php
 include("db_conect.php"); 
	...
	<table id='myTablecalibscripttime' border='1' class='table table-bordered table-sm texto10 scrolltablemarco table-striped '>
		...
		foreach ($data as $row) 
		{
			$v_data_eq = explode("#",$row['timescriptsteps']);
			...
			<tr data-rowa='0'>	
								...
								foreach($data as $i =>$keyaa) 		
								{
									...
									$tempabc=explode("#",$keyaa['timescriptsteps']);		
		...
		<?php
			...
			//echo "hola key.".$keyarray[0]."<br>".($keyarray[0]=="null" ? "NODATA" : $keyarray[0])."<br>";
				...
				?>
							...
							<tr data-rowa='1'><td data-rowa='1' data-cola='0'><b>Initial Procedure</b> </td>				
							<?php							
							...
							<tr data-rowa='1'><td data-rowa='1' data-cola='0'><b>Eq </b> </td>				
							<?php							
								for ($i_itera = 1; $i_itera <= $count_rows; $i_itera++) {
							...
							<tr data-rowa='1'><td data-rowa='1' data-cola='0'><b>Factory </b> </td>				
							<?php							
								for ($i_itera = 1; $i_itera <= $count_rows; $i_itera++) {
							...
							<tr data-rowa='1'><td data-rowa='1' data-cola='0'><b>Dry Contact Check</b> </td>				
							<?php							
								for ($i_itera = 1; $i_itera <= $count_rows; $i_itera++) {
							...
							<tr data-rowa='1'><td data-rowa='1' data-cola='0'><b>Final Check </b> </td>				
							<?php							
								for ($i_itera = 1; $i_itera <= $count_rows; $i_itera++) {
