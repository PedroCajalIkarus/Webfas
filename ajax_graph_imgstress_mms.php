...
error_reporting(0);
    include("db_conect.php"); 
		...
		////////////////////////    //////////////////////////////////
$sqlmmhead="
select distinct  bandnuevo, uldl  , iduniquebranch,   script,    timename, iduniqueop ,  pwr2  as arraypwr,duration,
...
,ARRAY_AGG (    round( CAST(pwr as numeric),2)  order by id_mkrmeasures asc ) as pwr2 
from
(
...
group  by bandnuevo, uldl  , iduniquebranch,   script,    timename, iduniqueop, pwr2, duration
