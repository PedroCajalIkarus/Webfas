        ...
        //      echo "Voy a controlar todo el ".$loscontroleshtml[1];
         //     echo "El valor de $clave es: $valor .<br><br>";
              ...
              $elciu= $_REQUEST['elciu'];
                ...
                $nuevonamecomp_ciu =   $_REQUEST['nuevonamecompciu_'.$loscontroleshtml[1]];
                ...
                $nuevonamecomp_ciu_descrip =  $_REQUEST['idprodcompdescrip'.$loscontroleshtml[1]];                                    
                                                        ...
                                                        <table class="table table-striped   ">
                                                            <thead class="thead-dark">
                                                                <tr>
                                                                    ...
                                                                    <td class="table-primary" scope="col"><b>Rev</b>
                                                                    </td>
                                        ...
                                        if ($vp_runinfo == 1) 
                                        {
                                          ?>
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control bloqueomm"
                                                                                value="<?php echo  $row['components_sn']; ?>"
...
///////////// end funcion 
          ...
          if ($cant_registros_xsn >0)
          {
            ...
            ?>
                                                    <div class="<?php echo  $divclassadd; ?>" id="divaddpicking"
                                                        name="divaddpicking">
                                                        <?php      
...
{
      $query_xm2024l ="select * from  products_components_critical where material = '".$v_ciu."'";
  //    echo  $query_xm2024l;
      ...
      foreach ($data2024 as $rowxml2024) 
      {
        $thesn_havecomponets ='Y';
        $immt++;
        Create_vinculation_sn_componetns($nroitempositio.$immt,$vvsn,$rowxml2024['component'],$rowxml2024['compdescrip']  );
        $nroitempositio = $nroitempositio+1;
...
if ($thesn_havecomponets =='N')
{
 ...
 ?>
              ...
              ?>
                                            ...
                                            <div class='container-fluid'>
                                                ...
                                                <button type="button" class="btn btn-block bg-gradient-primary btn-sm"
                                                    id="picking" name="picking" onclick="validar_envio()">Next</button>
                                            </div>
   ...
   //  echo "<br><br>Query link".$sqlattri;
                ...
                success: function(data) {
                 ...
                 /*       }
                        ...
                        if (chk_comp_sn == 1) {
                            ...
                            chk_idruninfo_status_sn(objdd.t_set, objdd.t_part, idcompparam);
                        } else {
    ...
    function chk_idruninfo_status_sn(sn, sku, idcomphtml) {
        console.log('Chk Status del SN in FAS:' + sn + '-sku:' + sku + '--idcomphtml:' + idcomphtml)


        $.ajax({
            url: 'ajax_chk_idruninfo_status_sn.php',
            data: "sn=" + sn + '&sku=' + sku + '&idcomphtml=' + idcomphtml,
            type: 'post',
            async: true,
            cache: false,
            success: function(data) {
