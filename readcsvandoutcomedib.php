            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Read CSV - Search OUTCOME</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">Read CSV Search OUTCOME </li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                                    ...
                                                    <?php
                                                        ...
                                                        //// Buscamoss cat y type
                                                                 ...
                                                                 $splicattipo = explode("#", $value  );
                                                                      ...
                                                                      $callsql= " select fnt_select_excel_info_by_idcatidtypedib ('".$sheet->getCell("D".$row)->getValue() ."','".$sheet->getCell("D".$row)->getValue() ."',".$splicattipo[1].",".$splicattipo[2].")";
                                                               // echo "<br>".$callsql;
