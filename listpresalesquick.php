...
Swal.fire({
    ...
    if (result.value) {
        window.location = "listpresalesquick.php";
    } else {
        window.location = "listpresalesquick.php";
    }
})
                            ...
                            <div class="" name="divscrolllog" id="divscrolllog" style="display">
                                ...
                                <div class="demo-container">
                                    ...
                                    <div class="card">
                                        ...
                                        <!-- aca form -->
                                        <form action="listpresalesquick.php" method="post" class="form-horizontal"
				...
				//		$queryquefiltramos=" and pre.date_approved > '".date(Y)."-01-01 00:00:00' ";
					...
					?>
                                            ...
                                            <div class="container-fluid ">
                                                <div class="row mb-3 ">
                                                    <div class="col-sm-10">
                                                        <input class="form-control col-md-12 form-control-sm"
							...
							{?>
                                                                <td class="font-weight-bold"><a href="#"
                                                                        ...
                                                                        title="View - Edit"><i class='far fa-edit'
                                                                            style='font-size:14px'></i></a> &nbsp&nbsp
                                                                    <a href="#" title="Delete?"
						...
						if( $row['issoblock']=="Yes")
						{
						   ?><span class='d-none'>CreditBlock</span>
                                                                    <i class='fas fa-exclamation-triangle'
                                                                        ...
                                                                        title='Credit Block' alt='Credit Block'></i>
                                                                    <?php
						   ...
						   else
						   {
							   ...
							   ?>
                                                                        <div class="progress-bar bg-secondary"
                                                                            style="width: 0%"><span class="text-info">
                                                                                Processed / Pend</span></div>
                                                                        <?php
								}
								else
								{
									if( $row['activeprod']=="S")
									{
										?>
                                                                        <div class="progress-bar bg-info"
                                                                            style="width: 0%"><span
                                                                                class="text-secondary"> No Further
                                                                                Action Required</div>
                                                                        <?php	
									}
									else
									{
										if ($row['haveupgrade']>0)
										{
											?>
                                                                        <div class="progress-bar bg-secondary"
                                                                            style="width: 0%"><span
                                                                                class="text-warning"> Pend. SN Assign
                                                                                for Upgrade <i
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.snasignados == null) {
                ...
                tabla_info_show_po = tabla_info_show_po + "<tr><th><b>SN LIST::" + $("#qeneslogin").val() +
                    "</b></th><td></td><td></td><td></td></tr>";
                $.each(data.snasignados, function(i, itemstock2) {
                    if ($("#qeneslogin").val() == 'develop' || 'Productionadmin' == $("#qeneslogin")
                        ...
                        tabla_info_show_po = tabla_info_show_po +
                            ...
                            '</b></th> <td colspan="2"> <a href="#" onclick="unlinkcustom(' + String
                            .fromCharCode(39) + itemstock2.wo_serialnumber + String.fromCharCode(
                                39) +
                            ')"> <span class="text-danger"> Unlink sn </span> </a>  </td></tr>';
                    } else {
                        tabla_info_show_po = tabla_info_show_po +
                            "<tr><th class='colorazulfiplex'><b>SN assigned: </b>  </th><th class='colorazulfiplex'><b>" +
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta.value = 'ok') {
                        ...
                        window.location.href = 'listpresalesquick.php';
                    }
                            ...
                            if (cb.attr('name').length > 8) {
                                if ('chkstock' == cb.attr('name').substring(0, 8)) {
                                    if ($("#" + cb.attr('name')).is(':checked')) {
                                        ...
                                        los_sn_seleccionados = los_sn_seleccionados + $("#" + cb.attr('name'))
                                            .val() + '#';
...
function unlinkcustom(vvsn) {

    var options = {
        message: "why do you want to unlink it?",
        title: 'Unlink SN',
        size: eModal.size.lg,
        subtitle: 'SN:' + vvsn
    ...
    eModal.prompt(options)
        .then(
            function(input) {
                console.log(input);
                var url = 'unlinksndevelop.php?snmm=' + vvsn + '&snmmde=' + input;
                console.log(url);
                $.ajax({
                    url: 'unlinksndevelop.php',
                    data: "snmm=" + vvsn + '&snmmde=' + input,
                    type: 'post',
                    datatype: 'JSON',
                    cache: false,
                    success: function(data, status, xhr) {
    ...
    ///  <a href='unlinksndevelop.php?snmm="+itemstock2.wo_serialnumber+"' >
