<?php
 ...
 $query_lista = "select distinct bandincome,	finalselect.idband,		uldl,	iduniquebranchsonprod,	namebranch,	namebusiness,	modelciu,	nameband,	idbusiness,
 finalselect.idproduct,	namefas_step,	idbandnn,	cat,	cattype,	id_income,		idscript,	in_instance,	idcategory,	idtype,	reference
 ,v_boolean,	v_integer,	v_double,	v_string,	v_datetime,	datetimeref
 
 
 from 
 (
	 select fas_income_integral.v_integer as idbandout,  d.idbandnn as idobj , idband.description as bandincome	 , fas_income_integral.reference as referencedd , fas_income_integral.v_integer as idband,  d.* from (
 ...
 idband.description as nameband,  productspp.idbusiness,  productspp.idproduct as idproduct1,    fas_step.description as namefas_step  ,
...
inner join idband 
on idband.idband = fas_income_integral.v_integer

order by modelciu, idbandnn
) as finalselect
left join bandgroups 
on bandgroups.idband = finalselect.idbandout
left join bandgroups as bandgroups2
on bandgroups2.idband = finalselect.idobj
where bandgroups.idbandgroup = bandgroups2.idbandgroup
...
//echo "1)-<br>".$query_lista;
 ...
 <th class="bg-primary "> Bands[ObjB] </th>
