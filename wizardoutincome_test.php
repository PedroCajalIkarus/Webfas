...
if($_POST)
	...
	//	$connect->beginTransaction();
		try {
				...
				/*
					$slqbandupd ="UPDATE fas_income_integral set ".$setear_sql1.$setear_sql2.$setear_sql3.$setear_sql4." where idfasoutcomecat = ".$idoutcomeaupdateear;
					echo "<br>".$slqbandupd ;
...
<form name="frma" id="frma" action="addreference_income.php" method="post" class="form-horizontal">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Wizard Products IN OUT COME  - SRV 10.4.253.20 TEST </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Wizard Products IN OUT COME  - SRV 10.4.253.20 TEST</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<td>
						...
						<option value=""> All Attributes </option>
												 <?php
																	 ...
																	 $indxtablaadd=0;
												 $sql = $connect->prepare("select * from products_attributes_type where idattribute IN(0,59,60,61,62,48)   order by attributename");
...
//	var losuldl =  $("#losuldl").val().toString();
	...
	console.log('losatributos'+ losatributos);
		...
		//	formData.append("lasmediciones", lasmediciones);
			...
			xhr2.open("POST", "searchcuicomponentfiltersinoutcome_test.php");
			xhr2.send(formData);
