...
<table class="table   table-bordered table-sm">
	...
	//echo "<br>final<br>".$sqlop_row."<br>fin";
        ...
        <?php } ?>
        <tr>
            <th rowspan="7" style='text-align: middle;'>Filter <?php echo $nro_of_filter; ?>
                <br>[<?php echo $freq_start." - ".$freq_stop; ?>]
                <br><?php echo $port_a_name."  <i class='fa fa-arrow-right'></i> ".$port_b_name; ?>
                <br><br>
                <p align="center">
...
$vt =0;
						       ...
						       ///   echo "<br>a ver aqui:".$signedUrl2;
									  ...
									  ?>
                        <li>
                            <img id="imgmc<?php echo $idmedicionind; ?>" name="imgmc<?php echo $idmedicionind; ?>"
                                data-original="<?php echo $signedUrl2;?>" src="<?php echo $signedUrl2;?>" width="100%"
                                class="md-none">
                        ...
                        <?php
									  ...
									  else
									  {
										  ?>
                        <li>
                            <img data-original="<?php echo $signedUrl2;?>" src="<?php echo $signedUrl2;?>" width="20%"
                                class="d-none">
...
function section_create_graph_VNA_by_idrun_sn_withoutplots($vp_runinfo,$v_sn,$idscript, $idinstance)
{
	...
	require 'aws/fplmm.php';
		...
		inner join 
		(
			select idruninfodb, max(idrev) as idrevm
			from fas_routines_process_sn
			where idruninfodb =".$vp_runinfo."
			group by idruninfodb
			
		) as max_rutina
		on  max_rutina.idruninfodb = fas_routines_process_sn.idruninfodb and 
			max_rutina.idrevm	   = fas_routines_process_sn.idrev
		inner join fas_routines_steps
		on fas_routines_steps.idstep = fas_routines_process_sn.idstep
		inner join fas_step
		on fas_step.instance = fas_routines_steps.instance
		where fas_routines_process_sn.idruninfodb =".$vp_runinfo." and iduniqueop > 0 and fas_step.instance  ='011093' order by idorder";
...
<div class="row">
    ...
    <div class="col-6  " id="divgrafico700imd0012" name="divgrafico700imd0012">
        ...
        <p class="  colorazulfiplex" style="font-size: 14px"><b>IMD <?php echo $name_graf; ?> DOWNLINK</b>
            &nbsp;&nbsp;<a href="#"
                onclick="abrirgaleria(<?php echo "'".$snmm."','00200701B',".$vp_runinfo.",".$idbandoffas; ?>)"><i
                    class="	fa fa-camera"></i> Plots </a>
        </p>
        <table class="table table-bordered table-sm text-center" style="font-size: 11px">
            <thead class="thead-dark">
                <tr>
...
<div class="col-6">
    ...
    <div class="row">
        <div class="col-6  " id="divgrafico700nf001" name="divgrafico700nf001">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Noise Figure <?php echo $name_graf;?> UpLink</b>
                </p>
        ...
        <div class="col-6  " id="divgrafico700nf002" name="divgrafico700nf002">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Noise Figure <?php echo $name_graf;?>
                        DownLink</b></p>
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_0_nf_up_data) - Math.abs(Math.min.apply(Math,
                    iduni_0_nf_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_0_nf_up_data) + Math.abs(Math.max.apply(Math,
                    iduni_0_nf_up_data) * 0.1))
            }
        }]
    }
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_1_nf_down_data) - Math.abs(Math.min.apply(Math,
                    iduni_1_nf_down_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_1_nf_down_data) + Math.abs(Math.max.apply(Math,
                    iduni_1_nf_down_data) * 0.1))
            }
        }]
    }
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_0_levelread_up_data) - Math.abs(Math.min.apply(
                    Math, iduni_0_levelread_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_0_levelread_up_data) + Math.abs(Math.max.apply(
                    Math, iduni_0_levelread_up_data) * 0.1))
            }
        }]
    }
...
<div class="col-6">
    ...
    <div class="row">
        <div class="col-6  " id="divgrafico700maxpwr00" name="divgrafico700maxpwr001">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Level Read <?php echo $name_graf;?>
                        UpLink</b>&nbsp; @<?php echo $data_0_reach[1];?>dBm</p>
        ...
        <div class="col-6  " id="divgrafico700maxpwr00" name="divgrafico700maxpwr001">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Level Read <?php echo $name_graf;?>
                        DownLink</b>&nbsp; @<?php echo $data_1_reach[1];?>dBm</p>
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_1_levelread_down_data) - Math.abs(Math.min.apply(
                    Math, iduni_1_levelread_down_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_1_levelread_down_data) + Math.abs(Math.max.apply(
                    Math, iduni_1_levelread_down_data) * 0.1))
            }
        }]
    }
    ...
    <div class="row">
        <div class="col-12  " id="divgrafico700maxpwr00temp" name="divgrafico700maxpwr001temp">
            ...
            <div class="chart">
                ...
                <canvas id="grafilevelreadndowntemp_<?php echo $idgrapf; ?>" height="400px" width="1500px"
                    style="width: 1500px;"></canvas>
        ...
        <div class="col-12 " id="divgrafico700maxpwr00" name="divgrafico700maxpwr001">
            <hr style=" border: 1px solid #007bff;">
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Level Read </b>&nbsp;
                    @<?php echo $data_0_reach[1];?>dBm</p>

                <canvas id="grafilevelreadnup_<?php echo $idgrapf; ?>" height="400px" width="1500px"
                    style="width: 1500px;"></canvas>
                <?php $grafico_0_up_levelread ="grafilevelreadnup_".$idgrapf;?>
        ...
        <div class="col-12  " id="divgrafico700maxpwr00" name="divgrafico700maxpwr001">
            ...
            <div class="chart">
                ...
                <canvas id="grafilevelreadndown_<?php echo $idgrapf; ?>" height="400px" width="1500px"
                    style="width: 1500px;"></canvas>
                <?php $grafico_0_down_levelread ="grafilevelreadndown_".$idgrapf;?>
...
var grafico_0_up_levelread = document.getElementById('<?php echo $grafico_0_up_levelread;?>').getContext('2d');
var grafico_0_down_levelreadv = document.getElementById('<?php echo $grafico_0_down_levelread;?>').getContext('2d');
var grafico_0_down_levelreadvtemperat = document.getElementById('<?php echo $grafico_0_down_levelreadtemp;?>')
    .getContext('2d');
...
<div class="col-6">
    ...
    <div class="row">
        <div class="col-6  " id="divgrafico700maxpwr00" name="divgrafico700maxpwr00">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Max Power <?php echo $name_graf;?> UpLink</b>
                </p>
        ...
        <div class="col-6  " id="divgrafico700maxpwr00" name="divgrafico700maxpwr00">
            ...
            <div class="chart">
                <p class="  colorazulfiplex" style="font-size: 14px"><b>Max Power <?php echo $name_graf;?> DownLink</b>
                </p>
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_0_maxpwr_up_data) - Math.abs(Math.min.apply(Math,
                    iduni_0_maxpwr_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_0_maxpwr_up_data) + Math.abs(Math.max.apply(Math,
                    iduni_0_maxpwr_up_data) * 0.1))
            }
        }]
    }
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_1_maxpwr_up_data) - Math.abs(Math.min.apply(Math,
                    iduni_1_maxpwr_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_1_maxpwr_up_data) + Math.abs(Math.max.apply(Math,
                    iduni_1_maxpwr_up_data) * 0.1))
            }
        }]
    }
...
if ($idscript==38)
{
  $idscript=40;
        ...
        &nbsp;&nbsp;<a href="#"
            onclick="abrirgaleria(<?php echo "'".$v_sn."','".$instancemm."',".$vp_runinfo.",".$idbandoffas; ?>)"><i
                class="	fa fa-camera"></i> Plots </a>
    </p>
    <table class="table table-bordered table-sm text-center" style="font-size: 11px">
        <thead class="thead-dark">
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_0_gain_up_data) - Math.abs(Math.min.apply(Math,
                    iduni_0_gain_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_0_gain_up_data) + Math.abs(Math.max.apply(Math,
                    iduni_0_gain_up_data) * 0.1))
            }
        }]
    }
    ...
    scales: {
        ...
        yAxes: [{
            ...
            ticks: {
                ...
                suggestedMin: (Math.min.apply(Math, iduni_1_gain_up_data) - Math.abs(Math.min.apply(Math,
                    iduni_1_gain_up_data) * 0.1)),
                suggestedMax: (Math.max.apply(Math, iduni_1_gain_up_data) + Math.abs(Math.max.apply(Math,
                    iduni_1_gain_up_data) * 0.1))
            }
        }]
    }
...
/*
    ...
    <div class="row " id="divgrafi<?php echo $idgrapf;?>" name="divgrafi<?php echo $idgrapf;?>">
        <div class="col-6">
            ...
            <div class="row">
                <div class="col-12 " id="divgraficoup<?php echo $idgrapf; ?>"
                    name="divgraficoup<?php echo $idgrapf; ?>">
                    <b> TOTAL RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficouptotalripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
                        <?php $grafico_0_up_total ="graficouptotalripple_".$idgrapf;?>
                    </div>
                </div>
                <div class="col-6 " id="divgraficouprxripple<?php echo $idgrapf; ?>"
                    name="divgraficouprxripple<?php echo $idgrapf; ?>">
                    <b>RX RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficouprxripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
                        <?php $grafico_0_up_rx ="graficouprxripple_".$idgrapf;?>
                    </div>
                </div>
                <div class="col-6 " id="divgraficouptxripple<?php echo $idgrapf; ?>"
                    name="divgraficouptxripple<?php echo $idgrapf; ?>">
                    <b> TX RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficouptxripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
        ...
        <div class="col-6  " id="idreturnloss" name="idreturnloss">
            ...
            <div class="row">
                <div class="col-12 " id="divgraficodown<?php echo $idgrapf; ?>"
                    name="divgraficodown<?php echo $idgrapf; ?>">
                    <b> TOTAL RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficodowntotalripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
                        <?php $grafico_1_down_total ="graficodowntotalripple_".$idgrapf;?>
                    </div>
                </div>
                <div class="col-6 " id="divgraficodownrxripple<?php echo $idgrapf; ?>"
                    name="divgraficodownrxripple<?php echo $idgrapf; ?>">
                    <b>RX RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficodownrxripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
                        <?php $grafico_1_down_rx ="graficodownrxripple_".$idgrapf;?>
                    </div>
                </div>
                <div class="col-6 " id="divgraficodowntxripple<?php echo $idgrapf; ?>"
                    name="divgraficodowntxripple<?php echo $idgrapf; ?>">
                    <b> TX RIPPLE</b>
                    <div class="chart">
                        <canvas id="graficodowntxripple_<?php echo $idgrapf; ?>" height="280"
                            style="height: 280;"></canvas>
...
for (var aix = 0; aix < iduni_eq_check_up_TX_data.length; aix++) {
    ...
    iduni_eq_check_up_TX_data_conmedia.push(iduni_eq_check_up_TX_data[aix] - ((Math.min.apply(null,
        iduni_eq_check_up_TX_data) + Math.max.apply(null, iduni_eq_check_up_TX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_calib_up_TX_data.length; aix++) {
    iduni_eq_calib_up_TX_data_conmedia.push(iduni_eq_calib_up_TX_data[aix] - ((Math.min.apply(null,
        iduni_eq_calib_up_TX_data) + Math.max.apply(null, iduni_eq_calib_up_TX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_check_up_RX_data.length; aix++) {
    iduni_eq_check_up_RX_data_conmedia.push(iduni_eq_check_up_RX_data[aix] - ((Math.min.apply(null,
        iduni_eq_check_up_RX_data) + Math.max.apply(null, iduni_eq_check_up_RX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_calib_up_RX_data.length; aix++) {
    iduni_eq_calib_up_RX_data_conmedia.push(iduni_eq_calib_up_RX_data[aix] - ((Math.min.apply(null,
        iduni_eq_calib_up_RX_data) + Math.max.apply(null, iduni_eq_calib_up_RX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_check_down_TX_data.length; aix++) {
    iduni_eq_check_down_TX_data_conmedia.push(iduni_eq_check_down_TX_data[aix] - ((Math.min.apply(null,
        iduni_eq_check_down_TX_data) + Math.max.apply(null, iduni_eq_check_down_TX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_calib_down_TX_data.length; aix++) {
    iduni_eq_calib_down_TX_data_conmedia.push(iduni_eq_calib_down_TX_data[aix] - ((Math.min.apply(null,
        iduni_eq_calib_down_TX_data) + Math.max.apply(null, iduni_eq_calib_down_TX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_check_down_RX_data.length; aix++) {
    iduni_eq_check_down_RX_data_conmedia.push(iduni_eq_check_down_RX_data[aix] - ((Math.min.apply(null,
        iduni_eq_check_down_RX_data) + Math.max.apply(null, iduni_eq_check_down_RX_data)) / 2));
}
...
for (var aix = 0; aix < iduni_eq_calib_down_RX_data.length; aix++) {
    iduni_eq_calib_down_RX_data_conmedia.push(iduni_eq_calib_down_RX_data[aix] - ((Math.min.apply(null,
        iduni_eq_calib_down_RX_data) + Math.max.apply(null, iduni_eq_calib_down_RX_data)) / 2));
}
...
iduniqueop_band_0_uldl_0_tx_check_total = sumArray(iduni_eq_check_up_TX_data_conmedia,
    iduni_eq_check_up_RX_data_conmedia);
iduniqueop_band_0_uldl_0_rx_check_total = sumArray(iduni_eq_calib_up_TX_data_conmedia,
    iduni_eq_calib_up_RX_data_conmedia);

iduniqueop_band_0_uldl_1_tx_check_total = sumArray(iduni_eq_check_down_TX_data_conmedia,
    iduni_eq_check_down_RX_data_conmedia);
iduniqueop_band_0_uldl_1_rx_check_total = sumArray(iduni_eq_calib_down_TX_data_conmedia,
    iduni_eq_calib_down_RX_data_conmedia);
