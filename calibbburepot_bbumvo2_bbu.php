...
$v_led_10_11_210_forced_off = "";
		 ...
		 foreach ($resultleds as $rowbbuacpt4a) 
		 {
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==209 ) {  $v_led_1_11_209_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==210 ) {  $v_led_2_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==211 ) {  $v_led_3_11_211_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==212 ) {  $v_led_4_11_212_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==213 ) {  $v_led_5_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==214 ) {  $v_led_6_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==215 ) {  $v_led_7_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==216 ) {  $v_led_8_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==217 ) {  $v_led_9_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==218 ) {  $v_led_10_11_210_forced_off = $rowbbuacpt4a['v_booleanm'] ;}
 ...
 where  idfasoutcomecat in(11)  and idtype in (191,192,193,194,195,196,197,198,219,220)
		...
		/// echo "<br>a verrrrrr  RELays ----->>  ". $elsqlvalueledrelays;
		 ...
		 foreach ($resultleds as $rowbbuacpt4a) 
		 {
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==191 ) {  $v_relays_1_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==192 ) {  $v_relays_2_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==193 ) {  $v_relays_3_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==194 ) {  $v_relays_4_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==195 ) {  $v_relays_5_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==196 ) {  $v_relays_6_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==197 ) {  $v_relays_7_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==198 ) {  $v_relays_8_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==219 ) {  $v_relays_9_off = $rowbbuacpt4a['v_booleanm'] ;}
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==11  && $rowbbuacpt4a['idfasoutcomecat']==11 && $rowbbuacpt4a['idtype']==220 ) {  $v_relays_10_off = $rowbbuacpt4a['v_booleanm'] ;}
...
?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><?php if ( $v_relays_1_off ==0   ) 	{ ?><span class="badge bg-green">Pass</span><?php } else    {   	?><span class="badge bg-red">Not Pass</span><?php	} ?> </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><?php if ( $v_relays_4_off ==0   ) 	{ ?><span class="badge bg-green">Pass</span><?php } else    {   	?><span class="badge bg-red">Not Pass</span><?php	} ?> </td>
                                                    </tr>
                                                    <tr>
