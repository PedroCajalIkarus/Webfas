                        ...
                        $sqlbusco ="select distinct  1 as orr, orders.idorders  ,
                            ...
                            ,        tienecalibracion.totalpass::int as tienecalibration_totalpass, tienecalibracion.calibrationscript::int as tienecalibration_calibrationscript,
                                        ...
                                        where orders.idorders = ".$v_idp."    and orders_sn.wo_serialnumber = '".$snafiltrar."' 
                                         ...
                                         and products.idproduct in (select distinct idproduct from products where iduniquebranchsonprod like '%000100380011%' )
                                         left join ( 
                                          ...
                                          select maxfechaxsn.* , sn as unitsn, fas_outcome_runinfo.idruninfo as calibrationscript  , 0 as totalpass,idruninfo ,'' as dibsn 
                                           ...
                                           and idproduct in (select distinct idproduct from products where iduniquebranchsonprod like '%000100380011%' )
      ...
      //      echo  $sqlbusco;
                 ...
                 <?php
                           ...
                           on tracking_steps.idtrackingsteps = business_tracking_steps.idtrackingstep
                               where iduniquebranchprodson in (select distinct iduniquebranchsonprod from   fnt_select_allproducts_maxrev()  where active = 'Y' and  modelciu = '".trim($rowbuscawo['modelciu'])."' ) order by orderlist ";
                              ...
                              foreach ($resultadospasoss as $rowpasos) 
                              {
                               ...
                               $activo_paso1_processfasserver ="";
                                  ...
                                  $activo_paso1_processfasserver = "<span class='badge bg-warning'>FasClient Pending </span>";
                                          ...
                                          {
                                             /////**************************************************** 
                                             $Sql_ifautotest = $connect->prepare(" select idruninfodb from runinfodb where idruninfodb = ".$rowbuscawo['tienecalibracion_idruninfo']." and script = 'Auto Calibrate Flex' ");                                 
                                  ...
                                  //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                        ...
                                        //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                            ...
                                            //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                ...
                                                ///////////////// wo_calibration_legacy //////////////////////////  
                                          ///////////////// wo_afterburning //////////////////////////
                                          if ($rowpasos['stepfunction']=="wo_calibration" &&  $_if_auto_test_box_calibration == "N" &&   $eslegacy =="N")
                                          {
                                             ///////////////////////////////////////////////////////
                                          ...
                                          ///////////////// so_info-finalcheck //////////////////////////  
                                            ...
                                            if ($rowpasos['stepfunction']=="bbu_fas_calibration")
                                            {
                                              $activo_paso_Final_Check  = "";
                                                 ...
                                                 $eslegacy ="Y";
                                                 $Sql_ifautotest = $connect->prepare(" select idruninfo from fas_outcome_runinfo where idruninfo = ".$rowbuscawo['tienecalibracion_idruninfo']." and idtyperun = 12  AND v_integer = 3 ");                                 
                                                 $Sql_ifautotest->execute();
                                                 $result_ifautotest = $Sql_ifautotest->fetchAll();	
                                                 foreach ($result_ifautotest as $row_autotest)
                                                 {
...
// fin// AutoComplete de CUIS version TOP	
   ...
   $("#txtlistcius").change(function(){
            ...
            window.location = 'trackingordersmmv3.php?isdo='+datosmm[0]+'&typeisdo='+datosmm[1]+'&encont='+datosmm[2];
   });
