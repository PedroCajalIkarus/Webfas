...
-->
	...
	<div class="card card-primary card-tabs ">
	  ...
	  <?php
		 ...
		 <select class="form-control col-sm-4 form-control-sm" name="cmbiditeracion" id="cmbiditeracion" >
			<?php
			...
			$datacabez = $connect->query($sql)->fetchAll();	
			  ...
			  <div class="card-header p-0 pt-1 d-none">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item ">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="false">UL</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">DL</a>
                  </li>
		  ...
		  <table class="table table-sm table-hover table-striped table-bordered text-center textotabla10">
			 ...
			 <div id="accordion">
                  ...
                  <div class="">
                    <div class="">
                      ...
                      <h4 class="textotabla10 ">
                        &nbsp;<span class="colornaranajafiplex"></span> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed" aria-expanded="false">
                         <span class="hrefmanito" onclick="abrirgaleria('imgma0')">  Not Equalized WITHOUT AGC </span>
                        </a>
                      </h4>
                    </div>
												...
												<li>
												  ...
												  <?php
													...
													else
													{
														  ?>
														<li>
															<img  data-original="<?php echo $signedUrl;?>" src="<?php echo $signedUrl;?>" width="10%" class="d-none" > 
                  ...
                  <div class="divmarco">
                    <div class="">
                      <h4 class="textotabla10 ">
                        &nbsp;<span class="colornaranajafiplex"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed" aria-expanded="false">
                           <span class="hrefmanito" onclick="abrirgaleria('imgmb0')"> Equalized WITHOUT AGC</span>
                        </a>
                      </h4>
                    </div>
									  ...
									  foreach ($eqwithoutagc as $rowd) 
											...
											//	echo $pngtemp;
												...
												///echo "<br>a ver aqui:".$signedUrl;
												  ...
												  ?>
												<li>
													<img id="imgmb<?php echo $vt; ?>" name="imgmb<?php echo $vt; ?>"   data-original="<?php echo $signedUrl1;?>" src="<?php echo $signedUrl1;?>" width="10%"> 
												  ...
												  <?php
													...
													else
													{
														  ?>
														<li>
															<img  data-original="<?php echo $signedUrl1;?>" src="<?php echo $signedUrl1;?>" width="10%" class="d-none" > 
				  ...
				  <div class="divmarco">
                    <div class="">
                       <h4 class="textotabla10 ">
                        &nbsp;<span class="colornaranajafiplex"></a>   <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo2" class="collapsed" aria-expanded="false">
                          <span class="hrefmanito" onclick="abrirgaleria('imgmc0')"> Not Equalized  AGC </span>
                        </a>
                      </h4>
                    </div>
									  ...
									  foreach ($noteqagc as $rowd) 
											...
											//	echo "acamarco:".$pngtemp;
												...
												///echo "<br>a ver aqui:".$signedUrl;
												  ...
												  ?>
												<li>
													<img  id="imgmc<?php echo $vt; ?>" name="imgmc<?php echo $vt; ?>" data-original="<?php echo $signedUrl2;?>" src="<?php echo $signedUrl2;?>" width="10%"> 
												  ...
												  <?php
													...
													else
													{
														  ?>
														<li>
															<img  data-original="<?php echo $signedUrl2;?>" src="<?php echo $signedUrl2;?>" width="10%" class="d-none" > 
                  ...
                  <div class="divmarco">
                    <div class="">
                      <h4 class="textotabla10 ">
                        ...
                        &nbsp;<span class="colornaranajafiplex"></a>   <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree2" class="collapsed" aria-expanded="false">
                          <span class="hrefmanito" onclick="abrirgaleria('imgmd0')">  Equalized  AGC </span>
                        </a>
                      </h4>
                    </div>
									  ...
									  foreach ($eqagc as $rowd) 
											...
											//	echo $pngtemp;
												...
												$signedUrl3 = (string) $request3->getUri();
												  ...
												  ?>
												<li>
													<img  id="imgmd<?php echo $vt; ?>" name="imgmd<?php echo $vt; ?>"  data-original="<?php echo $signedUrl3;?>" src="<?php echo $signedUrl3;?>" width="10%"> 
												  ...
												  <?php
													...
													else
													{
														  ?>
														<li>
															<img  data-original="<?php echo $signedUrl3;?>" src="<?php echo $signedUrl3;?>" width="10%" class="d-none" > 
			  ...
			  $classciuisdba="d-none";
				   ...
				   ?>
			  	 <div class="col-md-3 <?php echo $classciuisdba;?>" id="divbarritas" name="divbarritas">

				 
                    <br>
                    <h5 class=" colorazulfiplex text-center"> <strong> Factory Parameters</strong></h5>
                 		
					
						<div class="progress-group">
						<b> Levels Offset</b>
						
							<input id="range_levelsoffset" type="text" name="range_levelsoffset" value="" class="d-none" tabindex="-1" readonly="">
						...
						<div class="progress-group">
						<b> Squelch Offset</b>
							<input id="range_SquelchOffset" type="text" name="range_SquelchOffset" value="" class="d-none" tabindex="-1" readonly="" disabled="disabled">
						...
						<span class="progress-text"><b>Gain Offset</b></span>
							<input id="range_GainOffset" type="text" name="range_GainOffset" value="" class="d-none" tabindex="-1" readonly="" disabled="disabled">
						...
						<div class="progress-group">
						<b> Max Pwr Offset</b>
						<input id="range_MaxPwroffset" type="text" name="range_MaxPwroffset" value="" class="d-none" tabindex="-1" readonly="" disabled="disabled">
						...
						<input id="range_currentlimit" type="text" name="range_currentlimit" value="" class="d-none" tabindex="-1" readonly="">
						</div>
							...
							<table class="table table-sm table-hover table-striped table-bordered text-center textotabla10">
							 ...
							 <tbody>	
									<tr>
									  ...
									  <td><?php echo round($Calibration_LSGP_Calibration_gain_freqshow,2); ?></td>
									  <td><?php echo round($Calibration_LSGP_Calibration_gain_gainnoagc,2); ?></td>
									  <td><?php echo round($Calibration_LSGP_Calibration_gain_gainagc,2); ?></td>
									</tr> 
									<tr>
									  <td class=" text-left"><b>Max Pwr</b></td>
									  <td><?php echo round($Calibration_LSGP_Calibration_maxpwr_freq,2); ?></td>
									  <td><?php echo round($Calibration_LSGP_Calibration_maxpwr_pwrnoagc,2); ?></td>
									  <td><?php echo round($Calibration_LSGP_Calibration_maxpwr_pwragc,2); ?></td>
									</tr> 
							 </tbody>	
                             </table>
							<div id="galley4">
								...
								?>	
									  <li>  <img img src="<?php echo $signedUrl; ?>"  width="390px" alt="Gain Not Calibrated">
										<span class="texto8 colorazulfiplex"> Gain Not Calibrated  aa</span></li>
								</td>
								...
								?>		
									<li>	<img img src="<?php echo $signedUrl2; ?>"  width="390px" alt="Gain Calibrated ">
										<span class="texto6 colorazulfiplex"> Gain Calibrated </span></li>
								</td>
								</tr>		
								<tr>
								<td>	
								...
								?>			
									<li>    <img img src="<?php echo $signedUrl3; ?>"  width="390px" alt="Max Pwr Not Calibrated">
										<span class="texto6 colorazulfiplex"> Max Pwr Not Calibrated </span></li>
								</td>
								...
								?>			
									<li>	<img img src="<?php echo $signedUrl4; ?>"  width="390px" alt="Max Pwr Calibrated ">
										<span class="texto6 colorazulfiplex"> Max Pwr Calibrated </span></li>
								</td>
								</tr>		
								</table>	  
								</ul>
