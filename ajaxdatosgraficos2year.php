...
$vidmemp=$_REQUEST['idempresa'];		 
					$query_lista_repor =" select * from fnt_select_runinfo_by_business_count_bydaywithparambyyear(".$vidmemp.",".$vmes.",".$vanio."); ";
	//$return_arr[]="";				
				...
				//$loslabels="{";
					...
					{
						$losdatosamostrar =$losdatosamostrar.  "{label:'FIPLEX',fill: false,borderWidth : 2,lineTension  : 0,	spanGaps : true,borderColor  : '#007bff',	pointRadius : 3,pointHoverRadius : 7,pointColor: '#efefef',pointBackgroundColor: '#efefef',data : [".$valorxdia."] },";
					}
					if ($arraydatos['idbusiness']==2)
					{
						$losdatosamostrar =$losdatosamostrar.  "{label:'WESTELL',fill: false,borderWidth : 2,lineTension  : 0,	spanGaps : true,borderColor  : '#FF6666',	pointRadius : 3,pointHoverRadius : 7,pointColor: '#efefef',pointBackgroundColor: '#efefef',data : [".$valorxdia."] },";
					}
					if ($arraydatos['idbusiness']==3)
					{
						$losdatosamostrar =$losdatosamostrar.  "{label:'SPINNAKER',fill: false,borderWidth : 2,lineTension  : 0,	spanGaps : true,borderColor  : '#00994C',	pointRadius : 3,pointHoverRadius : 7,pointColor: '#efefef',pointBackgroundColor: '#efefef',data : [".$valorxdia."] },";			
					}
