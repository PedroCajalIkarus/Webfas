...
//   print_r($_POST);
    ...
    try {
          ...
          $v_resp2 = $_REQUEST['txtpreguntas2'];
          $v_resp3 = $_REQUEST['txtpreguntas3'];
          $v_resp4 = $_REQUEST['txtpreguntas4'];
          $v_resp5 = $_REQUEST['txtpreguntas5'];
          $v_resp6 = $_REQUEST['txtpreguntas6'];
          $v_resp7 = $_REQUEST['txtpreguntas7'];
          $v_resp8 = $_REQUEST['txtpreguntas8'];
          $v_resp9 = $_REQUEST['txtpreguntas9'];
          $v_resp10 = $_REQUEST['txtpreguntas10'];
          $v_resp11 = $_REQUEST['txtpreguntas11'];
          $v_resp12 = $_REQUEST['txtpreguntas12'];
          $v_resp13 = $_REQUEST['txtpreguntas13'];
          $v_resp14 = $_REQUEST['txtpreguntas14'];
          $v_resp15 = $_REQUEST['txtpreguntas15'];
          $v_resp16 = $_REQUEST['txtpreguntas32'];

          $search = array("'");
          $v_resp1corre = str_replace($search, "", $_REQUEST['txtcorre1']); 
          $v_resp2corre = str_replace($search, "", $_REQUEST['txtcorre2']); 
          $v_resp3corre = str_replace($search, "", $_REQUEST['txtcorre3']); 
          $v_resp4corre = str_replace($search, "", $_REQUEST['txtcorre4']); 
          $v_resp5corre = str_replace($search, "", $_REQUEST['txtcorre5']); 
          $v_resp6corre = str_replace($search, "", $_REQUEST['txtcorre6']); 
          $v_resp7corre = str_replace($search, "", $_REQUEST['txtcorre7']); 
          $v_resp8corre = str_replace($search, "", $_REQUEST['txtcorre8']); 
          $v_resp9corre = str_replace($search, "", $_REQUEST['txtcorre9']); 
          $v_resp10corre = str_replace($search, "", $_REQUEST['txtcorre10']); 
          $v_resp11corre = str_replace($search, "", $_REQUEST['txtcorre11']); 
          $v_resp12corre = str_replace($search, "", $_REQUEST['txtcorre12']); 
          $v_resp13corre = str_replace($search, "", $_REQUEST['txtcorre13']); 
          $v_resp14corre = str_replace($search, "", $_REQUEST['txtcorre14']); 
          $v_resp15corre = str_replace($search, "", $_REQUEST['txtcorre15']); 
          $v_resp16corre = str_replace($search, "", $_REQUEST['txtcorre32']); 
                         ...
                         foreach ($data as $row) 
                         {
                          $colorstyle="black";
                           if ($vidsurveyresponse ==0 && $_REQUEST['eyeid']=="" || $_REQUEST['eyeid']==$row['idsurveyresponse'])
                           {
                            ...
                            <tr>
                              <td><?php echo  $row['sn']; ?> 
                            &nbsp;&nbsp;  <a href='calibrationqualitychecklist.php?elsn=<?php echo $row['sn']; ?>&elso=<?php echo $row['so']; ?>&elciu=<?php echo $row['modelciu']; ?>&eyeid=<?php echo $row['idsurveyresponse']; ?>'><i class='fas fa-eye' style='color:<?php echo  $colorstyle;?>'></i>&nbsp;View  </a></td>
...
$idpreguntas= 1;
   ...
   <input type="text" class="form-control col-10" name="txtother" id="txtother" value=" ">
      ...
      <td colspan="2" >
      <select  class="form-control form-control-sm" name="lascategorias" id="lascategorias"  >
						<option value=""> -select- </option>
					
						<option value="CrossCables"> Cross Cables </option>
            <option value="Defectingcable"> Defecting Cable </option>
            <option value="DefectiveComponent"> Defective Component </option>
        ...
        <b>Corrections:</b>
   <input type="text" class="form-control form-control-sm  " name="txtotherbycat" id="txtotherbycat" value=" ">
   <input type="hidden" class="form-control form-control-sm  " name="numerador" id="numerador" value="1">
   <br>
   
   <p class="text-right">
   <button name="btnaddp" id="btnaddp" type="button" onclick="agregaritem()" class="btn btn-outline-primary  right-align "  >  Add</button>
   </p>
   <div id="addpreg" name="addpreg">
      ...
      <td colspan="3">
       ...
       <input type="hidden" class="form-control form-control-sm" name="txtaddcatothersarray" id="txtaddcatothersarray" value=" ">
      </td>
      </tr>
      <?php  
      } 
