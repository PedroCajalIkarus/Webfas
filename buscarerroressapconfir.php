...
$queryreparatodo=" update fas_to_sap
set processed ='M'
where idruninfo in (
select idruninfo
from fas_to_sap_xml
where  v_state =3 and  
	runinfodate >= CURRENT_DATE - INTERVAL '5 days') ";
$connect->query($queryreparatodo)->fetchAll();

$queryreparatodo=" delete from fas_to_sap_xml
where  v_state =3 and  
	runinfodate >= CURRENT_DATE - INTERVAL '5 days'";
$connect->query($queryreparatodo)->fetchAll();

$queryreparatodo=" 	update fas_to_sap set processed ='N' where processed ='M' ";
$connect->query($queryreparatodo)->fetchAll();
...
<form name="frma" id="frma">
 ...
 include ('licencefiplex_mm.php');
   ...
   function buscarTextoEnCadena($cadena, $texto, $sensibleMayusculas = false) {
    if (!$sensibleMayusculas) {
      $cadena = strtolower($cadena);
      $texto = strtolower($texto);
    }
  
    return strpos($cadena, $texto) !== false;
  }
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>List of unconfirmed transactions</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">List of unconfirmed transactions</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                            ...
                            <section class="col-lg-12 connectedSortable ui-sortable">
                                ...
                                <div class="" name="divscrolllog" id="divscrolllog" style="display.">
                                    ...
                                    <div class="card">
                                        ...
                                        Listamos las transacciones que no han sido confirmadas por SAP
                                        <br>
                ...
                $query_lista = "select *
                from (
                                select    fas_to_sap_xml.*, fas_outcome_integral.v_string as wosorma
                                        from fas_to_sap_xml  
                                    ...
                                    where  runinfodate > (current_date -20) and v_state <9  and v_state not in (4,8) 
                ) as todos
                inner join fas_outcome_integral
                on fas_outcome_integral.reference= todos.idruninfo 	and
                   fas_outcome_integral.idtype = 16 and
                   fas_outcome_integral.idfasoutcomecat =0   where (wosorma not like '%RM' or wosorma is null) and v_po <> 'NOXML' order by runinfodate asc  
                        ";
 ...
 // $decode = json_decode($row2['ffd']);
  ...
  //  echo var_dump($row2['ffd']);
   ...
   $SAP_totalpass
       ...
       ////// segun el resultado lo reprocesamos...

       if (buscarTextoEnCadena($row2['v_state_result'], "already blocked")) {
        //echo "  se encuentra en la cadena.";
        echo "<span class='badge bg-success'> *** Operation resent *** </span>";

        $idrunfin = $row2['idruninfo'];
      ...
      if (buscarTextoEnCadena($row2['v_state_result'], "already being processed")) {
        //echo "  se encuentra en la cadena.";
        echo "<span class='badge bg-success'> *** Operation resent *** </span>";
