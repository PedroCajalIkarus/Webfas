...
<head>
  ...
  <title>FIPLEX - Sales Orders</title>
...
function customHeaderFilter(headerValue, rowValue, rowData, filterParams){
    ...
    //rowData - the data for the row being filtered
    //filterParams - params object passed to the headerFilterFuncParams property
console.log(headerValue +'-'+rowData+'->'+rowValue+ 'filterParams'+filterParams);
...
var tableDataNested = [
    {name:"Oli Bob",  _children:[
        ...
        {name:"Brendon Philips", _children:[
            {name:"Margret Marmajuke"},
            {name:"Frank Harbours"},
        ]},
    ]},
    {name:"Jamie Newhart", },
    {name:"Gemma Jane",  _children:[
        {name:"Emily Sykes"},
    ]},
    {name:"James Newman"},
];			
			...
			var table = new Tabulator("#example-table", {
					...
					layout:"fitColumns",					
					columns:[ 
							 {title:"SO - Customers", field:"name",  sorter:"string", headerFilter:"input", headerFilterPlaceholder:"Search...", headerFilterFunc:customHeaderFilter},
