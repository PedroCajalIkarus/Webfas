               ...
               //     echo "<br>-------".$arraysteps_name[$immt]." wo-->".$rowbuscawo['ref_wo']." -- so-> ". $ref_so." <-idso----".$v_idp." - idwo:".$idorderwo." ---haveSOasing:". $haveSOasing;
                       ...
                       ///       echo "sssssssssssssssssssssssssssssssssssss";
                          ...
                          <div class="stepazulyamarillo active">
                              ...
                              <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"><b><?php echo substr($arraysteps_name[$immt],3,22); ?>
                               <br>  </b>
                              </span> 
                  ...
                  <?php
                   ...
                   if ($haveSOasing == "N")
                   {
                       // echo $rowbuscawo['wo_serialnumber'];  
                      /*  $sql  = $connect->prepare(" select reporttype from products_webfas_report  where idproduct =  ".$vtempidproduct);        
                        ...
                        // Chequeo aca si tiene SO asinada y no tiene Attributos..

                      /// create_only_SO($vv_worcenter,$vv_sn, $vv_idp,$vvnombre_a_mostrar_en_dvi,$vv_soworam,$vv_modelciu, $vtemp, $v_enable_attachfile);
                    $haveSOasing= "P";
                      ?>
                    <div class="stepazulyamarillo active">
...
{ 
  ...
  $vv_soworam_tempsurvey3 =$vv_soworam;
  $vv_modelciu_tempsurvey3=$vv_modelciu;
...
";
 ...
 { 
   ...
   ///////////////////////////////////
   function create_only_SO($vv_worcenter,$vv_sn, $vv_idp,$vvnombre_a_mostrar_en_dvi,$vv_soworam,$vv_modelciu, $vtemp, $v_enable_attachfile)
   {
    include("db_conect.php"); 
