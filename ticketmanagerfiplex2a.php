...
?>
  ...
  <!-- inicia pagina -->
	...
	on fas_techsupport_reason.idtechsupport_reason = fas_techsupport.idtkreason
		...
		on fas_techsupport_category_byuserfas.idtechsupport_category =   fas_techsupport.idcategory and 
		fas_techsupport_category_byuserfas.iduserfas				 = ".$iduserlogeado."
	...
	where fas_techsupport_category.active = 'Y' and fas_techsupport_category_business.idbusiness= ".$idbusiness." order by namecategory");
								...
								<div class="col-sm-10">
									...
									<?php
									$idbusiness=	$_SESSION["i"];
									  $sql = $connect->prepare("	select  * from fas_techsupport_reason order by namereason");
							...
							foreach ($resultsupport as $rowdatos) {
								...
								?>
								 ...
								 <th><?php 
										...
										echo $rowdatos['issue'];  $dateff=date_create($rowdatos['datereported']);
