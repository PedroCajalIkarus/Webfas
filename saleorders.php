...
<form  action="saleorders.php" method="post" class="form-horizontal" id="myform" name="myform">	
					...
					<table id="example1" class="table table-sm table-striped">
						...
						<tbody>
								...
								<?php		
									...
									//	echo $query_lista;	
									///	$query_lista="select * from orders_sn where typeregister  = 'MO' ";									
