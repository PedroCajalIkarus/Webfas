...
<head>
    ...
    <title>FIPLEX - history up to 2022</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Activity Log - History up to 2022</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <section class="col-lg-6 connectedSortable ui-sortable">
                                ...
                                <?php
			// 	echo "aaaa".$_SESSION["g"]; 
		//	  if 	($_SESSION["g"] == "develop" || $_SESSION["g"] == "quality" || $_SESSION["g"] == "director"  || $_SESSION["g"] == "Engineering" ) 
		//		  { ?>
		...
		//		  { 
                                        ...
                                        <li class="nav-item">
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control d-none"
                                                    placeholder="custom search" name="txtbusqcustom" id="txtbusqcustom">
                                                <span class="input-group-append">
                                                    <button type="button" name="btn2" id="btn2"
                                                        class="btn  btn-flat d-none"
                                                        onclick="search_custom(2,<?php echo $_SESSION["i"] ; ?>)"><i
                                                            class='fas fa-search-plus'></i></button>
                                                    <button type="button" name="btn1" id="btn1" class="btn  btn-flat"
                                                        onclick="search_custom(1,<?php echo  $_SESSION["i"] ;?>)"><i
                                                            class='fas fas fa-search' title="custom search"
			...
			//	  }
				 ?>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#" onclick="show_log_bs(1)"
                                                data-toggle="tab">FIPLEX US</a></li>

                                        <?php  if 	($_SESSION["g"] == "develop" || $_SESSION["g"] == "director" ) 
				 {					 ?>
                                        <li class="nav-item"><a class="nav-link" href="#" onclick="show_log_bs(11)"
                                                data-toggle="tab">WMata Project</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#" onclick="show_log_bs(3)"
                                                data-toggle="tab">SPINNAKER</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#" onclick="show_log_bs(2)"
                                                data-toggle="tab">WESTELL</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                                <?php  // } ?>
                                    ...
                                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title"> <span name="iconolog" id="iconolog"><i
                                                            class="fa fa-fw fa-list-alt"></i></span>Log Details :: </h3>
                                                <i class="fa fa-fw fa-user"></i> <label name="lblvuser" id="lblvuser">
                                                </label>
                                                <i class="fa fa-fw fa-tv"></i> <label name="lblvdevice" id="lblvdevice">
                                                </label>
                                                <i class="fa fa-fw fa-inbox"></i> <label name="lblvstationr"
                                                    id="lblvstationr"> </label>
                                            ...
                                            <div class="card-body p-0" style="display: block;">
                                                <div class="d-md-flex">
                                                    <div class="p-1 flex-fill" style="overflow: hidden">
                                                        <textarea class="form-control form-controltamanio" rows="18"
                                                            id="detallelog" name="detallelog"></textarea>
...
$(document).inactivityTimeout({
    ...
    inactivityWait: 1200, //default 600 =  10 minutes
    //how long to show inactivity dialog (in seconds) before automatically logging out.               
    dialogWait: 120, //default 60 =  1 minute
    logoutUrl: 'logdbyear2022.php?autorefreshxinactivity:)'
})
...
$(document).ready(function() {
    ...
    var table = new Tabulator("#example-table", {
        height: altor,
        layout: "fitDataFill",
        ajaxURL: "getruninfojsontabultordb2022.php?idab=" + pepe,
        ...
        columns: [
            ...
            {
                title: " <i class='fa fa-fw fa-calendar'></i> Date",
                field: "fechacorta",
                sorter: "date",
                width: 140,
                headerFilter: "input"
            ...
            {
                title: " <i class='fa fa-fw fa-user'></i> User",
                field: "userruninfo",
                sorter: "string",
                width: 90,
                headerFilter: "input"
            ...
            {
                title: " <i class='fa fa-fw fa-tv'></i>  Station",
                field: "station",
                sorter: "string",
                width: 90,
                headerFilter: "input"
            ...
            {
                title: " <i class='fa fa-fw fa-cog'></i> Script",
                field: "script",
                sorter: "string",
                width: 100,
                headerFilter: "input",
                formatter: function(cell, formatterParams) {
                    ...
                    ///if(value.indexOf("") > 0){
                    if (vj_scriptn == "Accept DigitalBoard" || "Accept Module" == vj_scriptn ||
                        "Unit Final Check" == vj_scriptn) {
                        coloresscrpit = "bg-green";

                    }
                    if (vj_scriptn == "Digital Module" || vj_scriptn == "Digital Unit" ||
                        vj_scriptn == "TXPA220") {
                        coloresscrpit = "bg-yellow";
                    }
                    if (vj_scriptn == "Calibration Splitter" || vj_scriptn ==
                        "Calibration Generator" || vj_scriptn == "unit calibration") {
                        coloresscrpit = "bg-info";
                    }
                    if (vj_scriptn == "SOFUSA Generator" || vj_scriptn ==
                    ...
                    return " <span class='badge " + coloresscrpit + "'>" + vj_scriptn +
                        "</span>";
            ...
            {
                title: " <i class='fa fa-fw fa-tv'></i> Device",
                field: "device",
                sorter: "string",
                width: 100,
                headerFilter: "input"
            ...
            {
                title: " <i class='fa fa-fw fa-tv'></i> FasVer",
                field: "fasversion",
                sorter: "string",
                headerFilter: "input",
                width: 70
            ...
            {
                title: " <i class='fa fa-fw fa-eye'></i> Id",
                field: "idruninfo",
                sorter: "number",
                width: 130,
                headerFilter: "input",
                ...
                formatter: function(cell, formatterParams) {
                    ...
                    return " <a href='#'  onclick=show_log(" + celldato + ") >" + celldato +
...
function show_log_bs(id_business) {
    ...
    var table = new Tabulator("#example-table", {
        height: altor,
        layout: "fitColumns",
        ajaxURL: "getruninfojsontabultordb2022.php?idb=" + id_business + "&wp=" + iswamataproyect +
            "&scustom=" + $(
                "#txtbusqcustom").val(),
        ajaxProgressiveLoad: "scroll",
        selectable: 1,
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(cell, formatterParams) {
                    ...
                    if (vj_scriptn == "Digital Module" || vj_scriptn == "Digital Unit" || vj_scriptn ==
                        "TXPA220") {
                        coloresscrpit = "bg-yellow";
                    }
                    if (vj_scriptn == "Calibration Splitter" || vj_scriptn == "Calibration Generator" ||
                        vj_scriptn == "Unit Calibration") {
                        coloresscrpit = "bg-info";
                    }
...
function getData_spec_by_search() {
    ...
    console.log('getData_spec_by_search  fiplexlog2 Mostramos:' + $('#datesearch').val() + '--' + $('#listuserm')
        .val() + '&t3=' + $('#liststation').val() + '&t4=' + $('#listscrip').val());
    $.ajax({
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (datax.tienesupport == 0) {
                ...
                $('#iconolog').html('<a href="#" onclick="openpopupframe(' + datax.tienesupport +
                    ')"><i class="fas fa-tools" style="color:green"></i> Open Support Ticket</a> ::  ');
            }


            if (ifdebuger == "develop") {
                $('#lblvstationr').html(datax.vstation.replace("#", " ") +
                    ' <a href="#" onclick="show_log2(' + anex +
                    ')") ><i class="fas fa-bug" style="color:blue"></i> ' + idlog_view +
                    '</a> - <a href="#" onclick="callsupportit(' + anex +
                    ')") > <i class="fas fa-question-circle"></i>Require Support</a>&nbsp;&nbsp;<a href="#" onclick="open_plots(' +
                    idlog_view + ')"><i class="far fa-file-image"></i> Plots </a> ');
            } else {
                $('#lblvstationr').html(datax.vstation.replace("#", " ") +
                    ' <a href="#" onclick="callsupportit(' + anex +
                    ')") > <i class="fas fa-question-circle"></i>Require Support</a>&nbsp;&nbsp;<a href="#" onclick="open_plots(' +
                    idlog_view + ')"><i class="far fa-file-image"></i> Plots </a> ');
            }
