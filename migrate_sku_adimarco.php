        ...
        <div class="row">
          <section class="col-lg-6 connectedSortable ui-sortable">
			...
			<p name="msjwaitline" id="msjwaitline" align="center"><img src="img/waitazul.gif" width="100px" ></p>	
              ...
              $sql_busca_siexiste = $connect->prepare("select modelciu, tmbadiproduct06302023.* 
              from tmbadiproduct06302023
              left join fnt_select_allproducts_maxrev_bysap() as pp
              on pp.modelciu = tmbadiproduct06302023.sku
              ");
              ...
              $resultado_buscasiexiste = $sql_busca_siexiste->fetchAll();
               foreach ($resultado_buscasiexiste as $rowbusca2) 
               {
                 if ($rowbusca2[0] == "")
                 {
                  ...
                  echo "<br>*->".$rowbusca2[0]."*->".$rowbusca2[1]."*->".$rowbusca2[2]."*->".$rowbusca2[3]."<br>";      

                  $sqlupdar=" insert into products 
                  select 0, (select max(idproduct)+1 from products), 0, null, '".$rowbusca2[1]."', null,null, 'S', 'FntFASSAP', now(), false, false, 1,'00010114', null,'impadi', 0, null, null
                  from   fnt_select_allproducts_maxrev_bysap() as ppp                 
                  where idproduct = 214";
