...
<td style='width: 33%;text-align: left'>Max Pwr Tolarance: <strong><?php echo $vv_info_maxpwrtolerance;?> (dBm)</strong></td>
...
//	echo "inicio:".$query_lista."<br>fin<br>";
		...
		<hr>
		<br>
		<table style="width: 700px;font-size: 10pt;text-align: center;border-top: 0px solid black;border-right: 0px solid black;border-left: 0px solid black; border-bottom: 0px solid black;">
        <tr>
			<td style="width:350px;height:200px;">Gain       
			<canvas id="salesCharttxripple<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
			<td style="width:350px;height:200px;">Max Power
		<canvas id="salesChartpowers<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		</tr>
		
		<tr>
			<td style="width:350px;height:200px;">Noise Figure   
		<canvas id="salesChartlevel<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		<td style="width:350px;height:200px;">Gain vs PwrIn @796.5MHz   
		<canvas id="graficoabajo1<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		</tr>
		<tr>
			<td style="width:350px;height:200px;">PwrOut vs PwrIn @796.5MHz   
		<canvas id="graficoabajo2<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		
			<td style="width:350px;height:200px;">PwrIn Dynamic Range   
		<canvas id="graficoabajo3<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		</tr>
		<tr>
			<td style="width:350px;height:200px;">Ch AGC vs PwrIn @796.5MHz   
		<canvas id="graficoabajo4<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
		</td>
		
			<td style="width:350px;height:200px;">BB AGC vs PwrIn @796.5MHz   
		<canvas id="graficoabajo5<?php echo $vvv_sumanombregraf; ?>" width="100px" height="100px" style="height: 100;width:100"></canvas>
...
<script type="text/javascript">
	...
	$( document ).ready(function() {
		...
		var imggrafico1 = document.getElementById('salesCharttxripple').toDataURL('image/png');
