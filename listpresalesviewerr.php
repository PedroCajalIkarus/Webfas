            ...
            <section class="content">
				...
				//		$queryquefiltramos=" and pre.date_approved > '".date(Y)."-01-01 00:00:00' ";
					...
					?>
                                            ...
                                            <!--- demo acordion--->
                                            &nbsp;<b>(*) - <a href='listpresales.php?qqdays=30'>Show last 30 days</a> ||
                                                <a href='listpresales.php?qqdays=1500'>View All </a></b>
				...
				if ($_REQUEST['qqdays']=="")
				{
					...
					$filtrer_date_marco ="  ((prestatus.datestate > now() -' 60 day'::INTERVAL) ) and";
					//$filtrer_date_marco ="  ((prestatus.datestate > now() -' 30 day'::INTERVAL) or orders_sn.processday is null) and";
				}
				else
				{
					$v_quantity_day = $_REQUEST['qqdays'];
					$filtrer_date_marco ="  ((prestatus.datestate > now() -' ".$v_quantity_day." day'::INTERVAL) or orders_sn.processday is null) and ";
				}
			//	$filtrer_date_marco ="";
...
where ".$filtrer_date_marco."  ( ( pre.active ='P'   )  
".$queryquefiltramos." )
