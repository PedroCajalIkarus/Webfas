    ...
    <section class="content">
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
		  <?php
		  echo "the user: ".$_REQUEST["b"]." does not have an associated station, contact the webfas administrator";
		    ...
		    /*
					...
					//Set who the message is to be sent to
						$mail->addAddress('agustin.corigliano@fiplex.com', 'DEVELOPMENT');
							  ...
							  $mail->Subject = "WEBFAS::User without associated station";
							  $mail->Body = "attention,user without associated station, the user: ".$_REQUEST["b"]."  ";
							//Definimos AltBody por si el destinatario del correo no admite email con formato html 
							  $mail->AltBody = "attention,user without associated station: ".$_REQUEST["b"]."  ";
