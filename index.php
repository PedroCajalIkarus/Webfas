...
<img src="Fipleximg2020.png" width="350px">
  <div class="login-logo">
    ...
    <a href="indexmm.php"><b>WEB</b>FAS</a>
	
  </div>
  <!-- /.login-logo -->
  <form action="index.php" method="post" id="contactForm" class="needs-validation" novalidate>
  <div class="card">
    ...
    <li class="nav-item">
    <a class="nav-link active" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="false">   <span class="fa fa-qrcode"></span> &nbsp;QR</a>
    </li>
    <li class="nav-item">
    <a class="nav-link " id="custom-content-above-profile-tab" data-toggle="pill" href="#custom-content-above-profile" role="tab" aria-controls="custom-content-above-profile" aria-selected="true"><span class="fas fa-user"></span>  &nbsp;User / HID</a>
    </li>
    </ul>
 ...
 <div class="input-group mb-3">
  ...
  <input type="hidden" id="txtqrh" name="txtqrh" class="form-control"  value="" >
    <input type="password" id="txtqr" name="txtqr" class="form-control" placeholder="QR" required>
...
<p class="login-box-msg">Sign in to start your session. </p>
  ...
  <div class="input-group mb-3">
    <input type="text" id="txtuser" name="txtuser" class="form-control" placeholder="User / HID / E-Mail" required>
