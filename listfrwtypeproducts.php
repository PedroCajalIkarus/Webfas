	...
	$( document ).ready(function() {
		...
		//FIN mostrar hora live
			...
			$("#detallelog").text("");
				...
				load_tree_products(1, $('#txtbusiness option:selected').html());
		/*
		/// migrado a function
			var jsonTreeData = "";
...
function load_tree_products (vvidbu, namebusiness)
{
	...
	var jsonTreeData = "";
			...
			$.ajax({
				url: 'ajax_list_tree_branchproducts_fw.php?idbu='+vvidbu+'&nmbu='+namebusiness,			
				type: 'post',				
				datatype:'JSON',				
				cache:false,					
				success: function(data, status, xhr) {
...
function mostrar_datos_fw(splt_a_filtrar, labelshowinfo)
{
	...
	var armando_tabla= '';
								$.ajax({
										url: 'listfirmware_ajax.php?p0='+splt_a_filtrar,										
										 cache:false,
