...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content" style="height: 100px; background-color: rgba(255, 0, 0, 0.1);">
      <div class="container-fluid" >
	...
	$( document ).ready(function() {
		...
		////aca vamos a probar el tablulator
			...
			var table = new Tabulator("#example-table", {
					...
					columns:[
							{title:" <i class='fa fa-fw fa-calendar'></i> Date", field:"fechacorta", sorter:"date", width:180,headerFilter:"input"},
							
							{title:" <i class='fa fa-fw fa-user'></i> User", field:"userruninfo", sorter:"string", width:120, headerFilter:"input"},
							{title:" <i class='fa fa-fw fa-tv'></i>  Station", field:"station", sorter:"string", width:130 ,headerFilter:"input" },
							{title:" <i class='fa fa-fw fa-cog'></i> Script", field:"script", sorter:"string", width:130, headerFilter:"input" ,
							...
							{title:" <i class='fa fa-fw fa-tv'></i> Device", field:"device", sorter:"string", width:230, headerFilter:"input"},
							{title:" <i class='fa fa-fw fa-eye'></i> Id", field:"idruninfo", sorter:"integer", width:100, headerFilter:"input",cellClick:function(e, cell){
