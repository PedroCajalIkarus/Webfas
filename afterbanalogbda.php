...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>After Burning  BDA Analog - TimeLine</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">After Burning  BDA Analog </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $vv_idrununfo = $_REQUEST['idruninfo'];
          ...
          <hr>
				...
				<?php
				    ...
				    section_create_graph_GAIN_by_idrun_sn($vv_idrununfo, $v_sn,38,'002007013') ;
            echo "</div><br><hr><div class='row'>	";
            section_create_graph_MaxPwr_by_idrun_sn($vv_idrununfo, $v_sn,38,'00200701A') ;
            echo "</div><br><hr><div class='row'>	";
            section_create_graph_IMD_by_idrun_sn($vv_idrununfo, $v_sn,38,'00200701B') ;
      
            echo "</div><br><hr><div class='row'>	";            
            section_create_graph_LevelRead_by_idrun_sn_fromafterburn($vv_idrununfo, $v_sn,38,'002007062') ;
                	
    
            echo "</div><br><hr><div class='row'>	";
         
            section_create_graph_Noisefigure_by_idrun_sn_fromafterburn($vv_idrununfo, $v_sn,38,'00200701C') ;
            ...
            echo "</div><br><hr><div class='row'>	";
            section_create_graph_Alarmchk_by_idrun_sn_fromafterburn($vv_idrununfo, $v_sn,38,'xxxxx') ;
				?>
