...
<input type="text" id="nrorev" name="nrorev" value="<?php echo $cant_Rev;?>">
...
else
{
  ...
  <?php
    ...
    <a class="btn btn-primary btn-sm col-sm-2" data-toggle="collapse" href="#multiCollapseExample<?php echo  $row['idtypecomponets'];   ?>" role="button" aria-expanded="false" aria-controls="multiCollapseExample<?php echo  $row['idtypecomponets'];   ?>">
    <?php echo  $row['nametypecomponets']; ?>  </a>&nbsp;&nbsp;
       <a href="#" onclick="abrirqrcomponet('readqr<?php echo  $row['idtypecomponets'];   ?>');return false">
       <i class='fas fa-qrcode' style='font-size:30px;color:blue;  vertical-align: middle;' ></i></a>
       &nbsp;&nbsp;     <input type="email" class="form-control form-control-sm form-control-sm col-md-4 d-none" onkeypress="return search_data_enter_qr(event,'readqr<?php echo  $row['idtypecomponets'];   ?>',<?php echo  $row['idtypecomponets'];   ?>)"  id="readqr<?php echo  $row['idtypecomponets'];   ?>" name="readqr<?php echo  $row['idtypecomponets'];   ?>"  placeholder="Read Qr">
       &nbsp;&nbsp;   <i class="fa fa-check d-none" style='  vertical-align: middle;font-size:20px;color:green' aria-hidden="true" id="readqr<?php echo  $row['idtypecomponets'];   ?>ok" name="readqr<?php echo  $row['idtypecomponets'];   ?>ok"></i> 
       &nbsp;&nbsp;   <i class="fa fa-times d-none" style='  vertical-align: middle;font-size:20px;color:red' aria-hidden="true" id="readqr<?php echo  $row['idtypecomponets'];   ?>okno" name="readqr<?php echo  $row['idtypecomponets'];   ?>okno"></i> 
       &nbsp;&nbsp;   <i class="fa fa-hourglass-start d-none" style='  vertical-align: middle;font-size:20px;color:#ff6600' aria-hidden="true" id="readqr<?php echo  $row['idtypecomponets'];   ?>wait" name="readqr<?php echo  $row['idtypecomponets'];   ?>wait"></i> 

    </div>
 
<div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample<?php echo  $row['idtypecomponets'];   ?>">
      <div class="card card-body">
         ...
         <div class=" col">
              ...
              if ($lostipodecomp=="")
              {
                $lostipodecomp = $row['idtypecomponets'];
              }
              else
              {
                $lostipodecomp = $lostipodecomp.",". $row['idtypecomponets'];
              }
              
            }

?>
<input type="hidden" name="lostiposdecomparry" id="lostiposdecomparry" value="<?php echo   $lostipodecomp;?>">
<input type="hidden" name="lostiposdecomparrypos" id="lostiposdecomparrypos" value="0">
</div>
</div>
...
function save_steps_outcome_integral(vvv_refence, vcatt,cccatttype, redirecciono,vvsn)
  ...
  function search_data_enter_qr(eventqr, namelemqr, idcompparam) {
