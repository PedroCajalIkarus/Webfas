  ...
  */
        ...
        //////////////////////////////////////////////////////////////////////////////////////////
            ...
            where   idruninfo in 
                ...
                ) and idattributeord=7  and v_string <>'' ");
...
echo "select  ponumber from orders_sn where so_soft_external ='".$elso."' and idproduct=". $elidproduct. " and wo_serialnumber='".$elsn."'  ";

                    $sqlblapo = $connect->prepare("select  ponumber from orders_sn where so_soft_external ='".$elso."' and idproduct=". $elidproduct. " and wo_serialnumber='".$elsn."'  ");
                    $sqlblapo->execute();
                    ...
                    echo "<br>select idorders, max(idnroserie) as mxidnroseire from orders_sn where so_soft_external ='".$elsoabuscar."' and idproduct=". $elidproduct. " group by idorders ";
                    $elsoabuscar=$rowso['v_string']."SO";
...
<form name="frma" id="frma"
    action="wopickingstepsmm.php?elsn=<?php echo $elsn; ?>&elso=<?php echo $elso; ?>&elciu=<?php echo $elciu; ?>"
   ...
   //  echo "<br><br>Query link".$sqlattri;
    ...
    function search_data_enter_qr(eventqr, namelemqr, idcompparam, chk_comp_sn, sku_for_check) {
        if (eventqr.keyCode == 13) {
            ...
            $.ajax({
                url: 'ajax_decode_board_infmm.php',
