...
$elwhere="";
	...
	if ( $param_search=="" && $nropage ==1)
	{
		$elwhere="   where dateserver> '2024/01/01'   ";
...
/*	if ( $param_search=="fiplexlog2")
	{
		...
		$elwhere4="";
		$anteswhere="";
			$elwhere=" where  dateserver >'2023/01/01' and  ";
...
$sql = $connect->prepare("select count(*) as cc from  runinfodb_head ".$elwhere);
    $sql->execute();
