            ...
            <div class="" name="divscrolllog" id="divscrolllog" style="display">
			  ...
			  <div class="demo-container">
				...
				<div class="card">
				 	<p align="right">
					 <span align="left">
							<a href="#" onclick="createtk()" style="color:#0053a1;">&nbsp;<i class='fa fa-info-circle' style='font-size:22px;color:#FFFF00;'></i>&nbsp;<b>Missing WO?</b></a> &nbsp;&nbsp;
						</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;<b>(*) -  <a href='listwordorder.php?qqdays=15'>Show last 30 days</a>    ||  <a href='listwordorder.php?qqdays=1500'>View All </a></b>
...
order by datestate desc");	
					  ...
					  ?>
					  &nbsp; <a href='woinfotopdf.php?idwop=<?php echo  $idpresales; ?>' title="View Info WO" target='_blank'><i class='fas fa-print'></i></a>
					  ...
					  &nbsp; <a href="#" title="Print SO Covers" onclick="Call_printcovers('<?php echo  $ciu; ?>',<?php echo  $row['quantity']; ?>,'<?php echo  $nrowo; ?>')"> <i class="fas fa-print"></a></i>
					  &nbsp; <a href="trackingorders.php?isdo=<?php echo  $idpresales; ?>&typeisdo=WO&encont=<?php echo  $nrowo; ?>" title="Tracking WO"><i class='fas fa-sitemap'></i></a>
					  <div class="d-none">
				...
				//			console.log("hola SN:"+itemnroserie.soassocied);
						...
						//	if (itemnroserie.cantregisencalib > 3)
							...
							else
							{
								...
								if (esdevelop =='develop')
								{
									tabla_info_show_po=tabla_info_show_po+"<tr><td>SN:</td><td> <b>"+itemnroserie.wosn+"</b>  <button onclick='habilitar_sn(this.value)' class='btn btn-xs' value="+itemnroserie.wosn+" title='Enable SN'> <i class='far fa-thumbs-up' style='font-size:18px;color:blue'></i> </button> </td><td align='left'></td><td colspan=2><b>Used: "+sn_used+"</b>  </td><td></td> </tr>";			
								}
								else
								{
...
//// fin enviamos para habiliar
	...
	function Call_printcovers(vpara_ciu, vcant,vwo)
	{
				console.log('si' + vpara_ciu);
				var ipservidorapache= '<?php echo $ipservidorapache; ?>';	
		eModal.iframe('https://'+ipservidorapache+'/printoscovers.php?vciu='+vpara_ciu+'&cc='+vcant+'&vwo='+vwo,'Print SO Covers');
