...
if($_POST)
	{
		...
		//levantamos los valores ingresamos para modificar
 		$v_txtnmeasures = $_REQUEST['txtnmeasures'];
		$v_txtref1 = $_REQUEST['txtref1'];
		$v_txtref2 = $_REQUEST['txtref2'];
		$v_txtref3 = $_REQUEST['txtref3'];
		$v_txtref4 = $_REQUEST['txtref4'];
		$v_txtref5 = $_REQUEST['txtref5'];
		$v_txtref6 = $_REQUEST['txtref6'];
		$v_txtref7 = $_REQUEST['txtref7'];
		$v_txtref8 = $_REQUEST['txtref8'];
		...
		try {
				...
				//	echo "<br>chkprod valor de ".$clave2." es: ".$valor2;
					...
					{
					//	echo "1";
						$setear_sql1= " nmeasures='".$v_txtnmeasures ."' ";
						$sumocoma="S";
					}
					if ($v_txtref1 <> "")
					{
						...
						$setear_sql2= $setear_sql2." reference1='".$v_txtref1 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref2 <> "")
					{
						...
						$setear_sql3= $setear_sql3." reference2='".$v_txtref2 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref3 <> "")
					{
						...
						$setear_sql4= $setear_sql4." reference3='".$v_txtref3 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref4 <> "")
					{
						...
						$setear_sql5= $setear_sql5." reference4='".$v_txtref4 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref5 <> "")
					{
						...
						$setear_sql6= $setear_sql6." reference5='".$v_txtref5 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref6 <> "")
					{
						...
						$setear_sql7= $setear_sql7." reference6='".$v_txtref6 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref7 <> "")
					{
						...
						$setear_sql8= $setear_sql8." reference7='".$v_txtref7 ."' ";
						$sumocoma="S";
					}
					if ($v_txtref8 <> "")
					{
						...
						$setear_sql9= $setear_sql9." reference8='".$v_txtref8 ."' ";
						$sumocoma="S";
					}
					...
					if ($v_txtscripttype <> "")
					{
						...
						$setear_sql10= $setear_sql10." idscripttype=".$v_txtscripttype ." ";
						$sumocoma="S";
					}
				 
				 
					$slqbandupd ="UPDATE public.fas_tree_product_references set ".$setear_sql1.$setear_sql2.$setear_sql3.$setear_sql4.$setear_sql5.$setear_sql6.$setear_sql7.$setear_sql8.$setear_sql9.$setear_sql10." 		where idproduct = ".$idproduct." and  idband =  ".$idbandselect ." and uldl = ".$iduldl." and iduniquebranch = '".$iduniquebranch."'" ;
				//	echo "<br>".$slqbandupd ;
			  	...
			  	$connect->query($slqbandupd);
					$msjdegrabo= "Update OK.!";
						/////////////////////////////////////////////////////////////////////////////////////
							...
							$vaccionweb="UPDATE fas_tree_product_references";
							$vdescripaudit="UPDATE fas_tree_product_references -".$valor2;
...
<form name="frma" id="frma" action="wizardproductsspecsref.php" method="post" class="form-horizontal">
									 ...
									 Bands</a></li>
									  ...
									  <li role="presentation" aria-selected="false" aria-level="2" aria-labelledby="ajax_ciu_addlbl*1129_anchor" id="ajax_ciu_addlbl*1129" class="jstree-node  jstree-leaf jstree-last">
										...
										<a class="jstree-anchor" href="wizardproductsspecsref.php" tabindex="-1" role="treeitem" aria-selected="false" aria-level="2" id="ajax_ciu_addlbl*1129_anchor">
										  <i class="jstree-icon jstree-themeicon fas fa-check jstree-themeicon-custom" role="presentation">
									      </i><b>  Measures References  </b></a></li>
...
UNIT --&gt; LEGACY																											  </option>	
			  ...
			  <p align="right">
				  ...
				  <span class="colorazulfiplex"><b> Measures References</b> </span>	<br><br>
				  ...
				  <table class="table   table-bordered table-sm ">
						<tr>
							  <td>	<label for="exampleInputEmail1">SCRIPT TYPE:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtscripttype')" name="btntxtscripttype" id="btntxtscripttype"> <i class="fas fa-edit"></i> Edit </button> </td>
					  	      <td>	<label for="exampleInputEmail1">NMEASURES:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtnmeasures')" name="btntxtnmeasures" id="btntxtnmeasures"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 1:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref1')" name="btntxtref1" id="btntxttxtref1"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 2:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref2')" name="btntxtref2" id="btntxttxtref2"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 3:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref3')" name="btntxtref3" id="btntxttxtref3"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 4:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref4')" name="btntxtref4" id="btntxttxtref4"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 5:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref5')" name="btntxtref5" id="btntxttxtref5"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 6:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref6')" name="btntxtref6" id="btntxttxtref6"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 7:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref7')" name="btntxtref7" id="btntxttxtref7"> <i class="fas fa-edit"></i> Edit </button> </td>
							  <td>	<label for="exampleInputEmail1">REFERENCE 8:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtref8')" name="btntxtref8" id="btntxttxtref8"> <i class="fas fa-edit"></i> Edit </button> </td>
					    </tr>
				  </table>
							<div class="row">
...
?>
									...
									<div class="form-group col-md-6 d-none" id="divtxtnmeasures" name="divtxtnmeasures">
										<label for="exampleInputEmail1">NMEASURES:</label> 										
										<input type="number" name="txtnmeasures" disabled id="txtnmeasures" class="form-control form-control-sm  " value="">	
									</div>	
									<div class="form-group col-md-6 d-none" id="divtxtref1" name="divtxtref1">
										<label for="exampleInputEmail1">REFERENCE 1:</label> 										
										<input type="number" name="txtref1" disabled id="txtref1" class="form-control form-control-sm  " value="">	
									</div>	
									<div class="form-group col-md-6 d-none" id="divtxtref2" name="divtxtref2">
										<label for="exampleInputEmail1">REFERENCE 2:</label> 										
										<input type="number" name="txtref2" disabled id="txtref2" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref3" name="divtxtref3">
										<label for="exampleInputEmail1">REFERENCE 3:</label> 										
										<input type="number" name="txtref3" disabled id="txtref3" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref4" name="divtxtref4">
										<label for="exampleInputEmail1">REFERENCE 4:</label> 										
										<input type="number" name="txtref4" disabled id="txtref4" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref5" name="divtxtref5">
										<label for="exampleInputEmail1">REFERENCE 5:</label> 										
										<input type="number" name="txtref5" disabled id="txtref5" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref6" name="divtxtref6">
										<label for="exampleInputEmail1">REFERENCE 6:</label> 										
										<input type="number" name="txtref6" disabled id="txtref6" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref7" name="divtxtref7">
										<label for="exampleInputEmail1">REFERENCE 7:</label> 										
										<input type="number" name="txtref7" disabled id="txtref7" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtref8" name="divtxtref8">
										<label for="exampleInputEmail1">REFERENCE 8:</label> 										
										<input type="number" name="txtref8" disabled id="txtref8" class="form-control form-control-sm  " value="">	
									</div>
...
function filtrartodo()
	...
	console.log('losatributos'+ losatributos);
			...
			xhr2.open("POST", "searchcuicomponentfiltersrefence.php");
			xhr2.send(formData);
