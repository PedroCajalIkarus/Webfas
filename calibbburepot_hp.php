...
foreach ($resultado3 as $row2) 
{
    ...
    ///////$dib_sku
     if ( $row2['idtype'] ==5)
     {
        $dib_sku = $row2['v_string'];
     }
     /////$dib_sku_sn
     if ( $row2['idtype'] ==6)
     {
        $dib_sku_sn = $row2['v_string'];
     }
     /////$dib_sku_bath
     if ( $row2['idtype'] ==38)
     {
        $dib_sku_bath = $row2['v_integer'];
     }
     ///////////$dib_sku_rev
     if ( $row2['idtype'] ==30)
     {
        $dib_sku_rev= $row2['v_integer'];
     }
...
?>
                                            ...
                                            <table
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width: 30%;text-align: left'>Date:
                                                        <strong><?php echo substr($v_datetimeidrun,0,19);?></strong>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style='text-align: left'>FW uC: <strong> <?php echo 	$_Fw_uC;?>
                                                        </strong></td>
                                                    <td style='width: 30%;text-align: left'>HW: <strong>
                                                            <?php echo 	$fas_hw_version;?> </strong> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width: 30%;text-align: left'>Battery Current Sensor:
                                                        <strong> <?php echo $battery_current_sensor; ?> </strong>
                                                    </td>
                                                    <td style='width: 30%;text-align: right'> DiB:
                                                        <b><?php echo $dib_sku;?></b> - SN :
                                                        <b><?php echo $dib_sku_sn;?></b> - Batch:
                                                        <b><?php echo $dib_sku_bath;?></b> -
                                                        Rev:<b><?php echo $dib_sku_rev;?></b>
                                                    </td>
					...
					//////////////////////////////////////////	 
						 ...
						 ?>
                                            ...
                                            <h5 style="text-decoration: underline;font-size:18px;text-align=center ">
                                                <b>Parameters:</b>
                                            </h5>
                                            <table
                                                class="table table-sm table-hover table-striped table-bordered text-center textotabla10">
...
where  idfasoutcomecat= 11  
	...
	$sqldscpp3 = $connect->prepare($elsqlvalue3);	 
			...
			foreach ($resultdescmc3a as $rowbbuacpt3a) 
			{
				...
				if (   $rowbbuacpt3a['instancem']=='0850C8112' && $rowbbuacpt3a['idfasoutcomecat']==11 && $rowbbuacpt3a['idtype']==154 ) {  $v_remotecommuerror_forced_on = $rowbbuacpt3a['v_booleanm'] ;}
				if (   $rowbbuacpt3a['instancem']=='0850C8106' && $rowbbuacpt3a['idfasoutcomecat']==11 && $rowbbuacpt3a['idtype']==154 ) {  $v_remotecommuerror_forced_off = $rowbbuacpt3a['v_booleanm'] ;}
...
?></td>
                                                        ...
                                                        <td style="text-align: left">>
                                                            <?php echo $v_System_Voltage_ref_2_6; ?> V
                                                            &nbsp;
                                                            &&nbsp;
                                                            < <?php echo $v_System_Voltage_ref_2_7; ?> V</td>

                                                        <td style="text-align: left">
                                                            <?php echo $v_System_Voltage_value;?> V</td>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">>
                                                            ...
                                                            < <?php echo $v_System_Voltage_ref_2_7; ?> V</td>
                                                        <td style="text-align: left">
                                                            <?php echo $V_Battery_Charger_Voltage_value;?> V</td>
                                                    </tr>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">>
                                                            <?php echo $v_Board_Temperature_ref_2_31; ?> °C

                                                            &nbsp;& &nbsp;< <?php echo $v_Board_Temperature_ref_2_15; ?>
                                                                °C &nbsp;&&nbsp; Δ <
                                                                <?php echo $v_Board_Temperature_ref_2_1; ?> °C</td>


                                                        <td style="text-align: left">
                                                            <?php echo $v_Board_Temperature_value ;?> °C</td>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo $v_ExternalTemperature_value;?> °C</td>
                                                    </tr>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo ($v_batt_current_sensor_voltage_ref_2_0 ); ?> +/-
                                                            <?php echo ($v_batt_current_sensor_voltage_ref_2_1 ); ?> V
                                                        </td>

                                                        <td style="text-align: left">
                                                            <?php echo $v_batt_current_sensor_voltage_value;?> V</td>
                                                    </tr>

                                                    <tr>
                                                        <td style="text-align: left"><br>Battery Current Sensor Residual
                                                            Current </td>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo ($v_Battery_Current_Sensor_Residual_Current_ref_2_5 ); ?>
                                                            +/-
                                                            <?php echo ($v_Battery_Current_Sensor_Residual_Current_ref_2_1 ); ?>
                                                            mA</td>

                                                        <td style="text-align: left">
                                                            <?php echo $v_Battery_Current_Sensor_Residual_Current_value;?>
                                                            mA</td>
                                                    </tr>
...
?>
                                                    ...
                                                    <tr>
                                                        <th colspan=4 style="text-align: left">
                                                            <h5 style="text-decoration: underline;font-size:18px ">
                                                                <br>Power Stress:
                                                            </h5>
                                                        </th>
                                                    </tr>
                                        ...
                                        <div name="divallgraphstress" id="divallgraphstress" class='divallgraphstress'>
                                            ...
                                            <div class="container-fluid " id="divgrafico700mp" name="divgrafico700mp">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12   " id="divgraf_current_pwr"
                                                        name="divgraf_current_pwr">

                                                        <div class="chart">
                                                            <canvas id="graf_current_pwr" height="280"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12   " id="divgraf_current_read"
                                                            name="divgraf_current_read">

                                                            <div class="chart">
                                                                <canvas id="graf_current_read" height="280"
                                                                    style="height: 280;"></canvas>
                                                            </div>
                                                        </div>


                                                        <div class="col-12    " id="divgraf_volt_readsepa"
                                                            name="divgraf_volt_readsepa">

                                                            <div class="chart">
                                                                <canvas id="graf_volt_readsepa" height="280"
                                                                    style="height: 280;"></canvas>
                                                            </div>
                                                        </div>


                                                        <div class="col-12    " id="divgraf_volt_read"
                                                            name="divgraf_volt_read">

                                                            <div class="chart">
                                                                <canvas id="graf_volt_read" height="280"
                                                                    style="height: 280;"></canvas>
                                                            </div>
                                                        </div>

                                                        <div class="col-12    " id="divgraf_volt_read2"
                                                            name="divgraf_volt_read2">

                                                            <div class="chart">
                                                                <canvas id="graf_volt_read2" height="280"
                                                                    style="height: 280;"></canvas>
                                                            </div>
                                                        </div>
...
function armar_graficos_imdstress() {
    ...
    ///////////////////////
    $.ajax({
        url: 'ajax_graph_reportstressbbuhp.php?unitsn=' + params.get('unitsn') + '&idrun=' + params.get(
            'idrun'),
