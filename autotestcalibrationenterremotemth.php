...
select 'AGC_ACTING', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(distinct fas_outcome_integral.v_double order by fas_outcome_integral.v_double),  ARRAY_AGG( distinct fas_outcome_integral.v_integer order by fas_outcome_integral.v_integer)
from fas_outcome_integral
inner join ( 
            ...
            { 
               ...
               //     echo "<br><br>aca entre lbl lsgp 0-0:".$rowdatos['arrayintegerm'];
                ...
                if ($rowdatos['idfasoutcomecat'] == 11 && $rowdatos['idtype'] ==7)
                {
                  if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] ==1)
                  {
                 // echo "<br>ACAMARCO".$rowdatos['iduniqueop']."--".$rowdatos['tipocalculo']."--".$rowdatos['idband']."--".$rowdatos['uldl']."--".$rowdatos['arrayintegerm']."--".$rowdatos['instance']."--".$rowdatos['tipocalculo']."--";
...
/*
  ...
  //    echo "<br> datos originakles->agc_band_0_1::".$agc_band_0_1;
...
<h6 class="colornaranajafiplex"><b>Lineality  Test</b> [ Max Power Vs AGC amount ]</h6> 
  ...
  <div class="col-3 d-none">
          ...
          <!-- Sales Chart Canvas -->
                ...
                <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                    <div class="card-tools">
                    <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','002007031','<?php echo  $elruninfo; ?>','0')">
  ...
  <div class="card">
          <!-- Sales Chart Canvas -->
                ...
                <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                    <div class="card-tools">
                    <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','002007031','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
  ...
  <!-- Graficos de ganancia- ---->
      ...
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','002007013','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
                              </a>
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','002007013','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
                              </a>
  ...
  <!-- Graficos de max pwr- ---->
      ...
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00200701A','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00200701A','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
  ...
  <div class="row">
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        ...
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00200701B','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00200701B','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
