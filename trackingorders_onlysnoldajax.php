                        ...
                        $sqlbusco ="select distinct  1 as orr, orders.idorders  ,
                            ...
                            ,        tienecalibracion.totalpass::int as tienecalibration_totalpass, tienecalibracion.calibrationscript::int as tienecalibration_calibrationscript,
                                        ...
                                        where orders.idorders = ".$v_idp."    and orders_sn.wo_serialnumber = '".$snafiltrar."'   and  products.modelciu not like '%LIC%'
                                                      and orders_sn.idnroserie >0  and orders_sn.so_soft_external not like '%SO%'   and 
                                                      orders_sn_SOassociada.so_soft_external not like '%RM%' 
                                        ...
                                        ,       0 as tienecalibration_totalpass, 0 as tienecalibration_calibrationscript,
                                         ...
                                         and products.idproduct in (
                                            select distinct idproduct from fnt_select_allproducts_maxrev() where iduniquebranchsonprod like '%001000010094%' or  iduniquebranchsonprod like '%00020007%' 
                                            union 
                                            select distinct idproduct from fnt_select_allproducts_maxrev() where iduniquebranchsonprod like '%001000010038008200880090%'  
                                            )
                        ...
                        $sqlbusco ="select distinct 1 as orr,  orders.idorders  ,
                            ...
                            ,        tienecalibracion.totalpass::int as tienecalibration_totalpass, tienecalibracion.calibrationscript::int as tienecalibration_calibrationscript,
                                        ...
                                        ,       0 as tienecalibration_totalpass, 0 as tienecalibration_calibrationscript,
                                         ...
                                         select distinct idproduct from fnt_select_allproducts_maxrev() where iduniquebranchsonprod like '%00010038%'
                                         union 
                                         select distinct idproduct from fnt_select_allproducts_maxrev() where iduniquebranchsonprod like '%001000010038008200880090%'  )
                                              ...
                                              ///    tienesoasociada
                                                  ...
                                                  else
                                                  {
                                                    ...
                                                    ?>
                                                            ...
                                                            <?php
                                                  if( $_SESSION["g"] =='develop' || 'Productionadmin' ==  $_SESSION["g"]  || $_SESSION["g"] == "Quality")
                                                  {
                                                    ?>
                                                            <br> <a
                                          ...
                                          if ($rowpasos['stepfunction']=="so_final_inspection_bbu")
                                          {
                                             /////**************************************************** 
                                               ...
                                               ?>
                                                                        ...
                                                                        <a href="#"
                                                                            onclick="show_info('Precheckfinalcheck','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $rowbuscawo['tienesoasociada']; ?>','<?php echo $rowbuscawo['tienesomodelciuso']; ?>','Quality Calibration Precheck',0)">
                                                                            <span class="icon"> <i
                                                                                    class="fas fa-tasks"></i> </span>
                                                                            <span class="text"> <b>Final Inspection
                                                                                    ...
                                                                                    <br></b></span>
                                                                            <?php
                                                 $sqldetectchkeo="SELECT   status_sn  FROM public.fas_survey_responses_bysn where  idsurvey = 3 and  sn = '".$rowbuscawo['wo_serialnumber']."' and  so = '".$rowbuscawo['tienesoasociada']."' and modelciu = '".$rowbuscawo['tienesomodelciuso']."'
                                                 order by datetimecheck desc limit 1 ";
