...
on products_branch.idproductsbranch = business_branch_tree.idprodbranchson where products_branch.active='Y' and havefw='Y' 
and  business_branch_tree.idbusiness =".$idbu." order by iduniquebranchprod ,  description ";
