...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Acceptance Enterprise - TimeLine</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Acceptance Enterprise </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
from (
  ...
  select 'ADVALUE_ALLVER' as tipocalculo, idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by fas_outcome_integral.reference) as arraydoublem,  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference) as  arrayintegerm
...
select 'AGC_ACTING', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by fas_outcome_integral.reference),  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference)
from fas_outcome_integral
inner join ( 
...
union 
  ...
  select 'FREQ_PWR_IN', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by  fas_outcome_integral.reference),  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference)
  from fas_outcome_integral
  inner join ( 
  ...
  on fas_outcome_category_type.idfasoutcomecat = fas_outcome_integral.idfasoutcomecat and 
  fas_outcome_category_type.idtype			 = fas_outcome_integral.idtype
  where fas_outcome_integral.idfasoutcomecat in (6,7,25,2) and fas_outcome_integral.idtype in (0,1,2)
  group by idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype 

union 
 

select 'PWR_OUT_MEASURE', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by fas_outcome_integral.reference),  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference)
from fas_outcome_integral
inner join ( 
...
select 'PWR_OUT', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by fas_outcome_integral.reference),  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference)
 from (
...
where 
fas_outcome_integral.idfasoutcomecat =2 and fas_outcome_integral.idtype in(19,24,25)
group by idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype 

union 

select 'PWR_OUT_REF', idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype ,  ARRAY_AGG(fas_outcome_integral.v_double order by fas_outcome_integral.reference),  ARRAY_AGG(fas_outcome_integral.v_integer order by fas_outcome_integral.reference)
from fas_outcome_integral	
inner join ( 
...
on losoutcome.iduniqueop = fas_outcome_integral.reference
where 
fas_outcome_integral.idfasoutcomecat =2 and fas_outcome_integral.idtype in(1,25)
group by idband , uldl, iduniqueop, nomband, fas_outcome_integral.idfasoutcomecat, fas_outcome_integral.idtype 
  ...
  on lasmediciones.iduniqueop =  fas_routines_process_sn.iduniqueop
   ...
   ///example__ $onlyconsonants = str_replace($vowels, "", "Hello World of PHP");
    ...
    foreach ($datacabez as $rowdatos)     
    {
      ...
      /////IMD3 Check
            if("00E041047" ===$rowdatos['instance'])
              {
                ...
                if ($rowdatos['idfasoutcomecat'] == 7 && $rowdatos['idtype'] ==1)
                {
                  ...
                  if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] ==1)
                  {
                //    echo "<br>778899-->CAT::".$rowdatos['idfasoutcomecat']." - tipo:".$rowdatos['idtype']."-tipocal:".$rowdatos['tipocalculo']."--".$rowdatos['idband']."--".$rowdatos['uldl']."--".$rowdatos['arraydoublem']."--".$rowdatos['instance']."--".$rowdatos['tipocalculo']."--";
                 ...
                 //*****MAX PWR Check  */
            if("00E041045" ===$rowdatos['instance'])   
            {

               ///**************** */
               if ($rowdatos['idfasoutcomecat'] == 2 && $rowdatos['idtype'] ==1 )
               {
                    if("PWR_OUT_REF" ==$rowdatos['tipocalculo'])
                    {
                      if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] == 0 ) { $tolerance_maxpwr_0_0 =$rowdatos['arraydoublem'];      $tolerance_maxpwr_0_0=  str_replace($simbolosareemplazar, "", $tolerance_maxpwr_0_0); }
                      if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] == 1 ) {  $tolerance_maxpwr_0_1 =$rowdatos['arraydoublem'];  $tolerance_maxpwr_0_1=  str_replace($simbolosareemplazar, "", $tolerance_maxpwr_0_1);  } 
                      if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] == 0 ) { $tolerance_maxpwr_1_0 =$rowdatos['arraydoublem'];  $tolerance_maxpwr_1_0=  str_replace($simbolosareemplazar, "", $tolerance_maxpwr_1_0);  }
                      if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] == 1 ) {  $tolerance_maxpwr_1_1 =$rowdatos['arraydoublem']; $tolerance_maxpwr_1_1=  str_replace($simbolosareemplazar, "", $tolerance_maxpwr_1_1);  }
                    }
                }    
               if ($rowdatos['idfasoutcomecat'] == 2 && $rowdatos['idtype'] ==25)
               {
                    if("PWR_OUT_REF" ==$rowdatos['tipocalculo'])
                    {
                  ///       echo "<br>778899-->CAT::".$rowdatos['idfasoutcomecat']." - tipo:".$rowdatos['idtype']."-tipocal:".$rowdatos['tipocalculo']."--".$rowdatos['idband']."--".$rowdatos['uldl']."--".$rowdatos['arraydoublem']."--".$rowdatos['instance']."--".$rowdatos['tipocalculo']."--"; 
                      if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] == 0 ) {  $pwr_reach_maxpwr_0_0 =$rowdatos['arraydoublem'];     $pwr_reach_maxpwr_0_0=  str_replace($simbolosareemplazar, "", $pwr_reach_maxpwr_0_0); }
                      if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] == 1 ) {  $pwr_reach_maxpwr_0_1 =$rowdatos['arraydoublem'];     $pwr_reach_maxpwr_0_1=  str_replace($simbolosareemplazar, "", $pwr_reach_maxpwr_0_1); }
                      if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] == 0 ) {  $pwr_reach_maxpwr_1_0 =$rowdatos['arraydoublem'];     $pwr_reach_maxpwr_1_0=  str_replace($simbolosareemplazar, "", $pwr_reach_maxpwr_1_0); }
                      if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] == 1 ) {  $pwr_reach_maxpwr_1_1 =$rowdatos['arraydoublem'];     $pwr_reach_maxpwr_1_1=  str_replace($simbolosareemplazar, "", $pwr_reach_maxpwr_1_1); }
                    }
       ...
       if("00E041044" ===$rowdatos['instance'])
       {
       ...
       //*****LSGP Check Power  */
       if("001004014022" ===$rowdatos['instance'])
       {
...
/*
    ...
    $pwr_out_measure_band_1_1=" 36.1,33.1,30.1,27.1,24.1";*/
     ...
     //echo "<br>HOLA tolerance_maxpwr_1_0".$tolerance_maxpwr_1_0;
    // echo "<br>HOLA pwr_reach_maxpwr_1_0".$pwr_reach_maxpwr_1_0;
...
<h6 class="colornaranajafiplex d-none"><b>AGC Table Calibration </b></h6> 
...
<h6 class="colornaranajafiplex d-none"><b>Dynamic AGC Test</b></h6> 
  <div class="row d-none">
  <div class="col-3">
  ...
  <!-- Graficos de ganancia- ---->
      ...
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041044','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
                              </a>
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041044','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
                              </a>
  ...
  <!-- Graficos de max pwr- ---->
      ...
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041045','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041045','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
  ...
  <div class="row">
      <div class="col-3">
              ...
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>700 UL </b></h5>
                        ...
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041047','<?php echo  $elruninfo; ?>','0')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
      ...
      <div class="card">
              <!-- Sales Chart Canvas -->
                    ...
                    <h5 class="card-title colorazulfiplex"><b>  800 UL</b></h5>
                        <div class="card-tools">
                        <a href="#" onclick="abrirgaleria('<?php echo $elsn;?>','00E041047','<?php echo  $elruninfo; ?>','1')">
                        <i class='	fas fa-file-image' style='font-size:16px'></i> Plots</a> ::
