...
if ($hidmenu=="")
{
 ...
 include("funcionesgraphgeneric_fortest.php"); 
...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Accept Passive - TimeLine</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Accept Passive  </li>&nbsp;&nbsp;<a href="<?php echo $_SERVER['REQUEST_URI']; ?>" targer='_blank'> <span align="right">Open New Tab</span></a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<br>
  <h5 class="colorazulfiplex" >
    Cabinet Serial Number: <?php echo $v_sn; ?>
  </h5>
  <hr>
  <br>  <h6 class="colorazulfiplex" ><b>RF Parameters</b> &nbsp;&nbsp; 
 </h6>
...
<?php
  section_create_graph_VNA_by_idrun_sn($vv_idrununfo, $v_sn,29,'011093' ) ;
?>
