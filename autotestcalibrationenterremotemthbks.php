    ...
    foreach ($datacabez as $rowdatos)     
    {
      ...
      /////IMD3 Check
       ...
       if("001004015027" ==$rowdatos['instance'])
       {
        ...
        {
              if ($rowdatos['idfasoutcomecat'] == 11 && $rowdatos['idtype'] ==36)
              {
                if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] ==0)
                {
                  $lsgp_puntos_graf_despues_0_0 = $rowdatos['iduniqueop'];
                ...
                if ($rowdatos['idband'] == 0 && $rowdatos['uldl'] ==1)
                {
                  $lsgp_puntos_graf_despues_0_1 = $rowdatos['iduniqueop'];
                ...
                if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] ==0)
                {
                  $lsgp_puntos_graf_despues_1_0 = $rowdatos['iduniqueop'];
                ...
                if ($rowdatos['idband'] == 1 && $rowdatos['uldl'] ==1)
                {
                  $lsgp_puntos_graf_despues_1_1 = $rowdatos['iduniqueop'];
...
*/
 /////////////////////////// CONTROL 700 -800
  if ($lsgp_puntos_graf_despues_1_0 =="" && $lsgp_puntos_graf_antes_1_0=="" )
  {
