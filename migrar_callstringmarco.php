      ...
      for ($x = 0; $x <= 10; $x++) 
       {
         ...
         select 0, (select max(idproduct)+1 from products), 0, null, ciu, null,null, 'S', 'FntFASSAP', now(), false, false, 1,'00010114', null,null, 0, null, null
         from tmp_group_brp_routing
         left join fnt_select_allproducts_maxrev_bysap() as ppp
         on ppp.modelciu = tmp_group_brp_routing.ciu
         where  ppp.modelciu is null
         limit 1 ";
