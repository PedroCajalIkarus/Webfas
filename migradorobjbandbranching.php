  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ObjBand Vs Brancking Diego</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       left join 
         (
           select ciu, max(maxidrev) as maxidrev, ARRAY_AGG (idband || '#' ||description || '#' || ccc) losdatosobjband
           from
           (
           ...
           inner join idband
           on idband.idband	= objband.idband and  objband.idband not in(3,4)
         ...
         where ppp.idproduct>4000 and ppp.idproduct<5000
     ...
     $v_elmaxidrev_by_product= 0;
        ...
        //      echo "a verrr2:".$v_elmaxidrev_by_product;
         ...
         //         echo "<br>888 *NO  BDA ";
          ...
          //        echo "<brSI BDA: ".$posicion_coincidencia;
                  ...
                  $vv_dlgain =$row['gain_vhf_dh14'];
                  $vv_ulgain = $row['gain_vhf_dh14'];
           ...
           //     echo "<hr>";     
                $sqlobjband = "INSERT INTO public.objectband( ciu, idband, idportinul, idportoutul, idportindl, idportoutdl, dlgain, ulgain, dlmaxpwr, ulmaxpwr, class, ismodule, idproduct, idrev)
                  ...
                  echo $sqlobjband."<br>";
                  $sqlmas = $connect->prepare($sqlobjband );      
                 $sqlmas->execute();
                ...
                $sqlmas = $connect->prepare($sqlinsertattriband);      
                  $sqlmas->execute();
      ...
      //            echo "<hr>";     
          ...
          //     echo "<br>".$sqlinsertattri;
           ...
           ///mm     $sqlmas = $connect->prepare($sqlinsertattri);      
           ///mm     $sqlmas->execute();
         //     echo "<hr>";   
