        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Report Burnin </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<p align="right"><a href='' target="_blank">open charts in new tab</a></p>
...
include("db_conect_srv20.php"); 
    $vidlog = $_REQUEST['idr'];
	  $sql = $connect20->prepare("select 1 as ordersalida, fas_outcome_integral.idtype ,fasoutcometypename, concat( substring(v_date::TEXT,0,19), v_boolean::TEXT, v_integer::TEXT,v_double::TEXT,v_string) as resultado
	  ,'' as scriptname
	  ...
	  where reference = :vidruninfo and fas_outcome_integral.idtype =12
	  order by ordersalida, fasoutcometypename,scriptname  
				...
				$resultado_outcome = $sql->fetchAll();
					 foreach ($resultado_outcome as $row_outcome) 
	 					{
							 if ( $row_outcome['idtype'] ==3)
							 {							 
							    $repor_ciu = $row_outcome['resultado'] ;	


                  $sql= "select distinct  products.description as  descripcionciu from products
                  where modelciu  ='". $repor_ciu."'  ";
          ...
          //echo "<br>".$sql;
                          ...
                          $vejecucion = 1;
                            ...
                            {
                                                $descripcionciu =  $rowheaders['descripcionciu'];
                                              
                            }                   

                  					 
							 }
               if ( $row_outcome['idtype'] ==4)
							 {							 
							    $repor_sn = $row_outcome['resultado'] ;							 
							 }

               if ( $row_outcome['idtype'] ==7)
							 {							 
							    $repor_fasversion = $row_outcome['resultado'] ;							 
							 }

               if ( $row_outcome['idtype'] ==8)
							 {							 
							    $repor_fasfpga = $row_outcome['resultado'] ;							 
							 }
               if ( $row_outcome['idtype'] ==9)
							 {							 
							    $repor_fasuc = $row_outcome['resultado'] ;							 
							 }
               if ( $row_outcome['idtype'] ==10)
							 {							 
							    $repor_fasEthernet = $row_outcome['resultado'] ;							 
							 }
               if ( $row_outcome['idtype'] ==16)
							 {							 
							    $repor_userrunscript = $row_outcome['resultado'] ;							 
							 }
               

               if ( $row_outcome['idtype'] ==13)
							 {							 
                if ( $row_outcome['resultado'] =='true')
                {
                  $repor_totalpass =     "   <span class='badge bg-success'>Passed</span><br>";	
                }
                else
                {
                  $repor_totalpass = "    <span class='badge bg-danger'>Fail</span><br>";;			
                }
...
<tr>
<td style="text-align: left">CIU: <strong><?php echo   $repor_ciu; ?></strong> </td>
<td style="text-align: right">SN: <strong><?php echo   $repor_sn; ?></strong></td>

</tr>
<tr>
<td colspan="2" style="text-align: left">DESCRIPTION: <b>
<?php echo $descripcionciu; ?></b>
</td>
</tr>
...
<table class="table table-sm table-hover table-striped table-bordered text-center textotabla10">
<tbody><tr>
<td style="width: 30%;text-align: left">Calibrator: <strong><?php echo   $repor_userrunscript; ?>                                                                                              </strong></td>
<td style="width: 30%;text-align: left"> </td>
<td style="width: 30%;text-align: right">FAS Version: <strong><?php echo   $repor_fasversion; ?></strong></td>

</tr>
	<tr>
<td style="width: 30%;text-align: left">FW FPGA: <strong><?php echo   $repor_fasfpga; ?></strong></td>
<td style="width: 30%;text-align: left">FW uC: <strong><?php echo   $repor_fasuc; ?></strong></td>
<td style="width: 30%;text-align: left">FW Ethernet: <strong><?php echo   $repor_fasEthernet; ?></strong></td>
...
<br>
  <br>  <h5>RF Parameters <?php echo  $repor_totalpass; ?>
  </h5>
...
function armar_graficos_imdstress()
{
        ...
        $.ajax
        ({ 
          url: 'ajax_graph_reportburnin.php?idruninfo='+params.get('idr'),
        ...
        ///    console.log('IMD STRESS');
          ...
          $('#msjwaitline ').hide();
              ...
              ///console.log(keyssmm);
               ...
               var grafico700strimd02   = $('#grafico700strimdlbl00').get(0).getContext('2d'); 
         ...
         //      var grafico800strimd11 = $('#grafico800strimd11').get(0).getContext('2d'); 
                           ...
                           datos_values_pacurrent_0_0 = data.values_pacurrent_0_0.split(",");  
                            datos_values_pacurrent_0_1 = data.values_pacurrent_0_1.split(",");  
                            datos_values_pacurrent_1_0 = data.values_pacurrent_1_0.split(",");  
                            datos_values_pacurrent_1_1 = data.values_pacurrent_1_1.split(",");  

                         

                            for ( var i = 0, j = datos_values_pacurrent_0_0.length ; i < j; i++ ) {
                              if ( datos_values_pacurrent_0_0[ i ] == '' ) {
                                datos_values_pacurrent_0_0.splice( i, 1 );
                              i--;
                              }
                            }

                            for ( var i = 0, j = datos_values_pacurrent_0_1.length ; i < j; i++ ) {
                              if ( datos_values_pacurrent_0_1[ i ] == '' ) {
                                datos_values_pacurrent_0_1.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = datos_values_pacurrent_1_0.length ; i < j; i++ ) {
                              if ( datos_values_pacurrent_1_0[ i ] == '' ) {
                                datos_values_pacurrent_1_0.splice( i, 1 );
                              i--;
                              }
                            }

                            for ( var i = 0, j = datos_values_pacurrent_1_1.length ; i < j; i++ ) {
                              if ( datos_values_pacurrent_1_1[ i ] == '' ) {
                                datos_values_pacurrent_1_1.splice( i, 1 );
                              i--;
                              }
                            }
                            ...
                            rptlbl_label_pacurrent_0_0 = data.label_pacurrent_0_0.split(",");  
                            rptlbl_label_level_0_0 = data.label_level_0_0.split(",");  
                            rptlbl_label_temp_0_0 = data.label_temp_0_0.split(",");  
                          
                            values_temp_0_0 = data.values_temp_0_0.split(",");  
                            values_temp_0_1 = data.values_temp_0_1.split(",");  
                            values_temp_1_0 = data.values_temp_1_0.split(",");  
                            values_temp_1_1 = data.values_temp_1_1.split(",");  

                        
                            for ( var i = 0, j = values_temp_0_0.length ; i < j; i++ ) {
                              if ( values_temp_0_0[ i ] == '' ) {
                                values_temp_0_0.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = values_temp_0_1.length ; i < j; i++ ) {
                              if ( values_temp_0_1[ i ] == '' ) {
                                values_temp_0_1.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = values_temp_0_0.length ; i < j; i++ ) {
                            ...
                            for ( var i = 0, j = values_temp_1_0.length ; i < j; i++ ) {
                              if ( values_temp_1_0[ i ] == '' ) {
                                values_temp_1_0.splice( i, 1 );
                              i--;
                              }
                            }

                            values_level_0_0 = data.values_level_0_0.split(",");  
                            values_level_0_1 = data.values_level_0_1.split(",");  
                            values_level_1_0 = data.values_level_1_0.split(",");  
                            values_level_1_1 = data.values_level_1_1.split(",");  


                            for ( var i = 0, j = values_level_0_0.length ; i < j; i++ ) {
                              if ( values_level_0_0[ i ] == '' ) {
                                values_level_0_0.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = values_level_0_1.length ; i < j; i++ ) {
                              if ( values_level_0_1[ i ] == '' ) {
                                values_level_0_1.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = values_level_1_0.length ; i < j; i++ ) {
                              if ( values_level_1_0[ i ] == '' ) {
                                values_level_1_0.splice( i, 1 );
                              i--;
                              }
                            }
                            for ( var i = 0, j = values_level_1_1.length ; i < j; i++ ) {
                              if ( values_level_1_1[ i ] == '' ) {
                                values_level_1_1.splice( i, 1 );
                              i--;
                              }
                            }

                            lblname_0_0 = data.lblname_0_0 + ' - Uplink';
                            lblname_0_1 = data.lblname_0_1 + ' - Downlink';
                            lblname_1_0 = data.lblname_1_0 + ' - Uplink';
                            lblname_1_1 = data.lblname_1_1+ ' - Downlink';
                            ...
                            var optiontemp = {                             
                             ...
                             var optionimdstress_700_00= {                             
                                        ...
                                        var nuevolabel_0_0 =0;
                                           for (let i = 0; i < datos_values_pacurrent_1_0.length; i++) 
                                                  {
                                                    nuevolabel_0_0 = nuevolabel_0_0 + i + ',';
                                                  }
                                                 
                                                  nuevolabel_0_0= nuevolabel_0_0.split(',');     

                                      
                          /////////TEMP acamarco
                       var    sumarmunitos = new Date('2020-01-01 00:00:00');
                          var nuevolabeltemp_0_0_temp = [];
                                           for (let i = 0; i < rptlbl_label_level_0_0.length; i++) 
                                                  {
                                                  ///  nuevolabeltemp_0_0 = nuevolabeltemp_0_0 + i + ',';
                                            //      console.log(rptlbl_label_level_0_0[0]);
                                           //      console.log(rptlbl_label_level_0_0[i]);
                                                  var date1 = moment("2022-01-01 " + rptlbl_label_level_0_0[0]);
                                                  var date2 = moment("2022-01-01 " +rptlbl_label_level_0_0[i]);
                                                
                                            //      console.log(date1);
                                                  var diff = date2.diff(date1,'s');

                                                ///  var ssss = rptlbl_label_level_0_0[0] - rptlbl_label_level_0_0[i];
                                              //      console.log(diff);
                                             //       console.log(secondsToString(diff));
                                                    nuevolabeltemp_0_0_temp.push(secondsToString(diff));
                                                 ///   console.log(sumarmunitos.getSeconds());
                                            //        console.log('<-<-SUMO-<-');
                                                  
                                                  }
                                                 
                                                 // nuevolabeltemp_0_0= nuevolabeltemp_0_0.split(',');     
                                        ...
                                        labels  : nuevolabeltemp_0_0_temp,
                                                datasets: [
                                                {
                                                  ...
                                                  data                :  values_temp_0_0                                
                                                  },
                                                
                            ]
                          };

                          var datos_grafico_allband_PAcurrent = {
                                        labels  : nuevolabeltemp_0_0_temp,
                                                datasets: [
                                                {
                                                    label               :  lblname_0_0,
                                                    ...
                                                    pointHighlightFill  : '#fff',
                                                    pointHighlightStroke: 'rgba(60,141,188,1)',
                                                  data                :  datos_values_pacurrent_0_0                                
                                                  },
                                                {
                                                    label               :  lblname_0_1,	
                                                  ...
                                                  data          :  datos_values_pacurrent_0_1  
                                                  },
                                                  
                                                {
                                                    ...
                                                    pointHighlightFill  : '#fff',
                                                    pointHighlightStroke: 'rgba(60,141,188,1)',
                                                  data                :  datos_values_pacurrent_1_0                                
                                                  },
                                                {
                                                    label               :  lblname_1_1,
                                                  backgroundColor     : 'rgba(200, 99, 132, 0.1)',
                                                    ...
                                                    pointHighlightFill  : '#fff',
                                                    pointHighlightStroke: 'rgba(255, 99, 132, 1)',		
                                                  data          :  datos_values_pacurrent_1_1  
                                                  },
                            ]
                          };
                          ...
                          /////// LABEL
                          var nuevolabel_0_0_level =0;
                                           for (let i = 0; i < values_level_0_0.length; i++) 
                                                  {
                                                    nuevolabel_0_0_level = nuevolabel_0_0_level + i + ',';
                                                  }
                                                 
                                                  nuevolabel_0_0_level= nuevolabel_0_0_level.split(',');     

                                        var datos_grafico_allband_level = {
                                        labels  : nuevolabeltemp_0_0_temp,
                                                datasets: [
                                                {
                                                    label               :  lblname_0_0,
                            ...
                            var rpt_grafico700imdstress00 = new Chart(grafico700strimd00, { 
                              type: 'line', 	
                              data: datos_grafico_allband_PAcurrent, 	 
                              options: optionimdstress_700_00
                            });

                            var rpt_grafico700imdstress01 = new Chart(grafico700strimd02, { 
                              type: 'line', 	
                            ...
                            var rpt_grafico700imdstress02 = new Chart(grafico700strimd01, { 
                              type: 'line', 	
                              data: datos_grafico_allband_level, 	 
                              options: optionlevel 
                            });
