...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Accept DiB Analog BDA  - TimeLine</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Accept DiB Analog BDA  </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <?php
    ...
    $vv_idrununfo = $_REQUEST['idruninfo'];
          ...
          <hr>
				<div class="row">	
				<?php
				    section_create_graph_GAIN_by_idrun_sn($vv_idrununfo, $v_sn,40,'00E041044' ) ;
            echo "</div><br><hr><div class='row'>	";
            section_create_graph_MaxPwr_by_idrun_sn($vv_idrununfo, $v_sn,40,'00E041045') ;
            echo "</div><br><hr><div class='row'>	";
            section_create_graph_IMD_by_idrun_sn($vv_idrununfo, $v_sn,40,'00E041047') ;
