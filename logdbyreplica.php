  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
	   ...
	   exec("bucardo status", $output, $return);
...
<script type="text/javascript">
		...
		$(document).inactivityTimeout({
                inactivityWait: 100,
                dialogWait: 10,
                logoutUrl: 'logdbyreplica.php?autorefreshxinactivity:)'
            })
	...
	$( document ).ready(function() {
		...
		////aca vamos a probar el tablulator
			...
			var table = new Tabulator("#example-table", {
					height:altor,
					layout:"fitDataFill",									
					ajaxURL:"getruninfojsontabultordb.php",
					...
					columns:[
							...
							{title:" <i class='fa fa-fw fa-calendar'></i> Date", field:"fechacorta", sorter:"date", width:120,headerFilter:"input"},							
	 ...
	 /* requesting data */
		...
		function show_log_bs(id_business)
		{
			...
			var vv_station ="";
					...
					height:altor,
					layout:"fitColumns",									
					ajaxURL:"getruninfojsontabultordb.php?idb="+id_business,
					ajaxProgressiveLoad:"scroll",					
					selectable:1,
					selectableRollingSelection:true,
					 selectablePersistence:false,
