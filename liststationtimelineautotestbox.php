...
<?php
  $sql = $connect->prepare("select distinct fas_routines_product.*,fas_step.description as branchname ,fas_routines_product_sn.sn , CASE fas_routines_product.idband
  WHEN 0  THEN 0
  WHEN 3  THEN 0
  WHEN 4  THEN 1
  WHEN 8  THEN 1
  ...
  WHEN 6  THEN 1
  ELSE NULL
  END AS idbandperson, fas_tree_measure2.totalpass
...
on fas_routines_product_sn.idproduct		=	fas_routines_product.idproduct and
fas_routines_product_sn.idscript			=	fas_routines_product.idscript and
fas_routines_product_sn.iduniquebranch		=	fas_routines_product.iduniquebranch and
fas_routines_product_sn.idband				=	fas_routines_product.idband and
fas_routines_product_sn.uldl				=	fas_routines_product.uldl and
fas_routines_product_sn.sn = '21066031FU' 	
left join fnt_select_allfas_tree_measure_maxrev2() as fas_tree_measure2
on fas_tree_measure2.unitsn = fas_routines_product_sn.sn and 
fas_tree_measure2.idrununfo  = fas_routines_product_sn.idruninfo and 
fas_tree_measure2.iduniquebranch = fas_routines_product_sn.iduniquebranch
where fas_routines_product.idproduct = (SELECT distinct idproduct from fas_routines_product_sn where sn = '21066031FU') 
and fas_routines_product.active = 'Y'
order by fas_routines_product.idorden asc
            ...
            //  echo "* -".$row['branchname']."<br>";
              ?>
                <li class="tl-item" ng-repeat="item in retailer_history">
                  ...
                  {
                    ?>
                       <b><?php echo $row['branchname']." [ Band: ".$row['idbandperson']." - ULDL: ".$row['uldl']." ]";?></b> 
                     <?php
                   }
                   else
                   {
...
<script type="text/javascript">
  ...
  var options = {
    ...
    tooltip: {
      template: function(originalItemData, parsedItemData) {
        ...
        return `<span style="font:10px;color:${color}">${originalItemData.title}</span>`;
      }
    }
  };
  ...
  $.ajax
			({ 
				url: 'ajax_timelinejsonautotestbox1.php',
				data: "idlog=",	
				type: 'post',
				async:true,
        cache:false,
