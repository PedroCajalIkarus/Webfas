...
$where_sn_add ="  and orders_sn.wo_serialnumber ='". $vsn."' ";    
    ...
    //   echo "<br>te".$idorder_so."tete:". $model_ciu_so;       
...
order by typestruct, v_integer
 ...
 // echo "<br>Primer query:<br> ".$query_lista ;       
  ...
  $data = $connect->query($query_lista)->fetchAll();	
    ...
    {
   //   echo $rowsteps['v_string']."--->".substr( $rowsteps['v_string'], 0, 2);
      if (   substr( $rowsteps['v_string'], 0, 2)=="wo"  ||  substr( $rowsteps['v_string'], 0, 4)=="AS01" ||  substr( $rowsteps['v_string'], 0, 4)=="AP01"  )
      {
        $have_wo='Y' ;
      }
    ...
    foreach ($data as $row_autotest) 
    {
     ...
     ///  so_FINALCAL
              ...
              ///         echo "sssssssssssssssssssssssssssssssssssss".$ref_so;
                    ...
                    if  ($row_autotest['v_string']  =="wo_PRECHECK" || $row_autotest['v_string']  =="wo_RWKPRECHECK"  || $nvostepsrouting[0] == "PC01" )
                    {
...
<div class="step <?php echo  $activo_paso3; ?>">
    ...
    <br><a
        ...
        target="_blank"> <i class='fas fa-file-pdf'></i> - View Report 9 </a>
    <br>
