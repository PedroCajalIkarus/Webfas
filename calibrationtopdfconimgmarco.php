...
<h2 style="text-decoration: underline;">Parameters 2:</h2>
...
<td style="text-align: left"><?php echo floor($v_dl_gain_pwr); ?> (dBm) </td>
<th style="text-align: left">UL Max Pwr Out:</th>
<td style="text-align: left"><?php echo floor($v_ul_gain_pwr); ?> (dBm) </td>
</tr>
<tr>
