...
//echo $sqltieneso;
   ...
   //   echo $rowsteps['v_string']."--->".substr( $rowsteps['v_string'], 0, 2)."<br>";
      if (  $rowsteps['typeregister'] =="WO"  || substr( $rowsteps['v_string'], 0, 2)=="wo"  ||  substr( $rowsteps['v_string'], 0, 4)=="AS01" ||  substr( $rowsteps['v_string'], 0, 4)=="AP01" ||  substr( $rowsteps['v_string'], 0, 4)=="SA01" ||  substr( $rowsteps['v_string'], 0, 4)=="AP02" ||  substr( $rowsteps['v_string'], 0, 4)=="AP05" )
      {
        $have_wo='Y' ;
      }
  ...
  echo  "<a href='trackingorders.php?isdo=".$idorders."&typeisdo=".$dondeinicio."&encont=".$vsn."'>&nbsp;</a><br><br>";
   ...
   //  echo "<br>STEPS:".$row_autotest['stepsarray']."--typeregister->".$row_autotest['typeregister'];
    ...
    //  echo "<br>3-->". ($decode_steps[2]['v_string'] );
      ...
      echo "<br>OJO AQUI".$step_nro_ary;
   
      $step_name_ary=strtolower($row_autotest['typeregister'])."_".trim($decode_steps[1]['v_string'] );
      echo "<br>NvoSteps:".$step_name_ary."..y aca:".$nvostepsrouting[0]."<br><br>";
      ...
      //acamm1           $haveSOasing="Y"; 
           ...
           //    echo "*******************-a ver".                   $nvostepsrouting[0]; 
                  if ( $nvostepsrouting[0] == "BBU" )
                  {
                    ...
                    {
                      crear_steps_wo_BBUMMS_HP("so_FINALCAL" ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_wo,$ref_wo,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step,$step_nro_ary);
                    }
                    else
                    {
                       crear_steps_wo_BBUMMS_HP("so_FINALCAL" ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_so,$ref_so,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step,$step_nro_ary);
                    }
                  ...
                  {
                   echo substr($model_ciu_wo, 0, 5)."MATI".$model_ciu_wo;
                    if ($step_name_ary  !="wo_FINALCAL" && ($nvostepsrouting[0]==""  || $nvostepsrouting[0]=="Final Calibration" || $nvostepsrouting[0]=="Personalization"))
                    {
                    ...
                    {
                        if ($step_name_ary  =="wo_FINALCAL" && (   substr($model_ciu_wo, 0, 5) =="DH440" ||  substr($model_ciu_wo, 0, 5) =="DHS40" ) )
                        {
                          crear_steps_so_FINALCAL($step_name_ary ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_wo,$ref_wo,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step, $row_autotest['v_integer'],$step_nro_ary );
              ...
              ///  echo "aaaaver::::".$nvostepsrouting[0];
                ...
                if ($step_name_ary  =="wo_FINALCAL" && $nvostepsrouting[0]=="Final Calibration"  )
                {
                  ...
                  $tengofuncionecreada=1;
                //marco$aca aca mando 1 para ocultar el SO Step
             
                  crear_steps_so_FINALCAL($step_name_ary ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_wo,$ref_wo,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step, 1,$step_nro_ary );
                }
                
                if ($step_name_ary  =="wo_FINALCAL" && $nvostepsrouting[0]==""  )
                {
                 
                echo "idorder_wo->".$idorder_wo."ref_woA123->".$ref_wo."model_ciu_wo->".$model_ciu_wo."idorder_so->".$idorder_so."ref_so->".$ref_so."model_ciu_so->".$model_ciu_so."->".$vvnombre_a_mostrar_en_dvi."->". $enabled_attachfile_step."->". $row_autotest['v_integer'];
                ...
                //    echo "----"."wo_".$idorder_wo."<--->".$ref_wo,$model_ciu_wo."<--->".$ref_wo."<--->". $enabled_attachfile_step; 
                    ...
                    if  ($step_name_ary  =="wo_ASSY" || $nvostepsrouting[0] == "SA01"  || $nvostepsrouting[0] == "AS01" || $nvostepsrouting[0] == "AP01"  || $nvostepsrouting[0] == "AP05" )
                    { 
                    $tengofuncionecreada=1;
                 ...
                 //    echo "----"."wo_".$step_name_ary."<--->".$row_autotest['wo_serialnumber']."<--->".$row_autotest['idorders']."<--->".$vvnombre_a_mostrar_en_dvi."<--->".$ref_wo,$model_ciu_wo."<--->".$ref_wo."<--->". $enabled_attachfile_step; 
                    ...
                    if  (   $nvostepsrouting[0] == "FC05"   )
                    {
                    $tengofuncionecreada=1;
                    $vvnombre_a_mostrar_en_dvi ='Order Detail :: '.$ref_wo." - SN: ".$rowbuscawo['wo_serialnumber'];
                 
                      crear_steps_wo_BBUnvo2("wo_BBUMMSRF" ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_so,$ref_so,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step,$step_nro_ary);
                    }
              ...
              ///         echo "sssssssssssssssssssssssssssssssssssss".$ref_so;
               //    echo "----"."wo_".$step_name_ary."<--->".$row_autotest['wo_serialnumber']."<--->idorder_so".$idorder_so."<--->ref_so".$ref_so."<--->".$ref_wo,$model_ciu_wo."<--->".$ref_wo."<--->". $enabled_attachfile_step; 
                ...
                ///    echo "<br><br>MARCO:".$step_name_ary."---".$nvostepsrouting[0]."--tengo".$show_stepSO_missing;
                    
                    if   ($step_name_ary  =="so_INFOSO"  && $nvostepsrouting[0]=="INFOSO" && $show_stepSO_missing=='N'  )
                    {
                    $tengofuncionecreada=1;
                    $show_stepSO_missing='Y';
                    $haveSOasing="Y"; 
                    $vvnombre_a_mostrar_en_dvi ='Order Detail :: SO:'.$ref_so." - SN: ".$rowbuscawo['wo_serialnumber'];                              
               ///   echo "<br>*9*9*9*model_ciu_so".$model_ciu_so;
                        if ( $model_ciu_so =='')
                          {
                              //****************************

                              $Sql_ifso = $connect->prepare(" select distinct so_soft_external , idorders, modelciu from orders_sn inner join products on products.idproduct = orders_sn.idproduct   where wo_serialnumber = '".$rowbuscawo['wo_serialnumber']."' and typeregister = 'SO' ");                                 
                              $Sql_ifso->execute();
                              $result_so = $Sql_ifso->fetchAll();	
                              foreach ($result_so as $row_somm)
                              {
                                $idorder_so = $row_somm['idorders'];
                                $ref_so =  $row_somm['so_soft_external'];
                                $model_ciu_so =  $row_somm['modelciu'];
                      //          echo "ENTRE bus".$ref_so."co SO".$row_somm['modelciu'];
                              }
                              //****************************
                          }
                      crear_steps_soinfo_only($step_name_ary ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_so,$ref_so,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step,$step_nro_ary);
         ...
         if($haveSOasing == "Y" && $rowbuscawo['wo_serialnumber']<>'')
         {
          ...
          foreach ($result_ifup as $row_up)
          {
            ...
            crear_steps_so_UPGRADELIC($step_name_ary ,$row_autotest['wo_serialnumber'], $idorder_wo,$ref_wo,$model_ciu_wo,$idorder_so,$ref_so,$model_ciu_so ,$vvnombre_a_mostrar_en_dvi, $enabled_attachfile_step,$step_nro_ary);
             ...
             echo $have_so."aaaaaaaaaaaaaaaaaaaa*".trim($haveSOasing)."*bbbbbbbbbbbbbbbbbbbb".$haveSteps;
...
echo $vvv_idso_nom."<br>rrrrrrrrrrrrrrrrreeeeeeeeeeeeeeeeeeeeee".$vvv_idwo; 
...
<div class="stepazul   active">
    ...
    <a href="#"
        ...
        <span class="text text-center">
            ...
            <b> SO:MM [<?php echo $vvv_idso_nom; ?>]<br>CIU: [<?php echo  $vvv_idso_ciu; ?>]</b>
...
else
{
  ...
  else
  {
    ...
    if ($name_js_report  =="calibbburepot")
    {
      $idruninfoAfertburnung=99;  
      $tipolinkweb=" ";
      $namephp="calibbburepot.php";
    }                                              
    /* if ( $vv_sn=="24034599FU")
     {
      $idruninfoAfertburnung=99;  
    ...
    <div class="  <?php echo $tieneregelstep;?> ">
        ...
        <?php
           ...
           else
           {
            ...
            $simulate_pass_fas="step";
              if ( (   substr($vvv_idwo_ciu, 0, 5) =="DH440" ||  substr($vvv_idwo_ciu, 0, 5) =="DHS40" ) )
              {
               
                
                
                $sql_attaanalogbda = $connect->prepare(" select * from orders_fileattach
                where idorders = ".$vv_idp." and sn = '".$vv_sn."' ");   
                ...
                {
                  $simulate_pass_fas="stepverde  active";
            ...
            ?>
        <div class="<?php echo  $simulate_pass_fas; ?> "> <span class="icon"> <i class="fas fa-box"></i> </span> <span
                class="text">  <?php echo $vvv_idso_ciu. '['.$vv_step_nro_ary.'] - '.$vv_worcenter_show; ?><br>
...
function crear_steps_wo_AFTERBURNING ($vv_worcenter,$vv_sn, $vvv_idwo,$vvv_idwo_nom,$vvv_idwo_ciu , $vvv_idso,$vvv_idso_nom,$vvv_idso_ciu, $vvnombre_a_mostrar_en_dvi, $v_enable_attachfile,$vv_step_nro_ary)
{
  ...
  $psswdtkkey = substr( md5(microtime()), 2, 8);
    ...
    inner join ( select reference, v_integer as idscript from fas_outcome_integral 
              ...
              and idfasoutcomecat = 0 and idtype= 12 and v_integer in( 33,38,52,3 )
               ) as lossub
    on lossub.reference = fas_outcome_integral.reference
    where fas_outcome_integral.idfasoutcomecat = 0 and 
...
function crear_steps_wo_BBUnvo2 ($vv_worcenter,$vv_sn, $vvv_idwo,$vvv_idwo_nom,$vvv_idwo_ciu , $vvv_idso,$vvv_idso_nom,$vvv_idso_ciu, $vvnombre_a_mostrar_en_dvi, $v_enable_attachfile,$vv_step_nro_ary)
 { 
 ...
 inner join ( select reference, v_integer as idscript from fas_outcome_integral 
           ...
           and idfasoutcomecat = 0 and idtype= 12 and v_integer in( 62 )
            ) as lossub
 on lossub.reference = fas_outcome_integral.reference
 where fas_outcome_integral.idfasoutcomecat = 0 and 
 fas_outcome_integral.idtype= 13
 ...
 /////Buscamos el tipo de reporte para el SKU
  ...
  $name_js_report = 'calibbburepot_bbumvo2_bbu';    
            ...
            <div class="step <?php echo  $activo_paso3; ?>">
                <a href="#"
                    ...
                    <span class="icon">
                        ...
                        <?php echo  '['.$vv_step_nro_ary.'] - '; ?><b> FINALCAL [BBU NVO2]<br>
                    </span></b></a>
     ...
     ";
           ...
           exit();
             ...
             foreach ($datahist as $row2hh) 
             {
                 ...
                 if ($row2hh['v_state']==8)
                 {
                  echo "<br><span class='badge bg-info' title='".$row2hh['v_state_result']."'>SAP::OK ACK FIX</span>";
                 }
                 /// echo "<br>".$row2hh['v_state_result'];
             }  
...
else
{
  ?>
           ...
           $sqlmaxhistory = " select * from fas_to_sap_xml where v_sn ='".$vv_sn."' and v_workcenetr = 'FINALCAL' 
              and v_sku = '".$modelciuwo."' and
           runprocessdate in (
...
inner join ( select reference, v_integer as idscript from fas_outcome_integral 
					...
					and idfasoutcomecat = 0 and idtype= 122 and v_integer in( 999 )
				   ) as lossub
on lossub.reference = fas_outcome_integral.reference
where fas_outcome_integral.idfasoutcomecat = 0 and 
fas_outcome_integral.idtype= 13
...
////// BURNING NO TENEMOS ACCIONES DESDE FAS
$name_js_report = '';  
?>
                                <div class="step <?php echo  $activo_paso3; ?>"> 
                                        <span class="icon"> <i class="fas fa-box"></i> </span> <span
                                            class="text"><?php echo '['.$vv_step_nro_ary.'] - ';?><b>BURNING <br>
                                                <?php echo $activo_paso3_totalpass; ?></span></b> </div>
                                <?php
//////
...
{
  include("db_conect.php"); 
   echo "<br>HOLA".$vv_worcenter."-wo".$vvv_idwo_nom."-SO".$vvv_idso_nom."-modelWO".$vvv_idwo_ciu ."-modelso".$vvv_idso_ciu;
     $vv_worcenter_show = substr(trim($vv_worcenter),3,10);
...
/*
   ...
   //  echo "SI,entre aca".  $wo_info ;
    ...
    if  ( $vv_worcenter =="wo_ASSY" || $vv_worcenter =="wo_2ND-ASSY"   )
    {
