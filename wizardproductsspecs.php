...
----------------------- MEJORAMOS 
				...
				*/
						...
						SELECT ciu, idband, idportinul, idportoutul, idportindl, idportoutdl, dlgain, ulgain, dlmaxpwr, ulmaxpwr, class, ismodule, idproduct, ".$maxidrevmasuno."
							FROM public.objectband
							where idproduct = ".$losvalores[1]." and idrev =  ".$losvalores[2];
					//	echo "<br>".$slqband."<hr>";
...
<form name="frma" id="frma" action="wizardproductsspecs.php" method="post" class="form-horizontal">
...
function filtrartodo()
	...
	console.log('losatributos'+ losatributos);
			...
			xhr2.open("POST", "searchcuicomponentfilters.php");
			xhr2.send(formData);
