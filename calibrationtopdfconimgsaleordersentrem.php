...
//query mejorado
//query mejorado
$queryinfo = " select * from fas_outcome_integral  where reference = ".$_REQUEST['idrunaferbur']."   AND idtype IN (7,8,9,10,36,37,16) ";
 ...
 $datainfoVersiones = $connect->query($queryinfo)->fetchAll();
								...
								$vejecucion = 1;
								  foreach ($datainfoVersiones as $rowversiones) 
								  {
									...
									{
										$namecalibration = $rowversiones['v_string'];
									}
									if( $rowversiones['idtype'] ==7)		
									{
										$fasversion = $rowversiones['v_string'];
									}

									if( $rowversiones['idtype'] ==8)		
									{
										$fpgaversion = $rowversiones['v_string'];
									}
									if( $rowversiones['idtype'] ==9)		
									{
										$ucversionfw = $rowversiones['v_string'];
									}
									if( $rowversiones['idtype'] ==10)		
									{
										$ethversionfw = $rowversiones['v_string'];
									}
									if( $rowversiones['idtype'] ==37)		
									{
										$HWName = $rowversiones['v_string'];
									}
									if( $rowversiones['idtype'] ==36)		
									{
										$HWVersion = $rowversiones['v_string'];
									}
								  }
...
<table style="width: 100%;  border-top: 1px solid black; border-bottom: 1px solid black; font-size: 12pt;">
<tr>
<td style='width: 30%;text-align: left'>Calibrator: <strong><?php echo $namecalibration;?></strong></td>
<td style='width: 30%;text-align: left'> </td>
<td style='width: 30%;text-align: right'>FAS Version: <strong><?php echo $fasversion;?></strong></td>

</tr>
<tr><td colspan=3><hr></td></tr>
<tr>
<td style='width: 30%;text-align: left'>FW FPGA: <strong><?php echo $fpgaversion;?></strong></td>
<td style='width: 30%;text-align: left'>FW uC: <strong><?php echo $ucversionfw ;?></strong></td>
<?php if ( $vv_idbusiness_ciu==1)
{
	?>
	<td style='width: 30%;text-align: left'>FW Ethernet: <strong><?php echo $ethversionfw;?></strong></td>
	<?php
}
?>
</tr>
<tr>
<td style='width: 30%;text-align: left'>HW Name: <strong><?php echo $HWName;?></strong></td>
<td style='width: 30%;text-align: left'>HW Version: <strong><?php echo $HWVersion ;?></strong></td>
</tr>
</table>
...
//echo "<br>2do::".$query_lista;
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////						
		////////////////////////////BUSCAMOS DATOS PARA LA 2DA TABLA////////////////////////////////////////
		foreach ($dataresumen as $rowresultrapido) 
						{	

							/// imd 00200701B
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==0 && $rowresultrapido['iduniquebranch'] ='00200701B')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(7) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==7)
												{
													$imd_read_0_0 = $rowresult2da['v_double'] ;
												}								 
												 
											}
							}
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==1 && $rowresultrapido['iduniquebranch'] ='00200701B')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(7) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==7)
												{
													$imd_read_0_1 = $rowresult2da['v_double'] ;
												}								 
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] ==0 && $rowresultrapido['iduniquebranch'] ='00200701B')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(7) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==7)
												{
													$imd_read_1_0 = $rowresult2da['v_double'] ;
												}								 
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] ==1 && $rowresultrapido['iduniquebranch'] ='00200701B')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(7) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==7)
												{
													$imd_read_1_1 = $rowresult2da['v_double'] ;
												}								 
							...
							/// maxpwr 00200701A
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==0 && $rowresultrapido['iduniquebranch'] ='00200701A')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(25,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==25)
												{
													$maxpwr_read_0_0 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$maxpwr_tolerance_0_0 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==1 && $rowresultrapido['iduniquebranch'] ='00200701A')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(25,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==25)
												{
													$maxpwr_read_0_1 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$maxpwr_tolerance_0_1 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] ==0 && $rowresultrapido['iduniquebranch'] ='00200701A')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(25,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==25)
												{
													$maxpwr_read_1_0 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$maxpwr_tolerance_1_0 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] ==1 && $rowresultrapido['iduniquebranch'] ='00200701A')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(25,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==25)
												{
													$maxpwr_read_1_1 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$maxpwr_tolerance_1_1 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							///// gain 002007013
							//echo "<br>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa". $rowresultrapido['iduniqueop'];
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==0 && $rowresultrapido['iduniquebranch'] ='002007013')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(24,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==24)
												{
													$gain_read_0_0 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$gain_tolerance_0_0 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==0 && $rowresultrapido['uldl'] ==1 && $rowresultrapido['iduniquebranch'] ='002007013')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(24,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
								//echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==24)
												{
													$gain_read_0_1 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$gain_tolerance_0_1 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] == 0 && $rowresultrapido['iduniquebranch'] ='002007013')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(24,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==24)
												{
													$gain_read_1_0 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$gain_tolerance_1_0 = $rowresult2da['v_double'] ;
												}
												 
											}
							}
							if ($rowresultrapido['band'] ==1 && $rowresultrapido['uldl'] == 1 && $rowresultrapido['iduniquebranch'] ='002007013')
							{
								$sql2databla ="select idtype, v_integer, v_double from fas_outcome_integral where idtype in(24,1) and idfasoutcomecat = 2 and reference = ".$rowresultrapido['iduniqueop'];
							//	echo $sql2databla;
								$dataresumen_xidoutcome = $connect->query($sql2databla)->fetchAll();
								foreach ($dataresumen_xidoutcome as $rowresult2da) 
											{
												if ($rowresult2da['idtype'] ==24)
												{
													$gain_read_1_1 = $rowresult2da['v_double'] ;
												}
												if ($rowresult2da['idtype'] ==1)
												{
													$gain_tolerance_1_1 = $rowresult2da['v_double'] ;
												}
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////	
		/// Probamos aca meter la tabla q era 2do graf
		...
		//	{
		  ...
		  ?>
					...
					//echo "cant band:".$quantityband."aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".$v_ban;
						...
						if(  $ciuisdas =="Y" && 	$ciuiscentrix=="Y")
						{
							echo "<b>".$label_band_amostrar; ?> <a href="finalchkallband.php?dnd=<?php echo $v_dnd;  ?>&idsndib=<?php echo $vparam_vnrounitsn; ?>&idmb=<?php echo $v_ban ; ?>&iduldl=<?php echo $v_uldl; ?>&idruninfo=<?php echo $vparam_idruninfo; ?>&idrunaferbur=<?php echo $_REQUEST['idrunaferbur']; ?>#"></b>  <i class="fas fa-eye"></i> </a></td>
							<?php
						}
						else
						{
							echo "<b>".$label_band_amostrar ." - ".$label_ULDL_amostrar; ?> <a href="finalchkallband.php?dnd=<?php echo $v_dnd;  ?>&idsndib=<?php echo $vparam_vnrounitsn; ?>&idmb=<?php echo $v_ban ; ?>&iduldl=<?php echo $v_uldl; ?>&idruninfo=<?php echo $vparam_idruninfo; ?>&idrunaferbur=<?php echo $_REQUEST['idrunaferbur']; ?>#"></b> <i class="fas fa-eye"></i> </a></td>
						<?php
						}
			...
			<tr>
				<td colspan=4><br><hr></td>
				 ...
				 <!-- inicio 2 do cuatro resumen  -->
		 
			<tr >
			<th style="font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">Band Reference</th>
			<th style="font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">Gain Reference</th>
			<th style="font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">Max Pwr Reference</th>
			<th style="font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">IMD Reference</th>
				 ...
				 <?php
				 	  foreach ($datacabez as $rowheaders) 
					   {
						...
						//echo "cant band:".$quantityband."aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".$v_ban;
							...
							echo "<tr><td style='font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;'><b> ".$label_band_amostrar ." - ".$label_ULDL_amostrar."</b></td>   ";

							echo "<td style='font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;'> ";
								if ($v_uldl ==0 && $v_ban ==0)
								{
									echo $gain_read_0_0."  ± ".$gain_tolerance_0_0." (dB)";
								}
								if ($v_uldl ==1 && $v_ban ==0)
								{
									echo $gain_read_0_1."  ± ".$gain_tolerance_0_1." (dB)";
								}
								if ($v_uldl ==0 && $v_ban ==1)
								{
									echo $gain_read_1_0."  ± ".$gain_tolerance_1_0." (dB)";
								}
								if ($v_uldl ==1 && $v_ban ==1)
								{
									echo $gain_read_1_1."  ± ".$gain_tolerance_1_1." (dB)";
								}
							echo "</td>  ";
							echo "<td style='font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;'> ";
							if ($v_uldl ==0 && $v_ban ==0)
								{
									echo $maxpwr_read_0_0."  ± ".$maxpwr_tolerance_0_0." (dB)";
								}
								if ($v_uldl ==1 && $v_ban ==0)
								{
									echo $maxpwr_read_0_1."  ± ".$maxpwr_tolerance_0_1." (dB)";
								}
								if ($v_uldl ==0 && $v_ban ==1)
								{
									echo $maxpwr_read_1_0."  ± ".$maxpwr_tolerance_1_0." (dB)";
								}
								if ($v_uldl ==1 && $v_ban ==1)
								{
									echo $maxpwr_read_1_1."  ± ".$maxpwr_tolerance_1_1." (dB)";
								}
							echo "</td>  ";
							echo "<td style='font-size: 10pt;text-align: center;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;'> "; 
							if ($v_uldl ==0 && $v_ban ==0)
								{
									echo  " <=  ".$imd_read_0_0." (dBm)";
								}
								if ($v_uldl ==1 && $v_ban ==0)
								{
									echo  "  <= ".$imd_read_0_1." (dBm)";
								}
								if ($v_uldl ==0 && $v_ban ==1)
								{
									echo  "  <= ".$imd_read_1_0." (dBm)";
								}
								if ($v_uldl ==1 && $v_ban ==1)
								{
									echo  "  <= ".$imd_read_1_1." (dBm)";
								}
							echo "</td></tr> ";
