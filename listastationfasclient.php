  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List Station - FASClient3</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">List Station - FASClient3</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
$queryinfo = "
select  userfas.iduserfas,userfas.username, namestation,   userfas.nameuserfas,business_station.*, namebusiness
from userfas
...
business_station.idstation = business_station_userfas.idstation order by namebusiness, username
...
////aca tenemos un problema..meti una union.. primero traemos los datos genericos y despues los especificos
 ...
 foreach ($datarelaciones as $rowdd) 
 {
                ...
                <div class="row">
                        <div class="col-sm-2">
                            <div class="position-relative p-2  " style="height: 180px;border: 2px solid #1C6EA4;">
