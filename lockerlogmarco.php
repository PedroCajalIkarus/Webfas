...
<input type="hidden" name="idempresa" id="idempresa" value="<?php echo 	$_SESSION["i"]  ; ?>">
...
<script type="text/javascript">
   ...
   /////a pedido de fer.
		$(document).inactivityTimeout({
                inactivityWait: 100,
                dialogWait: 2,
                logoutUrl: 'lockerlog.php?a=refreshbyinactivityWait' 
            })
...
*/
			...
			vidempresa = urlParams.get("idb");
			if ( vidempresa === undefined || vidempresa == null)
			{
				vidempresa = $("#idempresa").val();	
			}
			console.log("Busco idempresa:" + vidempresa);	
			var vv_station ="";
			var table = new Tabulator("#example-table", {
					height:altor,					
					layout : "fitDataFill" ,					
					ajaxURL:"getlockerloginfo.php?idb="+vidempresa,
...
function show_log_bs(id_business)
		{
			location.href= 'http://webfas.fiplex.com//lockerlogmarco.php?idb='+id_business;
		}
