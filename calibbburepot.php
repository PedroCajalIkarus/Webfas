                                            ...
                                            <table
                                                ...
                                                <tr>
                                                    <td style='text-align: left'>CIU:
                                                        <strong><?php echo 	"HONBDA-BTTY-100100";?></strong>
                                                    </td>
...
if ($idruninfomreq=="")
{
	...
	inner join fnt_select_maxidrun_fas_outcome_integral_byidscrip('".$vparam_vnrounitsn."',22) as maxidrun
	on maxidrun.reference =  fas_routines_process_sn_t.idruninfodb
	where  fas_outcome_integral.idfasoutcomecat in(1,2,3,5) and fas_tree_measure.iduniquebranch in( '09B09F0AD', '09B09F0AE','09B09F0A0','09B09F0BA')
   ";
}
else
{
	...
	inner join fnt_select_maxidrun_fas_outcome_integral_byidscrip_byidrun('".$vparam_vnrounitsn."',22,".$idruninfomreq.") as maxidrun
	on maxidrun.reference =  fas_routines_process_sn_t.idruninfodb
	where  fas_outcome_integral.idfasoutcomecat in(1,2,3,5) and fas_tree_measure.iduniquebranch in( '09B09F0AD', '09B09F0AE','09B09F0A0','09B09F0BA')
   ";
}*/
...
and fas_routines_steps.instance in( '09B09F0AD', '09B09F0AE','09B09F0A0','09B09F0BA')
   ";
}
else
{
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo $vpower_source_voltage_ref; ?> V +/-
                                                            <?php echo $vpower_source_voltage_ref2; ?> V</td>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo ($v_residualcurre_ref * 1000); ?> mA +/-
                                                            <?php echo ($v_residualcurre_tole * 1000); ?> mA</td>

                                                        <td style="text-align: left">
                                                            <?php echo $v_residualcurre_fip485;?> mA</td>
                                                    </tr>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo ($v_battresidualcurre_ref * 1000); ?> mA +/-
                                                            <?php echo ($v_battresidualcurre_tole * 1000); ?> mA</td>

                                                        <td style="text-align: left">
                                                            <?php echo $v_battresidualcurre_fip485;?> mA</td>
                                                    </tr>
                                                    <?php } ?>
...
?>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left">Donor Antenna Disconnection alarm
                                                            state</td>
                                                        <td style="text-align: center">
                                                            <?php  
...
?>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left">Donor Antenna Malfunction alarm
                                                            state</td>
                                                        <td style="text-align: center">
...
?>
                                                    ...
                                                    <tr>
                                                        <td colspan=4><br>
                                                            <h5
                                                                style="text-decoration: underline;font-size:18px; text-align: left; ">
                                                                Alarms BBU: </h5>
                                                        </td>
                                                    </tr>
...
?>
                                                    ...
                                                    <tr>
                                                        <th colspan=4 style="text-align: left"><br>
                                                            <h5 style="text-decoration: underline;font-size:18px ">Fire
                                                                Panel Alarm: </h5>
                                                        </th>
                                                    </tr>
                                                    <tr>
