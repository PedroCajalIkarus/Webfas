			 ...
			 try {
				...
				//	 echo "UNIT";
					...
					else
					{
					 ...
					 /// Vamos a utilizar el reprocesar SO
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                                ...
                                <div class="demo-container">
                                    ...
                                    <div class="card">
                                        ...
                                        <p align="right">
                                            ...
                                            <span align="left">
                                                <a href="#" onclick="createtk()" style="color:#0053a1;">&nbsp;<i
                                                        class='fa fa-info-circle'
                                                        style='font-size:22px;color:#0053a1;'></i>&nbsp;<b>Missing
                                                        SO?</b></a>
                                            </span> &nbsp;&nbsp;||&nbsp;&nbsp;
                                            <a href="generarsaleorders.php" style="color:#0053a1;"><i
                                                    class='fas fa-plus-circle'
                                                    style='font-size:24px;color:#0053a1;'></i>Create New PO / SO</a>
                                            &nbsp;&nbsp;||&nbsp;&nbsp;
                                            <a href="generarsaleorders.php?add=Y" style="color:#0053a1;"><i
                                                    class='fas fa-calendar-plus' style='font-size:24px;'></i> Add CIU to
                                                PO / SO</a> &nbsp;&nbsp;||&nbsp;&nbsp;
                                        </p>
                                        <div class="row container">

                                        </div>
                                        &nbsp;&nbsp;&nbsp;<b> Enter the Customer / SO / SerialNumber to search for and hit enter</b>
                                        <!-- aca form -->
                                        <form action="listpresales.php" method="post" class="form-horizontal"
				...
				//		$queryquefiltramos=" and pre.date_approved > '".date(Y)."-01-01 00:00:00' ";
					...
					?>
                                            <input value="<?php echo $puedeborrar;?>" id="puedeborrar" type="hidden"
                                                name="puedeborrar">
                                            <?php
					//// *********************************
					?>
                                            <input class="form-control" id="poselecm" type="hidden" name="poselecm">
                                            <input class="form-control" id="poselecmrev" type="hidden"
                                                name="poselecmrev">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputweek" type="text" onchange="searchsoweek()" placeholder="Search this week">
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputmonth" type="text" onchange="searchsomonth()" placeholder="Search this month">
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-control form-control-sm" id="myInputall" type="text" onchange="searchsoall()" placeholder="Search all">
                                                    </div>
                                                </div>
                                            <!--- demo acordion--->
					  ...
					  <th >P.Config</th>                       
					   <th>SOsAssign</th>  -->
                                                ...
                                                <tbody id="myTable">
                                                    ...
                                                    <?php
					$filtrer_date_marco ="  ((prestatus.datestate > now() -' 7 day'::INTERVAL) ) and";
					//$filtrer_date_marco ="  ((prestatus.datestate > now() -' 30 day'::INTERVAL) or orders_sn.processday is null) and";
			//	$filtrer_date_marco ="";
				 
		 
						 $sql = $connect->prepare("
select  distinct iduniquebranchsonprod, products.idproduct ,  pre.idcustomers, namecustomers ,  orders_sn.so_soft_external, pre.active,fassrverror, pre.processfasserver, pre.idorders,pre.idrev,  products.modelciu ciu, quantity,  pre.date_approved as datestate , max(prestatus.idstate) as idstates
...
group by iduniquebranchsonprod, products.idproduct , pre.idcustomers, namecustomers , orders_sn.so_soft_external, pre.active,fassrverror, 
						...
						if( $row['activeprod']=="Y")
						{
							...
							{?>
                                                        <td class="font-weight-bold"><a href="#" title="View - Edit"
                                                                ...
                                                                title="View - Edit"><i class='far fa-edit'
                                                                    style='font-size:14px'></i></a> &nbsp&nbsp <a
                                                                href="#" title="Delete?"
				...
				//		}
					...
					//	}
					 ...
					 if( $row['activeprod']=="Y")
					 {
						...
						if  ($_SESSION["a"]==1 ||$_SESSION["a"]==2 ||$_SESSION["a"]==17 || $_SESSION["a"]==16 || $_SESSION["a"]==8 || $_SESSION["a"]==7)
						{
							?>
                                                            <a href='#'
					...
					if (strpos($row['iduniquebranchsonprod'], '00010038') !== false ||   strpos($row['iduniquebranchsonprod'], '001000010094') !== false  ||   strpos($row['iduniquebranchsonprod'], '0010000200130133') !== false ||   strpos($row['iduniquebranchsonprod'], '001000020007') !== false ) 				 
					 {
						?>&nbsp; <a href="#" title="Label printing" onclick="Call_printlabel_todos('<?php echo  $ciu; ?>',<?php echo  $idpresales; ?>)">
						...
						if( $row['issoblock']=="Yes")
						{
						   ?><span class='d-none'>CreditBlock</span>
                                                            <i class='fas fa-exclamation-triangle'
                                                                style='font-size:12px;color:red' title='Credit Block'
                                                                alt='Credit Block'></i>
                                                            <?php
						   ...
						   else
						   {
							   ...
							   ?>
                                                                <div class="progress-bar bg-secondary"
                                                                    style="width: 0%"><span class="text-info"> Processed
                                                                        / Pend</span></div>
                                                                <?php
								}
								else
								{
									if( $row['activeprod']=="S")
									{
										?>
                                                                <div class="progress-bar bg-info" style="width: 0%">
                                                                    <span class="text-secondary"> No Further Action
                                                                        Required
                                                                </div>
                                                                <?php	
									}
									else
									{
										if ($row['haveupgrade']>0)
										{
											?>
                                                                <div class="progress-bar bg-secondary"
                                                                    style="width: 0%"><span class="text-warning"> Pend.
                                                                        SN Assign for Upgrade <i
                                                                            class="fas fa-solid fa-bell"></i></span>
                                                                </div>
                                                                <?php
										}
										else
										...
										?>
                                                                <div class="progress-bar bg-secondary"
                                                                    style="width: 0%"><span class="text-info"> Pend. SN
                                                                        Assign <i class="fas fa-clipboard"></i></span>
                                                                </div>
                                                                <?php
											}
											else
											{
												?>
                                                                <div class="progress-bar bg-secondary"
                                                                    style="width: 0%"><span class="text-info"> SN
                                                                        Autogenerated <i
					  ...
					  //  echo $row['haverabbit']; //Estado BORRADOR
						...
						//      echo "<br>".$url2 ;
						 ...
						 //      echo "<br>headers2:". $headers2[0];
							   ...
							   echo " <i class='far fa-bell' style='font-size:18px;color:red'></i>";
							   ?>
...
<script>
    //Script mio
    function searchsoweek() {
        var inputValue = document.getElementById('myInputweek').value;
        var date = "  ((prestatus.datestate > now() -' 7 day'::INTERVAL) ) and"
            $.ajax({
                url: 'searchso.php', 
                type: 'POST',
                data: { search: inputValue, date : date},
                beforeSend: function() {
                    $('#myTable').html('<div name="msjwaitlines" id="msjwaitlines" align="center"><img src="img/waitazul.gif" width="100px"></div>');
                },
    ...
    function searchsomonth() {
        var inputValue = document.getElementById('myInputmonth').value;
        var date = "  ((prestatus.datestate > now() -' 30 day'::INTERVAL) ) and"
                $.ajax({
                    url: 'searchso.php', 
                    type: 'POST',
                    data: { search: inputValue, date: date },
    ...
    function searchsoall() {
        var inputValue = document.getElementById('myInputall').value;
        var date = " "
                $.ajax({
                    url: 'searchso.php', 
                    type: 'POST',
                    data: { search: inputValue, date: date },
                    beforeSend: function() {
                        $('#myTable').html('<div name="msjwaitlines" id="msjwaitlines"><img src="img/waitazul.gif" width="100px"></div>');
                    },
                    success: function(response) {
                            $('#myTable').html(response);
                    },
                                                    ...
                                                    <div class="card" style="position: relative; left: 0px; top: 0px;">
                                                        <div class="card-header ui-sortable-handle"
                                                            ...
                                                            <h3 class="card-title">
                                                                ...
                                                                <span name="podatos" id="podatos"
                                                                    class="d-none "></span>
                                                            </h3>
                                                            <p name="ciusnshow" id="ciusnshow" class="text-primary ">
                                                            </p>
                                                            <div class="card-tools">
                                                                <ul class="nav nav-pills ml-auto">
                                                                    <li class="nav-item" name="divgeneralinfo"
                                                                        id="divgeneralinfo">
                                                                        <a class="nav-link active" href="#generalinfopo"
                                                                            data-toggle="tab">Info PO / SO</a>
                                                                    </li>
                                                                    <li class="nav-item d-none"
                                                                        name="divgeneralinfoparam"
                                                                        id="divgeneralinfoparam">
                                                                        <!-- Ocultado hasta terminar esta pag y pueda editar y terminemos de definir como mostramos las unit y gain y maxpwr -->
                                                                        <a class="nav-link" href="#editparampo"
                                                                            data-toggle="tab">Edit Parameters PO /
                                                                            SO</a>
                                                                    </li>

                                                                    <li class="nav-item" name="diveq" id="diveq">
                                                                        <a class="nav-link " href="#cuiparamealbert"
                                                                            data-toggle="tab">CIU Parameters Config</a>
                                                                    </li>
                                                                    <li class="nav-item" name="diveq" id="diveq">
                                                                        <a class="nav-link " href="#cuiparalu"
                                                                            data-toggle="tab">SO Assign </a>
                                                                    </li>
                                                                    <li class="nav-item" name="diveq" id="diveq">
                                                                        <a class="nav-link " href="#cuiparachir"
                                                                            data-toggle="tab">SN Assign </a>
                                                                    </li>
                                                                    <li class="nav-item" name="diveq" id="diveq">
                                                                        <a class="nav-link " href="#sosnupgrade"
                                                                            data-toggle="tab">SO / SN Assign for Upgrade
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="tab-content p-0">
                                                                <p name="msjwaitline" id="msjwaitline" align="center">
                                                                    <img src="img/waitazul.gif" width="80px">
                                                                </p>
                                                                <!-- Morris chart - Sales -->
                                                                <div class="chart tab-pane pre-scrollablemarco  "
                                                                    id="editparampo" style="position: relative; ">


                                                                    <div class="form-group row">
                                                                        <label for="inputPassword"
                                                                            class="col-sm-1 col-form-label">Ciu
                                                                            Model:</label>
                                                                        <div class="col-sm-4">
                                                                            <span name="txtciushow" id="txtciushow">
                                                                            </span>
                                                                            <input type="hidden" id="txtlistcius"
                                                                                name="txtlistcius" value="">
                                                                            <input type="hidden" id="kkasign"
                                                                                name="kkasign" value="">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <input type="number"
                                                                                class="form-control col-4" id="txtcant"
                                                                                name="txtcant" data-smk-type="number"
                                                                                min="1" disabled data-validate="true"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-4	">
                                                                            <textarea class="form-control"
                                                                                id="txtdescripso" data-validate="false"
                                                                                name="txtdescripso" rows="4"></textarea>
                                                                        </div>
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">Notes
                                                                            PO:</label>
                                                                        <div class="col-sm-4">
                                                                            <textarea class="form-control"
                                                                                id="txtnotepo" name="txtnotepo"
                                                                                data-validate="false"
                                                                                rows="4"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="inputPassword"
                                                                            class="col-sm-3 col-form-label text-danger">Include
                                                                            Rabbit Module :</label>
                                                                        <br>
                                                                        <div class="col-sm-6	">
                                                                            <select
                                                                                class="js-example-basic-single col-sm-4"
                                                                                required id="txthavemodulerabbit"
                                                                                name="txthavemodulerabbit">
                                                                    ...
                                                                    <div class="form-group d-none row">
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">POWER SUPPLY
                                                                            TYPE:</label>
                                                                        <div class="col-sm-2">
                                                                            <select id="txtpwrsupply"
                                                                                name="txtpwrsupply"
                                                                        ...
                                                                        <label for="inputPassword"
                                                                            class="col-sm-1 col-form-label">RC-G for
                                                                            BWA:</label>
                                                                        <div class="col-sm-1">

                                                                            <input type="checkbox" data-toggle="toggle"
                                                                                data-off="NO" data-on="YES"
                                                                                id="txtrcgbwa" name="txtrcgbwa">
                                                                            <input type="hidden" data-toggle="toggle"
                                                                                data-off="NO" data-on="YES"
                                                                                id="vhtxtrcgbwa" name="vhtxtrcgbwa"
                                                                                value="">
                                                                        </div>
                                                                        <label for="inputPassword"
                                                                            class="col-sm-1 col-form-label">Modem for
                                                                            Digital:</label>
                                                                        <div class="col-sm-1">
                                                                            <input type="checkbox" data-toggle="toggle"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="col-sm-12" id="listagainuldl"
                                                                                name="listagainuldl">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-6	">
                                                                            <label class="col-sm-6 col-form-label">DL
                                                                                Channels (MHz):</label> <input
                                                                                type="number" class="form-control"
                                                                                data-validate="false" id="txtchud" min=1
                                                                                name="txtchud" placeholder="000.000">
                                                                            <label class="col-sm-6 col-form-label">UL
                                                                                Channels (MHz): </label> <input
                                                                                type="number" class="form-control"
                                                                                data-validate="false" id="txtchul" min=1
                                                                                name="txtchul" placeholder="000.000">
                                                                            <button type="button"
                                                                                class="btn btn-smk btn-outline-primary btn-flat"
                                                                                onclick="add_channels()">Add to Channel
                                                                                List</button>
                                                                            ...
                                                                            <p align="right">
                                                                                <button name="btnaddchannels1"
                                                                                    id="btnaddchannels1" type="button"
                                                                                    class="btn btn-sm btn-outline-primary btn-flat"
                                                                                    onclick="importar_channell()">Import
                                                                                    Channel </button>
                                                                            <div class="container d-none"
                                                                                id="importador" name="importador">
                                                                                <div class="row">
                                                                                    <div class="col"> DL Channels ::
                                                                                        copy and paste the channels here
                                                                                        <textarea class="form-control"
                                                                                            id="importchdl"
                                                                                            name="importchdl"
                                                                                            rows="2"></textarea>
                                                                                    </div>
                                                                                    <div class="col"> UL Channels ::
                                                                                        copy and paste the channels here
                                                                                        <textarea class="form-control"
                                                                                            id="importchul"
                                                                                            name="importchul"
                                                                                ...
                                                                                <br><br> <button name="btnaddchannels3"
                                                                                    id="btnaddchannels3" type="button"
                                                                                    class="btn btn-sm btn-outline-primary btn-flat"
                                                                                    onclick="importar_nowl()">Import now
                                                                                </button>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="col-sm-12" id="listachannel"
                                                                                name="listachannel">
                                                                                <table
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control"
                                                                                id="txtnotechanel" name="txtnotechanel"
                                                                                data-validate="false"
                                                                                rows="4"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <input type="hidden" class="form-control"
                                                                            id="templistadpx" name="templistadpx">
                                                                        <div class="col-sm-12">
                                                                            <div class="col-sm-12" id="listadpx"
                                                                                name="listadpx"> DPX (Low - High) List
                                                                                <table
                                                                                    class="table table-striped table-sm ">
                                                                                    <thead>
                                                                                        <tr>
														...
														?>
                                                                        <div class="col-sm-4">
                                                                            <button type="button"
                                                                                ...
                                                                                id="btnchangep" name="btnchangep"
                                                                                onclick="save_new_rev()">Save </button>
                                                                        </div>
                                                                        <?php  } ?>
                                                                ...
                                                                <div class="chart tab-pane pre-scrollablemarco  "
                                                                    id="cuiparalu" style="position: relative; ">
                                                                    <!-- inicio modif luciana -->

                                                                    <div class="form-group row">
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">SO
                                                                            Number</label>
                                                                        <div class="col-sm-4	">
                                                                            <input type="text" class="form-control"
                                                                                id="txtsoluumber" name="txtsoluumber"
                                                                                required="" placeholder="SO Number">

                                                                            <span name="lblsonumber" id="lblsonumber"
														...
														?>
                                                                        <div class="col-sm-4">
                                                                            <button type="button"
                                                                                ...
                                                                                id="btnchangep_lu"
                                                                                onclick="saveLuciana()"
                                                                                name="btnchangep_lu">Assign SO</button>
                                                                        </div>
                                                                        <?php } ?>
                                                                    </div>
                                                                ...
                                                                <div class="chart tab-pane pre-scrollablemarco"
                                                                    id="cuiparachir" name="cuiparachir"
                                                                    style="position: relative; ">
                                                                </div>
                                                                <div class="chart tab-pane pre-scrollablemarco"
                                                                    id="sosnupgrade" name="sosnupgrade"
                                                                    style="position: relative; ">
                                                                </div>
                                                                <div class="chart tab-pane pre-scrollablemarco active "
                                                                    id="generalinfopo" style="position: relative; ">
                                                                    <!----- INICIO LISTA PO  -->
                                                                ...
                                                                <div class="chart tab-pane pre-scrollablemarco  "
                                                                    id="cuiparamealbert" style="position: relative; ">
                                                                    <!-- inicio modif alebrt -->
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <label for="inputPassword"
                                                                            class="col-sm-21 col-form-label"> &nbsp&nbsp
                                                                            Training required for PP-ASSY</label>
                                                                        <div class="col-sm-2">
                                                                            <input type="checkbox" data-toggle="toggle"
                                                                                data-on="YES" data-off="NO"
                                                                                id="txtppassy_abert"
                                                                                name="txtppassy_abert">
                                                                        </div>
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">Training
                                                                            required for Calibration</label>
                                                                        <div class="col-sm-2">
                                                                            <input type="checkbox" data-toggle="toggle"
                                                                                data-on="YES" data-off="NO"
                                                                                id="txtreqcalib_abert"
                                                                                name="txtreqcalib_abert">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">Special
                                                                            Material required</label>
                                                                        <div class="col-sm-2">
                                                                            <input type="checkbox" data-toggle="toggle"
                                                                                data-on="YES" data-off="NO"
                                                                                id="txtmatespecial_abert"
                                                                                name="txtmatespecial_abert">
                                                                        </div>
                                                                        <label for="inputPassword"
                                                                            class="col-sm-2 col-form-label">Other</label>
                                                                        <div class="col-sm-2">
                                                                            <input type="checkbox" data-toggle="toggle"
                                                                                data-off="NO" data-on="YES"
                                                                                id="txtotherchange_abert"
                                                                                name="txtotherchange_abert">
                                                                        </div>
                                                                    </div>
                                                                    <!-- NUEVO RENGLON FORM  -->
                                                                    <!-- NUEVO RENGLON FORM  -->
                                                                    <div class="form-group row">
                                                                        <label for="inputPassword"
                                                                            ...
                                                                            of Resources Required:</label>
                                                                        <div class="col-sm-6	">
                                                                            <textarea class="form-control"
                                                                                id="txtdescripmatesp_abert"
                                                                                name="txtdescripmatesp_abert"
                                                                                rows="4"></textarea>
							...
							?>
                                                                        <div class="col-sm-4">
                                                                            <button type="button"
                                                                                ...
                                                                                id="btnchangep_abert"
                                                                                onclick="savealbert()"
                                                                                name="btnchangep_abert">Save </button>
                                                                        </div>
                                                                        <?php } ?>
                                                    ...
                                                    <p name="msjwait" id="msjwait" align="center"><img
                                                            src="img/waitazul.gif" width="80px"></p>
                                                </div>
...
function show_po(vidpo, idshow) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.ps[0].ciu.indexOf('LIC') >= 0) {
                ...
                if (data.arr_dpxunit != null) {
                    $.each(data.arr_dpxunit, function(i, itempsunit) {
                        ...
                        if (itempsunit.nomband.indexOf('700') >= 0 || itempsunit.nomband.indexOf(
                                '800') >= 0) {
            ...
            //show data po y rebv
            $("#podatos").html(' SO:' + data.ps[0].so_soft_external + ' Rev:' + data.ps[0].idrev +
                '<br><br>');
            ...
            if (data.snasignados == null) {
                ...
                tabla_info_show_po = tabla_info_show_po +
                    "<tr><th><b>SN LIST</b></th><td></td><td></td><td></td></tr>";
                $.each(data.snasignados, function(i, itemstock2) {
                    if ($("#qeneslogin").val() == 'develop' || 'Productionadmin' == $("#qeneslogin")
                        .val() || 'quality' == $("#qeneslogin").val() || 'Quality' == $(
                            "#qeneslogin").val()) {
                        tabla_info_show_po = tabla_info_show_po +
                            "<tr><th class='colorazulfiplex'><b>SN assigned: </b>  </th><th class='colorazulfiplex'><b>" +
                            itemstock2.wo_serialnumber +
                            "</b></th> <td colspan='2'> <a href='unlinksndevelop.php?snmm=" +
                            itemstock2.wo_serialnumber +
                            "' target='_blank'> <span class='text-danger'>Unlink sn </span> </a>  </td></tr>";
                    } else {
                        tabla_info_show_po = tabla_info_show_po +
                            "<tr><th class='colorazulfiplex'><b>SN assigned: </b>  </th><th class='colorazulfiplex'><b>" +
                            itemstock2.wo_serialnumber + "</b></th> <td colspan='2'></td></tr>";
                    }
            ...
            if (data.resultadojson != '') {
                console.log('ABCCCCC');
                tabla_info_show_po = tabla_info_show_po + "<tr><td  colspan='2'>" + data.resultadojson +
                    "</td><td></td><td></td></tr>";
            }
            ...
            if (data.isdigunit == 'Y') {
                if (v_modulorabbit != '') {
                    tabla_info_show_po = tabla_info_show_po +
                        "<tr><td><b>Include Rabbit Module: </b></td><td>" + v_modulorabbit +
                        "</td><td></td><td></td></tr>";
                } else {
                    if (data.ps[0].estacompletalaso == 'Y') {

                        tabla_info_show_po = tabla_info_show_po +
                            "<tr><td class='text-danger'><b>Missing Definition Rabbit Module </b></td><td>Does this unit requires a rabbit module? <button type='button' class='btn btn-outline-success btn-sm'  onclick='setrabbit(1," +
                            vidpo +
                            ")'>Yes</button>&nbsp;&nbsp;&nbsp;<button type='button'  onclick='setrabbit(0," +
                            vidpo +
                            ")' class='btn btn-outline-danger  btn-sm'>No</button></td><td></td><td></td></tr>";
                    } else {
                        tabla_info_show_po = tabla_info_show_po +
                            "<tr><td class='text-danger'><b>Missing Definition Rabbit Module </b></td><td>Does this unit requires a rabbit module? <button type='button' class='btn btn-outline-success btn-sm' onclick='setrabbit(1," +
                            vidpo +
            ...
            tabla_info_show_po = tabla_info_show_po + "<tr><td> <b>CIU: </b></td><td>" + data.ps[0].ciu +
                "</td><td> <b>Quantity: </b></td><td>" + data.ps[0].quantity + "</td></tr>";
            tabla_info_show_po = tabla_info_show_po + "<tr><th>Description CIU:<br></th><td colspan=3>" +
                data.ps[0].descripcionciu + "</td></tr>";
            ...
            tabla_info_show_po = tabla_info_show_po + "<tr><td><b>DL gain: </b></td><td>" + vv_dlgain +
                " (dB)</td><td><b>UL  gain:</b></td> <td>" + vv_ulgain + " (dB)</td></tr>";
            tabla_info_show_po = tabla_info_show_po + "<tr><td><b>DL Max Pwr Out: </b></td><td>" +
                vv_dlmaxpwe + " (dBm)</td><td><b>UL 	Max Pwr Out:</b></td> <td>" + vv_ulmaxpwr +
                "  (dBm)</td></tr>";

            tabla_info_show_po = tabla_info_show_po + "<tr><th>PO Numbre:<br></th><td colspan=3>" + data.ps[
                0].ponumber + "</td></tr>";
            tabla_info_show_po = tabla_info_show_po + "<tr><th>Description PO:<br></th><td colspan=3>" +
                data.ps[0].descripcion + "</td></tr>";
            tabla_info_show_po = tabla_info_show_po + "<tr><th>Notes PO:<br></th><td colspan=3>" + data.ps[
                0].notes + "</td></tr>";
            tabla_info_show_po = tabla_info_show_po + "<tr><td><b>POWER SUPPLY TYPE:</b></td><td>" + data
                .ps[0].pwrsupplytype + "</td><td></td><td></td></tr>";
            ...
            ////// list file attach
            tabla_info_show_po = tabla_info_show_po +
                "<tr><td><br></td><td></td><td></td><td></td></tr></table>";

            tabla_info_show_po = tabla_info_show_po +
                "<table class='table table-striped '><tbody><tr><td><b>List of Attached Files:</b> <hr>";
            if (data.listattach != null) {
                ...
                $.each(data.listattach, function(i, itemplistatt) {
                    ...
                    if (itemplistatt.idordersfileat > 0) {
                        ...
                        if (posicionpdf !== -1) {
                            tabla_info_show_po = tabla_info_show_po +
                                "<a href='' onclick='openpfgdownfileattaso(0," + String
                                .fromCharCode(34) + itemplistatt.namefileattach2 + String
                                .fromCharCode(34) +
                                ",0);return false;'><i class='fas fa-file-pdf' style='font-size:18px;color:red'></i>&nbsp; " +
                                itemplistatt.namefileattach + " </a>";

                            // solo Luciana o ADMINISTRATOS pueden borrar.
                            if ($("#puedeborrar").val() == "Y") {
                                tabla_info_show_po = tabla_info_show_po +
                                    "&nbsp;||&nbsp;<a href='' onclick='delattachorigsn(" +
                                    itemplistatt.idordersfileat +
                                    ");return false;'> <i class='far fa-times-circle'></i> </a><br>"
                            } else {
                            ...
                            tabla_info_show_po = tabla_info_show_po +
                                "<a href='' onclick='downfileattaso(0," + String.fromCharCode(34) +
                                itemplistatt.namefileattach2 + String.fromCharCode(34) +
                                ",0)'><i class='fas fa-paperclip' style='font-size:18px'></i> " +
                                itemplistatt.namefileattach + " </a><br>";
                            // solo Luciana o ADMINISTRATOS pueden borrar.
                            if ($("#puedeborrar").val() == "Y") {
                                tabla_info_show_po = tabla_info_show_po +
                                    "&nbsp;||&nbsp;<a href='' onclick='delattachorigsn(" +
            ...
            tabla_info_show_po = tabla_info_show_po + "<hr><br><a href='' onclick='addfiletoso(" + String
                .fromCharCode(34) + v_seedtemp + String.fromCharCode(34) + "," + vidpo +
                ");return false;'> <i class='far fa-plus-square' style='font-size:18px'></i> - Add files to SO</a>";
            ...
            tabla_info_show_po = tabla_info_show_po +
                "<div class=' ' id='listadpx1' name='listadpx1'> </div>";
            tabla_info_show_po = tabla_info_show_po +
                "<div class='col-sm-12' id='listagainuldl1' name='listagainuldl1'> </div>";
            ...
            tabla_info_show_po = tabla_info_show_po +
                "<tr><th><br></th><td></td><td><br></td><td></td></tr>";
            tabla_info_show_po = tabla_info_show_po +
                "<tr><th><b>Channels List</b></th><td></td><td></td><td></td></tr>";
            var note_unit_ch = "";
            $.each(data.psch, function(i, itempsch) {
                //	console.log(i +'muestro psch...itemdib:'+itempsch.totalpass);
                note_unit_ch = itempsch.notes;
                tabla_info_show_po = tabla_info_show_po +
                    "<tr><td><b>DL Channels :</b></td><td><b>" + itempsch.dl_ch_fr +
                    "</b> (MHz)</td><td><b>UL Channels :</b></td> <td><b>" + itempsch.ul_ch_fr +
                    "</b> (MHz)</td></tr>";
            ...
            tabla_info_show_po = tabla_info_show_po + "<tr><th>Note Channels:<br></th><td colspan=3>" +
                note_unit_ch + "</td></tr>";
            ...
            tabla_info_show_po = tabla_info_show_po +
                "<tr><td><b>Training required for PP-ASSY: </b></td><td>" + v_req_ppassyg +
                "</td><td><b>Training required for Calibration:</b></td> <td>" + v_req_calibration +
                " </td></tr>";
            tabla_info_show_po = tabla_info_show_po +
                "<tr><td><b>Special Material required: </b></td><td>" + v_req_spec +
                "</td><td><b>Other:</b></td> <td>" + v_req_other + " </td></tr>";
            tabla_info_show_po = tabla_info_show_po +
                "<tr><th>Description of Resources Required::<br></th><td colspan=3>" + data.ps[0]
                .reqresources + "</td></tr>";
            ...
            tabla_info_stock = "";
            tabla_info_stock = tabla_info_stock +
                "<table class='table table-striped '><tbody><tr><td colspan=4> <b>PO:(Final SKU) </b> <input type='text' class='form-control form-control-sm ' id='txtposkufinal' name='txtposkufinal' ></td></tr><tr><td colspan=4> <b> Stock CIU: </b></td></tr>";
            //console.log(data.ps[0].ciu.substr(0,4));
            if (data.ps[0].ciu.substr(0, 4) == "DH7S") {
                tabla_info_stock = tabla_info_stock +
                    "<tr><td colspan='2'><input type='hidden' name='quiengenerarlossn' id='quiengenerarlossn' value=''>  </td><td colspan='2'> <button type='button' class='btn btn-block btn-outline-success' onclick='seleciongenerasn(2)' name='btnsn2' id='btnsn2'>Assign SN User</button> </td></tr>";
            } else {
                tabla_info_stock = tabla_info_stock +
                    "<tr><td colspan='2'><input type='hidden' name='quiengenerarlossn' id='quiengenerarlossn' value=''><button type='button' class='btn btn-block btn-outline-primary' onclick='seleciongenerasn(1)' name='btnsn1' id='btnsn1'>Assign SN FasServer</button>  </td><td colspan='2'> <button type='button' class='btn btn-block btn-outline-success' onclick='seleciongenerasn(2)' name='btnsn2' id='btnsn2'>Assign SN User</button> </td></tr>";
            }
            ...
            $.each(data.ciustockdet, function(i, itemstock) {
                ...
                if (idproducttemp != itemstock.idproduct) {
                    ...
                    tabla_info_stock = tabla_info_stock + "<tr><td>CIU:<b> " + itemstock.modelciu +
                        "</b> </td><td colspan=3>";
                    ...
                    tabla_info_stock = tabla_info_stock +
                        "<input  type='checkbox' class='combomarco' onclick='sumarme_asign_sn()' value='" +
                        itemstock.wo_serialnumber + "|" + itemstock.so_soft_external +
                        "' id='chkstock" + itemstock.wo_serialnumber + "' name='chkstock" +
                        itemstock.wo_serialnumber + "' " + ischequed + " > " + itemstock
                        .wo_serialnumber + "<br>";
                } else {
            ...
            if (varpermiso_assing_sn == 'Y') {
                ...
                if (data.ps[0].so_soft_external == '') {
                    tabla_info_stock = tabla_info_stock + "<tr><td><b>Quantity Required SO :" +
                        cant_requerid_total + "<br> Remaining amount : " + cantrequired +
                        "</b> <input type='hidden' value='" + cantrequired +
                        "' name='vhcantrequerida' id='vhcantrequerida'> </td><td><b>Selected quantity: <input type='hidden'  id='vhcantselect' name='vhcantselect' value=" +
                        autoselectsn + "> <span id='cantselect'>" + autoselectsn +
                        "</span></b></td> <td colspan='2'><button type='button' class='btn btn-primary btn-block' id='btnchangep_chirs' disabled name='btnchangep_chirs'>Assign SN ..</button></td></tr>";
                } else {
                    tabla_info_stock = tabla_info_stock + "<tr><td><b>Quantity Required SO :" +
                        cant_requerid_total + "<br> Remaining amount :" + cantrequired +
                        "</b> <input type='hidden' value='" + cantrequired +
                        "' name='vhcantrequerida' id='vhcantrequerida'></td><td><b>Selected quantity: <input type='hidden'  id='vhcantselect' name='vhcantselect' value=" +
                        autoselectsn + "> <span id='cantselect'>" + autoselectsn +
                        "</span></b></td> <td colspan='2'><button type='button' class='btn btn-primary btn-block' id='btnchangep_chirs' onclick='savechristian()' name='btnchangep_chirs'>Assign SN</button></td></tr>";
                }
                ...
                tabla_info_stock = tabla_info_stock + "<tr><td><b>Quantity Required SO :" +
                    ...
                    "' name='vhcantrequerida' id='vhcantrequerida'> </td><td><b>Selected quantity: <input type='hidden'  id='vhcantselect' name='vhcantselect' value=" +
                    autoselectsn + "> <span id='cantselect'>" + autoselectsn +
                    "0</span></b></td> <td colspan='2'><button type='button' class='btn btn-primary btn-block' id='btnchangep_chirs' disabled name='btnchangep_chirs'>Assign SN ....</button></td></tr>";
            }
            ...
            if (data.snasignados == null) {
                ...
                $.each(data.snasignados, function(i, itemstock2) {
                    tabla_info_stock = tabla_info_stock +
                        "<tr><td><b>SN assigned: </b>  </td><td><b>" + itemstock2.wo_serialnumber +
            ...
            tabla_info_stock = tabla_info_stock +
                "<div class='info-box'><span class='info-box-icon bg-yellow '><i class='fas fa-cogs'></i></span><div class='info-box-content'><a href='generawororder.php'><span class='info-box-number'>Create New Work Orders  </span></a></div></div>";
...
function sumarme_asign_sn() {
    ...
    $('input[type=checkbox]').each(function() {
        ...
        if (typeof cb.attr('name') === 'undefined' || cb.attr('name') === null) {} else {
                                ...
                                if (cb.attr('name').length > 8) {
                                    if ('chkstock' == cb.attr('name').substring(0, 8)) {
                                        if ($("#" + cb.attr('name')).is(':checked')) {
                                            ...
                                            los_sn_seleccionados = los_sn_seleccionados + $("#" + cb.attr(
                                                'name')).val() + '#';
                        ...
                        if (los_sn_seleccionados != "") {
                            ...
                            $.ajax({
                                ...
                                data: "idpo=" + vidpo + '&so=' + vvnroso + '&lossn=' + los_sn_seleccionados +
                                    '&cantasing=' + vkkasign + '&poskufinal=' + poskufinal,
                                type: 'post',
                                datatype: 'JSON',
                                success: function(data) {
                                    // 
...
function tabla_gain_udul() {
    ...
    var esUHFVHF = 0;
    var htmlmejorado =
        '	<table class="table table-striped table-bordered table-sm"><thead >    <tr ><th class="table-dark text-center" scope="col">#</th> <th class="table-primary text-center" colspan=4 scope="col">DOWNLINK </th><th  class="table-info text-center" colspan=4 scope="col">UPLINK</th> </tr>';
    htmlmejorado +=
    ...
    for (var i = 0; i < tabla_gain_dlul.length; i++) {
        ...
        if (tabla_gain_dlul[i].Band.indexOf('700') >= 0 || tabla_gain_dlul[i].Band.indexOf('800') >= 0) {
            htmlmejorado += '<tr><th width="80px" scope="row">' + tabla_gain_dlul[i].Band +
                '</th>	<td  width="80px" class=" text-center  id' + i + '#DL_Start' + '" id="id' + i +
                '#DL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                '#DL_Start' + "'" + ',' + i + ')" >' + tabla_gain_dlul[i].hiddengainudstart +
                ' </td>	<td width="80px" class=" text-center  id' + i + '#DL_Stop' + '" id="id' + i +
                '#DL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                '#DL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul[i].hiddengainudstop +
                ' </td><td class=" text-center" >' + tabla_gain_dlul[i].noteditDL_gain +
                ' dB </td><td class=" text-center" >' + tabla_gain_dlul[i].noteditDL_maxpwr + ' dBm</td>';
            htmlmejorado += '<td  width="80px" class=" text-center  id' + i + '#UL_Start' + '" id="id' + i +
                '#UL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                '#UL_Start' + "'" + ',' + i + ')"  >' + tabla_gain_dlul[i].hiddengainulstart +
                ' </td><td width="80px" class=" text-center  id' + i + '#UL_Stop' + '" id="id' + i +
                '#UL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                '#UL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul[i].hiddengainulstop +
                ' </td><td  class=" text-center">' + tabla_gain_dlul[i].noteditUL_gain + ' dB</td>';
            ...
            if (esUHFVHF == 0 || esUHFVHF == 2) {
                ...
                htmlmejorado += '<tr><th width="80px" scope="row">' + nombandper +
                    '</th>	<td  width="80px" class=" text-center ' + v_temp_DL_Startclass + ' id' + i + '#DL_Start' +
                    '" id="id' + i + '#DL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' +
                    "'id" + i + '#DL_Start' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_DL_Start +
                    ' </td>	<td width="80px" class=" text-center ' + v_temp_DL_Stopclass + ' id' + i + '#DL_Stop' +
                    '" id="id' + i + '#DL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' +
                    "'id" + i + '#DL_Stop' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_DL_Stop +
                    ' </td><td class=" text-center" >' + tabla_gain_dlul[i].noteditDL_gain +
                    ' dB </td><td class=" text-center" >' + tabla_gain_dlul[i].noteditDL_maxpwr + ' dBm</td>';
                htmlmejorado += '<td  width="80px" class=" text-center ' + v_temp_Startclass + ' id' + i + '#UL_Start' +
                    '" id="id' + i + '#UL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' +
                    "'id" + i + '#UL_Start' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_Start +
                    ' </td><td width="80px" class=" text-center ' + v_temp_UL_Stopclass + ' id' + i + '#UL_Stop' +
                    '" id="id' + i + '#UL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' +
                    "'id" + i + '#UL_Stop' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_UL_Stop +
                    ' </td><td  class=" text-center">' + tabla_gain_dlul[i].noteditUL_gain + ' dB</td>';
                console.log('aver14-' + isNaN(tabla_gain_dlul[i].noteditUL_maxpwr));
                if (isNaN(tabla_gain_dlul[i].noteditUL_maxpwr)) {
                    htmlmejorado += ' <td  class=" text-center" >missing information</td> ';
                } else {
                    htmlmejorado += ' <td  class=" text-center" >' + tabla_gain_dlul[i].noteditUL_maxpwr +
                        ' dBm </td> ';
                }
            }
        }
    ...
    htmlmejorado +=
        ' </tbody></table><P style="color:rgba(250, 5, 5)";>* <b>The cell that contains this color indicates missing information.</b></P> '
    ...
    for (var i = 0; i < tabla_gain_dlul.length; i++) {
                    ...
                    if (!j.indexOf('hidden')) {
                        ...
                        if (j.indexOf('notedit')) {
                            if (tabla_gain_dlul[i][j] == 0) {
                                html += '<td width="80px" contenteditable="true" id="id' + i + '#' + j +
                                    '" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                                    '#' + j + "'" + ',' + i + ')" class=" colorfondonaranja id' + i + '#' + j +
                                    '"> -missing info -</td>';
                            } else {
                                html += '<td width="80px" contenteditable="true" id="id' + i + '#' + j +
                                    '" onkeypress="return soloNumeros(event)" class="id' + i + '#' + j +
                                    '" onblur="modif_table_array(' + "'id" + i + '#' + j + "'" + ',' + i + ')">  ' +
                                    tabla_gain_dlul[i][j] + ' MHz</td>';
                            }
        ...
        html += '<td>  <a href="#" onclick="borrar_array_uldl(' + i +
            ')"> <i class="fas fa-trash-alt"></i> Del</a> </td>';
        html += '</tr>';
    }
    html += '</table>';
...
function savealbert() {
    if (document.getElementById("poselecm").value != "") {
        ...
        $.ajax({
            ...
            data: "idpo=" + vidpo + '&eqcalib=' + txtreqcalib_abert + '&ppassy=' + txtppassy_abert +
                '&matespecial=' + txtmatespecial_abert + '&otherchange=' + txtotherchange_abert +
                '&txtdescrip=' + txtdescripmatesp_abert,
            type: 'post',
            datatype: 'JSON',
            success: function(data) {
...
function show_ciu_version2020(idsaleorders, nameSO_Customers) {
    ...
    if ($('#collapse' + idsaleorders).is(":hidden") == true) {
        ...
        $('#collapse' + idsaleorders).html(
            "<p name='msjwaitparticular' id='msjwaitparticular' align='center'><img src='img/waitazul.gif' width='80px' ></p>"
        );
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    eTable += "<a data-toggle='collapse' data-parent='#accordion' onclick=" +
                        "show_CIU_SN2020(" + idsaleorders + ",'" + data[i].ciu + "','" + idsaleorders +
                        data[i].ciu_sincara + "','') href='#collapse" + idsaleorders + data[i].ciu_sincara +
                        "' aria-expanded='true'><img src='img/imgciu.jpg' width='40px' > " + data[i].ciu +
                        "&nbsp;<span data-toggle='tooltip' class='badge " + lbl_color +
                        " mb-2 labelsom'> &nbsp;[ &nbsp;" + data[i].cant_sn +
                        " SN &nbsp;] &nbsp; </span></a>&nbsp;<a href='#' >	</a> <br><div id='collapse" +
                        idsaleorders + data[i].ciu_sincara + "' name id='collapse" + idsaleorders + data[i]
                        .ciu_sincara + "' class='panel-collapse in collapse'> ... </div>";
    ...
    if ($('#collapse' + vciunomdiv).is(":hidden") == true) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var eTable =
                    "<div class='container'><table class='table  table-bordered table-striped table-sm'><tbody>";
                var det_modules = "";
                var detband = "0";
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    eTable += "<tr >";
                    eTable += "<td> <a data-toggle='collapse' data-parent='#accordion' onclick=" +
                        "show_CIU_SN_details2020(" + idsaleorders + ",'" + vciu + "','" + idsaleorders +
                        vciu + data[i].sn + data[i].idband + "','" + data[i].sn + "','" +
                        name_show_customerSO + "',1) href='#collapse" + idsaleorders + vciu + data[i].sn +
                        data[i].idband + "' aria-expanded='true'><i class='nav-icon fas fa-th'></i> " +
                        data[i].sn + ifdualband + "</a>&nbsp&nbsp&nbsp";

                    eTable += '<a href="#" onclick="Call_create_RMA2020(' + String.fromCharCode(39) + vciu +
                        String.fromCharCode(39) + ',' + String.fromCharCode(39) + data[i].sn + String
                        .fromCharCode(39) +
                        ')" title="Create RMA?"> <i class="nav-icon fas fa-box-open"></i></a> ';
                    if (data[i].sn_modulo != "") {
                        det_modules += '<i  class="fas fa-sliders-h"></i> Digital Module ' + data[i]
                            .sn_modulo + ' ' + detband + ' <a href="#" onclick="mostrar_digmod(' + "'" +
                            data[i].sn_modulo.trim() + "','" + data[i].sn + "'" +
                            ')"> <i class="fas fa-eye"></i></a><br>';
                        eTable +=
                            "<span data-toggle='tooltip'  class='float-right'> &nbsp; <span data-toggle='tooltip' class='badge badge-pill bg-warning'>Dig. Mod [" +
                            data[i].countdigm + "]&nbsp;"
                        ...
                        if (data[i].sn_modulocalif != "") {
                            det_modules += '<i class="fas fa-tools"></i> Calibration ' + data[i]
                                .sn_modulocalif + '  ' + detband +
                                ' <a href="#"  onclick="mostrar_digmodcalib(' + "'" + data[i].sn_modulo
                                .trim() + "','" + data[i].sn + "'" +
                                ')"> &nbsp;<i class="fas fa-eye"></i>&nbsp;</a><br>';
                            eTable +=
                                "&nbsp;&nbsp;<span data-toggle='tooltip' class='badge bg-info'>Calib [" +
                                data[i].countdigmcalif + "]&nbsp;"
                        ...
                        if (data[i].sn_modulocaliffnchk != "") {
                            ...
                            det_modules += '<i class="far fa-check-square"></i> Final Check ' + data[i]
                                .sn_modulocaliffnchk + '  ' + detband +
                                ' <a href="#" onclick="mostrar_digmodcalibfinalcheck(' + "'" + data[i]
                                .sn_modulo.trim() + "','" + data[i].sn + "'" +
                                ')"> &nbsp;<i class="fas fa-eye"></i>&nbsp;</a><br>';
                            eTable +=
                                "&nbsp;&nbsp;<span data-toggle='tooltip' title='3 ' class='badge bg-green'>Final Chk [" +
                                data[i].countdigmcaliffnchk + "]&nbsp;"
                    ...
                    eTable += " </span><div id='collapse" + idsaleorders + vciu + data[i].sn + data[i]
                        .idband + "' name='collapse" + idsaleorders + vciu + data[i].sn + data[i].idband +
                        "' class='panel-collapse in collapse container ' style='background-color:#E1F5FE'> " +
                        det_modules + " </div>";
                    eTable += "</tr>";
                    det_modules = "";
                }
...
function list_tabla_dpx_udul2dagen_solomuestra() {
    ...
    $.each(tabla_dpx_solomuestra, function(i, itempsdpx) {
        htmlmejoradodpx = htmlmejoradodpx + "<tr class='text-center'><td>" + itempsdpx.Band + "</td><td><b>" +
            itempsdpx.dpxlowstart + "</b> MHz</td><td><b>" + itempsdpx.dpxlowstop + "</b> MHz</td><td> <b>" +
            itempsdpx.dpxhighstart + "</b> MHz</td> <td> <b>" + itempsdpx.dpxhighstop + "</b> MHz</td></tr>";
        ...
        if (tabla_dpx[i].Band.indexOf('700') >= 0 || tabla_dpx[i].Band.indexOf('800') >= 0) {
            ...
            */
            ...
            for (var immxx = 0; immxx < tabla_dpx[i].qband; immxx++) {
                imm = tabla_dpx[i].idarray;
                htmlmejoradodpx += '<tr><th width="100px" scope="row"> ' + tabla_dpx[i].Band +
                    '   &nbsp;&nbsp; <a href="#" onclick="borrar_array_dpx(' + imm +
                    ')" title="Delete the DPX"><i class="fas fa-times-circle"></i></a>   </th>';
    ...
    for (var i = 0; i < tabla_gain_dlul.length; i++) {
        ...
        if (tabla_gain_dlul[i].Band.indexOf('700') >= 0 || tabla_gain_dlul[i].Band.indexOf('800') >= 0) {
            ...
            htmlmejorado += '<td  width="80px" class=" text-center  id' + i + '#UL_Start' + '" id="id' + i +
                ...
                '#UL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul[i].hiddengainulstop +
                ' </td><td  class=" text-center">' + tabla_gain_dlul[i].noteditUL_gain + ' dB</td>';
            htmlmejorado += ' <td width="80px" class=" text-center" >' + tabla_gain_dlul[i].noteditUL_maxpwr +
                ' dBm </td> ';
...
function tabla_gain_udul2dagen_solomuestra() {
    ...
    for (var i = 0; i < tabla_gain_dlul_onlyshow.length; i++) {
        ...
        if (tabla_gain_dlul_onlyshow[i].Band.indexOf('700') >= 0 || tabla_gain_dlul_onlyshow[i].Band.indexOf('800') >=
            0) {
            if (isNaN(tabla_gain_dlul[i].noteditDL_maxpwr)) {
                htmlmejorado += '<tr><th width="80px" scope="row">' + tabla_gain_dlul_onlyshow[i].Band +
                    '</th>	<td  width="80px" class=" text-center  id' + i + '#DL_Start' + '" id="id' + i +
                    '#DL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                    '#DL_Start' + "'" + ',' + i + ')" >' + tabla_gain_dlul[i].hiddengainudstart +
                    ' MHz </td>	<td width="80px" class=" text-center  id' + i + '#DL_Stop' + '" id="id' + i +
                    '#DL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                    '#DL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul_onlyshow[i].hiddengainudstop +
                    ' MHz </td><td class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditDL_gain +
                    ' dB </td><td class=" text-center" >Missing Inf.</td>';
            } else {
                htmlmejorado += '<tr><th width="80px" scope="row">' + tabla_gain_dlul_onlyshow[i].Band +
                    '</th>	<td  width="80px" class=" text-center  id' + i + '#DL_Start' + '" id="id' + i +
                    '#DL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                    ...
                    '#DL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                    '#DL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul_onlyshow[i].hiddengainudstop +
                    ' </td><td class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditDL_gain +
                    ' dB </td><td class=" text-center" >' + tabla_gain_dlul[i].noteditDL_maxpwr + ' dBm</td>';
            }
            ...
            htmlmejorado += '<td  width="80px" class=" text-center  id' + i + '#UL_Start' + '" id="id' + i +
                ...
                ' </td><td width="80px" class=" text-center  id' + i + '#UL_Stop' + '" id="id' + i +
                '#UL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                '#UL_Stop' + "'" + ',' + i + ')" >' + tabla_gain_dlul_onlyshow[i].hiddengainulstop +
                ' </td><td  class=" text-center">' + tabla_gain_dlul_onlyshow[i].noteditUL_gain + ' dB</td>';
            ...
            if (isNaN(tabla_gain_dlul_onlyshow[i].noteditUL_maxpwr)) {
                ...
                htmlmejorado += ' <td width="80px" class=" text-center" >' + tabla_gain_dlul_onlyshow[i]
                    .noteditUL_maxpwr + ' dBm </td> ';
            }
            ...
            if (esUHFVHF == 0 || esUHFVHF == 2) {
                ...
                if (isNaN(tabla_gain_dlul_onlyshow[i].noteditDL_maxpwr)) {
                    htmlmejorado += '<tr><th width="80px" scope="row">' + nombandper +
                        '</th>	<td  width="80px" class=" text-center ' + v_temp_DL_Startclass + ' id' + i +
                        '#DL_Start' + '" id="id' + i +
                        '#DL_Start" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                        '#DL_Start' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_DL_Start +
                        ' </td>	<td width="80px" class=" text-center ' + v_temp_DL_Stopclass + ' id' + i + '#DL_Stop' +
                        '" id="id' + i +
                        '#DL_Stop" onkeypress="return soloNumeros(event)"  onblur="modif_table_array(' + "'id" + i +
                        '#DL_Stop' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_DL_Stop +
                        ' </td><td class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditDL_gain +
                        ' dB </td><td class=" text-center" >Missing Inf.</td>';
                } else {
                    htmlmejorado += '<tr><th width="80px" scope="row">' + nombandper +
                        ...
                        '#DL_Stop' + "'" + ',' + i + ')"  contenteditable="true">' + v_temp_DL_Stop +
                        ' </td><td class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditDL_gain +
                        ' dB </td><td class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditDL_maxpwr +
                        ' dBm</td>';
                }
                ...
                if (isNaN(tabla_gain_dlul_onlyshow[i].noteditUL_maxpwr)) {
                    ...
                    htmlmejorado += ' <td  class=" text-center" >' + tabla_gain_dlul_onlyshow[i].noteditUL_maxpwr +
                        ' dBm </td> ';
                }
                        ...
                        if (j.indexOf('notedit')) {
                            if (tabla_gain_dlul_onlyshow[i][j] == 0 || (isNaN(tabla_gain_dlul_onlyshow[i][j]))) {
                                ...
                                html += '<td width="80px" contenteditable="true" id="id' + i + '#' + j +
                                    '" onkeypress="return soloNumeros(event)" class="id' + i + '#' + j +
                                    '" onblur="modif_table_array(' + "'id" + i + '#' + j + "'" + ',' + i + ')">  ' +
                                    tabla_gain_dlul_onlyshow[i][j] + ' MHz</td>';
                            }
...
function Call_printcovers(vpara_ciu, vcant, vwo, vnomcli) {
    ...
    eModal.iframe('https://' + ipservidorapache + '/printoscovers.php?vciu=' + vpara_ciu + '&cc=' + vcant + '&vwo=' +
        vwo + '&vnomc=' + vnomcli, 'Print SO Covers');
        ...
        .then(
            function(input) {
                ...
                $.ajax({
                    ...
                    data: "idruninfodb=" + idlog_view2 + '&v_issue=' + input + '-Ref:' + idlog_view2 +
                        '&vuser=' + userregistred + '&tp=' + $('#amf').val() + '&tp1=' + $('#amf').val() +
                        '&keyd=' + idlog_view2,
                    type: 'post',
                    datatype: 'JSON',
                    cache: false,
...
function Call_printlabel_todos(vpara_ciu, vparamidorders) {
    console.log('si' + vpara_ciu);
    var ipservidorapache = '<?php echo $ipservidorapache; ?>';
    eModal.iframe('https://' + ipservidorapache + '/labelprintermultisn.php?vciu=' + vpara_ciu + '&vidord=' +
        vparamidorders, 'Label printing');
