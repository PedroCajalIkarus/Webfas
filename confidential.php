        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> <a href="edit_comp_dib.php"> Confidential </a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
			...
			<p name="msjwaitline" id="msjwaitline" align="center"><img src="img/waitazul.gif" width="100px" ></p>	
				...
				<!-- fin tabla add labeling -->
					...
					<span>Reference:	</span>
					  ...
					  <span class="badge" style="background-color:#ffcccc;" >Cui Inactive</span>
					   <span class="badge" style="background-color:#FF6565;">Cui Deleted </span>
...
var dateEditor = function(cell, onRendered, success, cancel){
	...
	function tabla_list()
	{
		...
		var table = new Tabulator("#tablelabeling", {													
					...
					columns:[		
							{title:"Modelo CIU", field:"modelciu", sorter:"string",  headerFilter:"input",editor:false },							
							{title:"Family Prod", field:"namefamily", sorter:"string" ,headerFilter:"input",editor:false},							
							{title:"Type Band", field:"typeband", sorter:"string", headerFilter:"input",editor:false	 },
							{title:"Type Prod", field:"typeproducts", sorter:"string",  headerFilter:"input" ,editor:false},
							{title:"Type Reg", field:"typeregulation", sorter:"string",  headerFilter:"input" ,editor:false	},													
							{title:"Description", field:"proddescrip", sorter:"string",  headerFilter:"input" ,editor:false	},																		
