...
error_reporting(0);
	...
	include("db_conect_srv20.php"); 
						...
						(
						 ...
						 (
							 ...
							 where reference in 
								 ...
								 where reference in
										 ( select reference  
										   from fnt_select_maxidrun_fas_outcome_integral_byidscrip('".$unitsn."',54) as maxidrun
										 )
								 and idfasoutcomecat = 0 and idtype = 23
												...
												(
													...
													where  idruninfodb in (
																			select reference 
																			from fnt_select_maxidrun_fas_outcome_integral_byidscrip('".$unitsn."' ,54)
																		) 
												)
		...
		on fas_outcome_category_type.idfasoutcomecat	=	fas_outcome_integral.idfasoutcomecat and 
		fas_outcome_category_type.idtype				=	fas_outcome_integral.idtype
		where  fas_outcome_integral.idfasoutcomecat in(3,11,5) and
		fas_outcome_integral.idtype in (202,201,200,207,0,1,203,204,101,102)
...
echo(json_encode(["label_system_volt"=>$label_system_volt,"values_System_Voltage_vsys"=>$values_System_Voltage_vsys,"values_System_Voltage_vin"=>$values_System_Voltage_vin,"values_Battery_Voltage_vbank"=>$values_Battery_Voltage_vbank,"values_Battery_Voltage_vbat"=>$values_Battery_Voltage_vbat,"values_Battery_Voltage_veload"=>$values_Battery_Voltage_veload,"values_CurrentComsum_ibat"=>$values_CurrentComsum_ibat,"values_CurrentComsum_iin"=>$values_CurrentComsum_iin,"values_CurrentComsum_ieload"=>$values_CurrentComsum_ieload,"values_individual_batt_volt_vbat1"=>$values_individual_batt_volt_vbat1,"values_individual_batt_volt_vbat2"=>$values_individual_batt_volt_vbat2 ]));
