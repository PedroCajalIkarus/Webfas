					...
					$msjdegrabo= "Update OK.!";
						/////////////////////////////////////////////////////////////////////////////////////
							...
							$vtextaudit=$slqband."***".$slqbandupd; 
									...
									$sentenciaudit = $connect20->prepare("INSERT INTO public.auditwebfas(dateaudit, userfas, menuweb, actionweb, descripaudit, textaudit)	VALUES (now(),  :userfas, :menuweb, :actionweb, :descripaudit, :textaudit);");
...
<form name="frma" id="frma" action="wizardproductsspecs_test.php" method="post" class="form-horizontal">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Wizard Products Spec  - SRV 10.4.253.20 TEST</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Wizard Products Spec  - SRV 10.4.253.20 TEST</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
UNIT --&gt; LEGACY																											  </option>	
				...
				<tr>
				<td colspan="4"> <button type="button" class="btn btn-block btn-outline-primary btn-xs" onclick="filtrartodo()" >Apply Filters</button> </td>
				</tr>
				</table>	
...
function filtrartodo()
	...
	console.log('losatributos'+ losatributos);
			...
			xhr2.open("POST", "searchcuicomponentfilters_test.php");
			xhr2.send(formData);
