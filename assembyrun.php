        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Assemby Run</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<br>
					<div class="container-fluid">
						...
						<div class="callout callout-success">
						  <h5>REF: 20190696WO - SN: 20066158FU </h5>
					  	...
					  	<form name="frmlabeling" id="frmlabeling" action="" method="post"  class="form-horizontal needs-validation"  >							
							   ...
							   <div class="card-body form-row">							   
									...
									<label for="exampleInputEmail1">Cabinet SN:</label>
									<input type="text" name="txtcabinetsn" id="txtcabinetsn" class="form-control" placeholder="Cabinet SN"  required data-required-message="Cabinet SN is required">
								
	
	
									</div>
									<div class="form-group col-md-6 ">
									<label for="exampleInputEmail1">Motherboard  SN:</label>
									<input type="text" name="txtmothersn" id="txtmothersn" class="form-control" placeholder="Motherboard  SN" required oninvalid="setCustomValidity('Motherboard  SN is required.')" 
                   oninput="setCustomValidity('')">
									</div>
								
								   <div class="form-group col-md-6">
									<label for="exampleInputEmail1">CIU:</label>
									<input type="text" name="txtciu" id="txtciu" class="form-control" placeholder="CIU" required oninvalid="setCustomValidity('CIU is required.')" 
                   oninput="setCustomValidity('')">
								   </div>
								...
								<div class="card-footer text-right">
								  ...
								  <button type="button" onclick="iniciar_assemby()" class="btn btn-primary right-align">Start Assembly</button>
