...
?>
	...
	<div class="card card-primary card-tabs">
			...
			<span class="text-right"><a href="finalchkallband.php?dnd=<?php echo $v_dnd ; ?>&idsndib=<?php echo $_REQUEST['idsndib']."&iduldl=9 &idmb=9&idruninfo=".$_REQUEST['idruninfo'];?>" target="_blank">Open in New Tab</a> &nbsp;&nbsp;&nbsp;</span>
             <div class="col-10">
...
if ($v_dnd =="WO")
{
	$sql = $connect->prepare("select distinct typeproduct, products.modelciu, orders_sn.pwrsupplytype , showdpxreport,orders_sn_specs.*
	from orders_sn 
	inner join orders_sn_specs
...
<th class="table-dark text-center">Status Gain</th>
<th class="table-dark text-center">Status MaxPower</th>
<?php 
  ...
  { ?>
<th class="table-dark text-center">Status NF</th>
<?php } ?>
<th class="table-dark text-center">Status IMD</th>
<?php 
  if(  $ciuisenterprice=="Y" &&  $ciuisremote=="Y")
  {
  ...
  { ?>
<th class="table-dark text-center">Status Spurious</th>
<?php } ?>
</tr>
...
<!-- fin levelread tabla especial -->
		 ...
		 <?php
				/// if( $typeproduct_ciu == "PSC REMOTE")
				$mostrargraficosDAS="";
				if(  $ciuisdas =="Y" &&  $ciuisremote=="Y" )
				{
					$mostrargraficosDAS="d-none";
					
				}	?>
			<section class="col-lg-3 connectedSortable ui-sortable <?php echo $mostrargraficosDAS; ?>">
		

				<div class="card <?php echo $mostrargraficosDAS; ?>">
					<div class="card-header">
...
/// definicion grafico 10
 ...
 options: optionesbasicasgrafico1	  
	...
	/// definicion grafico 10
	  var salesChart9 = new Chart(salesChart_graficoabajolinealityenterprise, { 
      type: 'line', 	
