  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tracking Orders SAP TESTING</h1>
          </div>
          <div class="col-sm-6">
                        ...
                        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                <br>
                                  ...
                                  ///  	echo "test:".$sqldetectchkeopicki;
                                    ...
                                    <?php
                                    $sqlmaxhistory = " select * from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = 'ASSY' and
                                    runprocessdate in (
                        select max(runprocessdate) from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = 'ASSY')
                                ...
                                ?>
                                        ...
                                        <span class="icon"> <i class="fa fa-check"></i> </span>
                                          <span class="text text-center">
                                            ...
                                            <?php echo "".$arraysteps_name[$immt] ."<br>"; ?>   
...
// fin// AutoComplete de CUIS version TOP	
   ...
   $("#txtlistcius").change(function(){
            ...
            window.location = 'trackingordersmmsap1.php?isdo='+datosmm[0]+'&typeisdo='+datosmm[1]+'&encont='+datosmm[2];
   });
