    ...
    <span class="col-sm-2 col-form-label textotabla10">Select the Iteration:</span>   
		 ...
		 <select class="form-control col-sm-3 form-control-sm" name="cmbiditeracion" id="cmbiditeracion" >
	        ...
	        $sql="SELECT DISTINCT  fas_tree_measure.idrununfo as idruninfo, max(datetime) as fechahora  from fas_tree_measure 
			  ...
			  and 	fas_calibration_result.modelciu in(select distinct  modelciu from products where typeproduct = 'MADRE') 
		 where  fas_tree_measure.unitsn = '".$vparam_vnrounitsn."' and  fas_tree_measure.uldl = ".$vparam_uldld." and fas_tree_measure.band = ". $vparam_band." and fas_tree_measure.iduniquebranch like '002%' group by fas_tree_measure.idrununfo order by fechahora desc ";
		 //echo "hola".$sql;
								  ...
								  foreach ($datacabez as $rowheaders) 
								  {
									$loencontre="";
										...
										//	echo "<a href='equalizeriir.php?idsndib=".$_REQUEST['idsndib']."&iduldl=".$vparam_uldld."&idmb=".$vparam_band."&idruninfo=".$vparam_idruninfo."'> It.".$vidnro ."</a> - ";
											echo " <option ".$loencontre." value='finalchk.php?idsndib=".$_REQUEST['idsndib']."&iduldl=".$vparam_uldld."&idmb=".$vparam_band."&idruninfo=".$vparam_idruninfo."'>".$vidnro." [".$fechahcortada."]</option>";
										$vidnro = $vidnro + 1;
									  }
									  ?>
					  </select>				  
...
from fas_tree_measure
where fas_tree_measure.iduniquebranch like '002%' and uldl = ".$vparam_uldld." and  band = ".$vparam_band." and  unitsn = '".$vparam_vnrounitsn."'
