...
$sqlmm="
SELECT   max(runinfodb.dateserver)  as maxff from fas_tree_measure
...
where   fas_finalcheckref_result.unitsn = '".$vparam_vnrounitsn."' and
		 ...
		 $dtafecha = $connect->query($sqlmm)->fetchAll();
	 
foreach ($dtafecha as $rowff) 
{
	$v_rowff= $rowff['maxff']; 
}
...
?>
                        ...
                        <td style="text-align: right"><strong><?php  echo substr($v_rowff,0,19);
...
?>
                ...
                <table style="width: 100%;" class="header">
                    <tr>
                        <td>
                            <h2 style="text-align: left; color:#0053a1;">TEST RESULTS</h2>
                        </td>
                        <td>
                ...
                <table
                    style="width: 100%;  border-top: 1px solid black; border-bottom: 1px solid black; font-size: 12pt;">
                    <tr>
                ...
                <table
                    ...
                    <tr>
                        <td style='width: 30%;text-align: left'>Calibrator:
                            <strong><?php echo $rowversiones['userruninfo'];?></strong>
                        </td>
                        <td style='width: 30%;text-align: left'> </td>
                        <td style='width: 30%;text-align: right'>FAS Version:
                            <strong><?php echo $rowversiones['fasversion'];?></strong>
                        </td>
                    ...
                    <tr>
                        <td style='width: 30%;text-align: left'>FW FPGA:
                            <strong><?php echo $rowversiones['fpgafirm'];?></strong>
                        </td>
                        <td style='width: 30%;text-align: left'>FW uC:
                            <strong><?php echo $rowversiones['ucfirm'];?></strong>
                        </td>
                        <?php if ( $vv_idbusiness_ciu==1)
{
	?>
                        <td style='width: 30%;text-align: left'>FW Ethernet:
                            <strong><?php echo $rowversiones['ethernetfirm'];?></strong>
                        </td>
                        <?php
}
?>
...
?>
                ...
                <table
                    style="width: 100%;font-size: 10pt;text-align: left;border-top: 1px solid black; border-bottom: 1px solid black;">

                    <tbody>

                        <tr>
                            <th style="text-align: left">DL gain:</th>
                            <td style="text-align: left"><?php echo floor($v_dl_gain); ?> (dB)</td>
                            <th style="text-align: left">UL gain:</th>
                            <td style="text-align: left"><?php echo floor($v_ul_gain); ?> (dB)</td>
                        </tr>

                        <tr>
                            <th style="text-align: left"> <?php if ( $ismaster=="N") { ?>DL Max Pwr Out: <?php } ?></th>
                            <td style="text-align: left"><?php if ( $ismaster=="N") { ?>
                                <?php echo floor($v_dl_gain_pwr); ?> (dBm) <?php } ?> </td>
                            <th style="text-align: left"><?php if ( $ciuisremote=="N") { ?> UL Max Pwr Out: <?php } ?>
                            </th>
                            <td style="text-align: left"><?php if ( $ciuisremote=="N") { ?>
                                <?php echo floor($v_ul_gain_pwr); ?> (dBm) <?php } ?> </td>
                        </tr>
                        <tr>
...
inner join idband
on idband.idband = orders_sn_specs.idband	
	where typedata = 'UNIT' and (so_soft_external like '%SO' or so_soft_external like '%RM') and  wo_serialnumber =  '".$vparam_vnrounitsn."'");
...
?>
                <table
                    style="width: 100%; font-size: 10pt; border-top: 1px solid black; border-bottom: 1px solid black; ">
                    <tr>
                        <td style='width: 33%;text-align: left'>Gain Tolerance: ±
                            <strong><?php echo $vv_info_gaintolerance;?> (dB)</strong>
                        </td>
                        <td style='width: 33%;text-align: left'>Max Pwr Tolerance: ±
                            <strong><?php echo $vv_info_maxpwrtolerance;?> (dBm)</strong>
                        </td>
                        <td style='width: 33%;text-align: left'>Noise Figure reference: <=<strong>
                                <?php echo $vv_info_nfreference;?> (dB)</strong></td>
                    </tr>
                    <tr>
                        <td style='width: 33%;text-align: left'>IMD Reference: <=<strong><?php echo $vv_info_imdlimit;?>
                                (dBm)</strong></td>
                        <td style='width: 33%;text-align: left'>Spurious reference: <= <strong>
                                <?php echo $vv_info_spuriousreference;?> (dBm)</strong></td>
...
?>
                <br><br>
                <table
                    style="width: 100%;font-size: 10pt;text-align: left;border-top: 2px solid black;border-right: 2px solid black;border-left: 2px solid black; border-bottom: 2px solid black;">
                    <tbody>
                        <tr>
                            <th
                                style="font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                Reference</th>
				...
				$mostrarlostitulodetabla='N';
						...
						//// $typeproduct_ciu == "PSC REMOTE"
								...
								//	echo "**********************SI";
									...
									inner join 
									( select iduniquebranch, unitsn, dibsn, uldl, band, idrununfo, max(idrev) as maxidrev , max(idorder) as maxidorder from fas_tree_measure
									...
									maxretry.maxidrev		=   fas_tree_measure.idrev and
									maxretry.maxidorder 	= 	fas_tree_measure.idorder

									inner join fas_tree
									on fas_tree.iduniquebranch = fas_tree_measure.iduniquebranch  and fas_tree.idfastree =  1
									inner join fas_step
									on fas_step.idfasstep = fas_tree.idfastrepson
									where   fas_tree_measure.iduniquebranch  in('002007013','00200701B','00200701A','00200701C','00200701B02F0','002007030') and fas_tree_measure.iduniquebranch like '002%' and fas_tree_measure.band = ".$rowheaders['band']." and  fas_tree_measure.unitsn = '".$vparam_vnrounitsn."' and  fas_tree_measure.idrununfo =".$vparam_idruninfo. " order by namebranch";
								...
								else
								{
									...
									inner join fas_step
									on fas_step.idfasstep = fas_tree.idfastrepson
									where   fas_tree_measure.iduniquebranch  in('002007013','00200701B','00200701A','00200701C','00200701B02F0','002007030') and fas_tree_measure.iduniquebranch like '002%' and fas_tree_measure.uldl = ".$rowheaders['uldl'] ." and fas_tree_measure.band = ".$rowheaders['band']." and  fas_tree_measure.unitsn = '".$vparam_vnrounitsn."' and  fas_tree_measure.idrununfo =".$vparam_idruninfo. " order by namebranch";
								}
 
//echo "<br>2do::".$query_lista;
	//and fas_calibration_result.modelciu  in(select distinct  modelciu from products where  idproduct not in (select distinct idproduct from products_attributes where v_boolean= true and idattribute = 0)) 	
		...
		//	{
		  ...
		  ?>
                        ...
                        <tr>
                            <td
                                style='font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black'><?php 
						if ($v_uldl ==0)
						{
					...
					//echo "cant band:".$quantityband."aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".$v_ban;
						...
						if(  $ciuisdas =="Y" && 	$ciuiscentrix=="Y")
						{
							echo "".$label_band_amostrar; ?> <a
                                    href="finalchkallband.php?dnd=<?php echo $v_dnd;  ?>&idsndib=<?php echo $vparam_vnrounitsn; ?>&idmb=<?php echo $v_ban ; ?>&iduldl=<?php echo $v_uldl; ?>&idruninfo=<?php echo $vparam_idruninfo; ?>&idrunaferbur=<?php echo $_REQUEST['idrunaferbur']; ?>#">
                                    <i class="fas fa-eye"></i> </a></td>
                            <?php
						}
						else
						{
							echo "".$label_band_amostrar ." - ".$label_ULDL_amostrar; ?> <a
                                href="finalchkallband.php?dnd=<?php echo $v_dnd;  ?>&idsndib=<?php echo $vparam_vnrounitsn; ?>&idmb=<?php echo $v_ban ; ?>&iduldl=<?php echo $v_uldl; ?>&idruninfo=<?php echo $vparam_idruninfo; ?>&idrunaferbur=<?php echo $_REQUEST['idrunaferbur']; ?>#">
                                <i class="fas fa-eye"></i> </a></td>
                            <?php
						}
...
/////////////////// OJOOO RECORDAR QUE ESTA FRENADDO ACA:::::::::::
///echo "aaaaaaaaaaaaaaaaa:".$ciuisbda;
////echo "ciuisbda".$ciuisbda."-ciuiscentrix".$ciuiscentrix."-ciuisremote".$ciuisremote;
if ( $ciuisbda=="Y" || substr($_name_ciu,0,4)=="DH14" || ($ciuiscentrix=="Y"  && $ciuisremote=="Y") )
{
	//exit();
}
///////////////////////////////////////
...
//	echo "<br>Cuadros:".$query_listacuadros;			
	...
	///	echo "a ver cuantos tengoo".count( $array_finalchk_pwr)."<br>";		  
		...
		?>
            <div class="page_break" id="content<?php echo "".$label_band_amostrar ." - ".$label_ULDL_amostrar; ?>"
                name="content<?php echo "".$label_band_amostrar ." - ".$label_ULDL_amostrar; ?>">
		 ...
		 ?></h3>
                <table
					...
					?>
                        ...
                        <tr>
                            <td
                                style="font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                Noise Figure <span style="text-align: right;">&nbsp;&nbsp; [dB]</span></td>
                            <?php
					   $mi=0;
                ...
                <table
                    ...
                    <thead class="thead-dark">
                        <tr>
                            <th
                                style="width: 30%;font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                Frequency Center [MHz] </th>
                            <?php
					  $mi=0;
                    ...
                    <tbody>
                        <tr>
                            <td
                                style="width: 20%;font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                IMD 1 <span style="text-align: right;">&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [dBm]</span></td>
                            <?php
					   $mi=0;
					...
					?>
                        ...
                        <tr>
                            <td
                                style="width: 20%;font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                Fundamental Tone 1 <span style="text-align: right;">&nbsp;&nbsp; [dBm]</span></td>
                            <?php
					   $mi=0;
					...
					?>
                        ...
                        <tr>
                            <td
                                style="width: 20%;font-size: 10pt;text-align: left;border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; border-bottom: 1px solid black;">
                                Fundamental Tone 2 <span style="text-align: right;">&nbsp;&nbsp; [dBm]</span></td>
                            <?php
					   $mi=0;
...
?>
			...
			?>
                ...
                <table
                    style="width: 680px;font-size: 10pt;text-align: center;border-top: 0px solid black;border-right: 0px solid black;border-left: 0px solid black; border-bottom: 0px solid black;">
                    <tr>
                        <td style="width:340px;height:190px;">Gain
                            <canvas id="salesCharttxripple<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                height="245px" style="height: 245px;width:338px"></canvas>
                        </td>
                        <td style="width:340px;height:190px;">

                            <canvas id="salesChartpowers<?php echo $vvv_sumanombregraf; ?>" width="338px" height="245px"
                                style="height: 245px;width:338px"></canvas>
                        </td>
                    </tr>
                </table>
                <?php if (	$mostrargraficosDAS=="") 
		{
			?>
                <div style="<?php echo $mostrargraficosDASENTER ?>">
                    <table
                        ...
                        <tr>
                            <td style="width:340px;height:19px;">Noise Figure
                                <canvas id="salesChartlevel<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                            </td>

                            <td style="width:340px;height:190px;">Gain vs PwrIn
                                <canvas id="graficoabajo1<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                    ...
                    <div class='d-none'>
                        <canvas id="graficoabajolr<?php echo $vvv_sumanombregraf; ?>" width="0px" height="0px"
                            style="height: 0px;width:0px"></canvas>
                    </div>
                </div>
                <?php
		}
			...
			?>
                <div style="<?php echo $mostrargraficosDASENTER ?>">
                    <table
                        ...
                        <tr>
                            ...
                            <td style="width:340px;height:190px;">
                                <canvas id="graficoabajo1<?php echo $vvv_sumanombregraf; ?>" width="0px" height="0px"
                                    style="height: 0px;width:0px"></canvas>
                                <?php if ($tienedatosgraflevelread =="N")
				{
					?>
                                <p style='display: none'>
                                    <canvas id="graficoabajolr<?php echo $vvv_sumanombregraf; ?>" width="0px"
                                        height="0px" style="height: 0px;width:0px"></canvas>
                                </p>
                                <?php
				}  
				else
				{
					?>
                                ...
                                <canvas id="graficoabajolr<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                                <?php
				}
				?>
                    ...
                    <table
                        ...
                        <tr>
                            <td style="width:340px;height:190px;">PwrOut vs PwrIn
                                <canvas id="graficoabajo2<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                            </td>

                            <td style="width:340px;height:190px;">PwrIn Dynamic Range
                                <canvas id="graficoabajo3<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                            </td>
                        </tr>
                    </table>
                    <table
                        ...
                        <tr>
                            <td style="width:340px;height:190px;">Ch AGC vs PwrIn
                                <canvas id="graficoabajo4<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                            </td>

                            <td style="width:340px;height:190px;">BB AGC vs PwrIn
                                <canvas id="graficoabajo5<?php echo $vvv_sumanombregraf; ?>" width="338px"
                                    height="245px" style="height: 245px;width:338px"></canvas>
                ...
                var salesChart_finalchknoisefig = $('#salesChartlevel<?php echo $vvv_sumanombregraf; ?>').get(0)
                    .getContext('2d');
                var salesChart_finalchkmaxpowers = $('#salesChartpowers<?php echo $vvv_sumanombregraf; ?>').get(0)
                    .getContext('2d');
                var salesChart_finalchkgain = $('#salesCharttxripple<?php echo $vvv_sumanombregraf; ?>').get(0)
                    .getContext('2d');
                var salesChart_finalgraf1 = $('#graficoabajo1<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');
                var salesChart_finalgraf2 = $('#graficoabajo2<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');
                var salesChart_finalgraf3 = $('#graficoabajo3<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');
                var salesChart_finalgraf4 = $('#graficoabajo4<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');
                var salesChart_finalgraf5 = $('#graficoabajo5<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');

                var salesChart_finalgraf6 = $('#graficoabajolr<?php echo $vvv_sumanombregraf; ?>').get(0).getContext(
                    '2d');
...
?>
                    ...
                    $(document).ready(function() {
                        ...
                        var imggrafico1 = document.getElementById('salesCharttxripplemm00').toDataURL(
                            'image/png');
                        ...
                        $('#testDiv').empty().append('<img src=' + imgdelcanvas +
                            ' height="346px" width="232px">')
