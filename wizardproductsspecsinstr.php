...
if($_POST)
	{
		...
		//levantamos los valores ingresamos para modificar
 		$v_txtrbw = $_REQUEST['txtrbw'];
		$v_txtspan = $_REQUEST['txtspan'];
		$v_txtreflvl = $_REQUEST['txtreflvl'];
		$v_txtscaleoffset = $_REQUEST['txtscaleoffset'];
		$v_txtavgcount = $_REQUEST['txtavgcount'];
		$v_txtavgon = $_REQUEST['txtavgon'];
		$v_txtpwron1 = $_REQUEST['txtpwron1'];
		$v_txtpwron2 = $_REQUEST['txtpwron2'];
		$v_txtpwrout1 = $_REQUEST['txtpwrout1'];
		$v_txtpwrout2 = $_REQUEST['txtpwrout2'];
		$v_txtrfon1 = $_POST['txtrfonma'];
		$v_txtrfon2 = $_POST['txtrfonm'];
		$v_txtscripttype = $_POST['txtscripttype'];
		...
		try {
				...
				//	echo "<br>chkprod valor de ".$clave2." es: ".$valor2;
					...
					$idbandselect = $losvalores[2];
					$iduniquebranch = $losvalores[3];
					$iduldl = $losvalores[4];
					...
					if ($v_txtspan <> "")
					{
						...
						$setear_sql2= $setear_sql2." span='".$v_txtspan ."' ";
						$sumocoma="S";
					}
					...
					//	echo "3";
						...
						$setear_sql3=$setear_sql3. " reflvl='".$v_txtreflvl ."' ";
						$sumocoma="S";
					}
					...
					if ($v_txtscaleoffset <> "")
					{
						...
						$setear_sql4= $setear_sql4." scaleoffset='".$v_txtscaleoffset ."' ";
						$sumocoma="S";
					}
					...
					if ($v_txtavgcount <> "")
					{
						...
						$setear_sql5=$setear_sql5. " avgcount='".$v_txtavgcount ."' ";
						$sumocoma="S";
					}
					...
					if ($v_txtavgon <> "")
					{
						...
						$setear_sql6= $setear_sql6." avgon='".$v_txtavgon ."' ";
						$sumocoma="S";
					}
					if ($v_txtpwron1 <> "")
					{
						...
						$setear_sql7= $setear_sql7." pwrin1='".$v_txtpwron1 ."' ";
						$sumocoma="S";
					}
					if ($v_txtpwron2 <> "")
					{
						...
						$setear_sql8= $setear_sql8." pwrin2='".$v_txtpwron2 ."' ";
						$sumocoma="S";
					}
					if ($v_txtpwrout1 <> "")
					{
						...
						$setear_sql9= $setear_sql9." pwrout1='".$v_txtpwrout1 ."' ";
						$sumocoma="S";
					}
					if ($v_txtpwrout2 <> "")
					{
						...
						$setear_sql10= $setear_sql10." pwrout2='".$v_txtpwrout2 ."' ";
						$sumocoma="S";
					}
					if ($v_txtrfon1 <> "")
					{
					//	echo "bbb";
						...
						$setear_sql11=$setear_sql11. " rfon1='".$v_txtrfon1 ."' ";
						$sumocoma="S";
					...
					if ($v_txtrfon2 <> "")
					{
						...
						$setear_sql12=$setear_sql12. " rfon2='".$v_txtrfon2 ."' ";
					...
					if ($v_txtscripttype <> "")
					{
						...
						$setear_sql13=$setear_sql13. " idscripttype=".$v_txtscripttype ." ";
						
					}
				 /*
				 UPDATE public.fas_instruments_parameters
	SET ciu=?, idproduct=?, idfastree=?, idband=?, uldl=?, iduniquebranch=?, 
	rbw=?, span=?, reflvl=?, scaleoffset=?, avgcount=?, avgon=?, pwrin1=?, 
	pwrin2=?, pwrout1=?, pwrout2=?, rfon1=?, rfon2=?
	WHERE <condition>;
				 */
					$slqbandupd ="UPDATE public.fas_instruments_parameters set ".$setear_sql1.$setear_sql2.$setear_sql3.$setear_sql4.$setear_sql5.$setear_sql6.$setear_sql7.$setear_sql8.$setear_sql9.$setear_sql10.$setear_sql11.$setear_sql12.$setear_sql13." 		where idproduct = ".$idproduct." and  idband =  ".$idbandselect ." and uldl = ".$iduldl." and iduniquebranch = '".$iduniquebranch."'" ;
			//	echo "<br>".$slqbandupd ;
				...
				$connect->query($slqbandupd);
					$msjdegrabo= "Update OK.!";
						/////////////////////////////////////////////////////////////////////////////////////
							...
							$vaccionweb="update fas_instruments_parameters";
							$vdescripaudit="update fas_instruments_parameters -".$valor2;
	  ...
	  <div class="container-fluid">
									 ...
									 Bands</a></li>
									  ...
									  <li role="presentation" aria-selected="false" aria-level="2" aria-labelledby="ajax_ciu_addlbl*1129_anchor" id="ajax_ciu_addlbl*1129" class="jstree-node  jstree-leaf jstree-last">
										...
										<a class="jstree-anchor" href="wizardproductsspecsinstr.php" tabindex="-1" role="treeitem" aria-selected="false" aria-level="2" id="ajax_ciu_addlbl*1129_anchor">
									      ...
									      </i> <b> Measures Instruments </b></a></li>
		...
		<section class="col-lg-10 connectedSortable ui-sortable">
			...
			<table class="table table-striped">
				...
				<td>
                        <label>Select </label>
                        <select multiple="" class="form-control form-control-sm" name="losuldl" id="losuldl"    >
...
UNIT --&gt; LEGACY																											  </option>	
				...
				<td>
                        ...
                        <select  class="form-control form-control-sm" name="lasmediciones" id="lasmediciones"    >
			  ...
			  <p align="right">
				  ...
				  <table class="table   table-bordered table-sm ">
						...
						<td>	<label for="exampleInputEmail1">RBW:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtrbw')" name="btntxtrbw" id="btntxtrbw"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">SPAN:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtspan')" name="btntxtspan" id="btntxtspan"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">REFLVL:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtreflvl')" name="btntxtreflvl" id="btntxtreflvl"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">SCALEOFFSET:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtscaleoffset')" name="btntxtscaleoffset" id="btntxtscaleoffset"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">AVG COUNT:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtavgcount')" name="btntxtavgcount" id="btntxtavgcount"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">AVG ON:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtavgon')" name="btntxtavgon" id="btntxtavgon"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">PWR IN 1:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtpwron1')" name="btntxtpwron1" id="btntxtpwron1"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">PWR IN 2:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtpwron2')" name="btntxtpwron2" id="btntxtpwron2"> <i class="fas fa-edit"></i> Edit </button> </td>

						<td>	<label for="exampleInputEmail1">PWR OUT 1:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtpwrout1')" name="btntxtpwrout1" id="btntxtpwrout1"> <i class="fas fa-edit"></i> Edit </button> </td>
						<td>	<label for="exampleInputEmail1">PWR OUT 2:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtpwrout2')" name="btntxtpwrout2" id="btntxtpwrout2"> <i class="fas fa-edit"></i> Edit </button> </td>
				 
						<td>	<label for="exampleInputEmail1">RFON 1:</label>   <button type="button" class="btn btn-xs btn-default" onclick="hablitame('divtxtrfon1')" name="btntxtrfon1" id="btntxtrfon1"> <i class="fas fa-edit"></i> Edit </button> </td>
...
?>
									...
									<div class="form-group col-md-6 d-none" id="divtxtspan" name="divtxtspan">
										<label for="exampleInputEmail1">SPAN:</label> 										
										<input type="text" name="txtspan" disabled id="txtspan" class="form-control form-control-sm  " value="">	
									</div>	
									<div class="form-group col-md-6 d-none" id="divtxtreflvl" name="divtxtreflvl">
										<label for="exampleInputEmail1">REFLVL:</label> 										
										<input type="text" name="txtreflvl" disabled id="txtreflvl" class="form-control form-control-sm  " value="">	
									</div>

									<div class="form-group col-md-6 d-none" id="divtxtscaleoffset" name="divtxtscaleoffset">
										<label for="exampleInputEmail1">SCALEOFFSET:</label> 										
										<input type="text" name="txtscaleoffset" disabled id="txtscaleoffset" class="form-control form-control-sm  " value="">	
									</div>

									<div class="form-group col-md-6 d-none" id="divtxtavgcount" name="divtxtavgcount">
										<label for="exampleInputEmail1">AVG COUNT:</label> 										
										<input type="text" name="txtavgcount" disabled id="txtavgcount" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtavgon" name="divtxtavgon">
										<label for="exampleInputEmail1">AVG ON:</label> 										
																		
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtavgony" name="txtavgon"  value="TRUE"   >
										<label for="customRadio2" class=" ">YES</label>
										</div>
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtavgonn" name="txtavgon"  value="FALSE"  >
										<label for="customRadio2" class=" ">NO</label>
										</div>
									</div>

									

									<div class="form-group col-md-6 d-none" id="divtxtpwron1" name="divtxtpwron1">
										<label for="exampleInputEmail1">PWR IN 1:</label> 										
										<input type="text" name="txtpwron1" disabled id="txtpwron1" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtpwron2" name="divtxtpwron2">
										<label for="exampleInputEmail1">PWR IN 2:</label> 										
										<input type="text" name="txtpwron2" disabled id="txtpwron2" class="form-control form-control-sm  " value="">	
									</div>


									<div class="form-group col-md-6 d-none" id="divtxtpwrout1" name="divtxtpwrout1">
										<label for="exampleInputEmail1">PWR OUT 1:</label> 										
										<input type="text" name="txtpwrout1" disabled id="txtpwrout1" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtpwrout2" name="divtxtpwrout2">
										<label for="exampleInputEmail1">PWR OUT 2:</label> 										
										<input type="text" name="txtpwrout2" disabled id="txtpwrout2" class="form-control form-control-sm  " value="">	
									</div>
									<div class="form-group col-md-6 d-none" id="divtxtrfon1" name="divtxtrfon1">
										<label for="exampleInputEmail1">RFON 1:</label> 				

									 									
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtrfon1" name="txtrfonma"  value="TRUE"   >
										<label for="customRadio2" class=" ">YES</label>
										</div>
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtrfon1" name="txtrfonma"  value="FALSE"  >
										<label for="customRadio2" class=" ">NO</label>
										</div>
 
									 
									</div>	
									<div class="form-group col-md-6 d-none" id="divtxtrfon2" name="divtxtrfon2">
										<label for="exampleInputEmail1">RFON 2:</label> 										
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtrfon2" name="txtrfonm"  value="TRUE"   >
										<label for="customRadio2" class=" ">YES</label>
										</div>
										<div class="custom-control custom-radio">
										<input class=" " type="radio" id="txtrfon2" name="txtrfonm"  value="FALSE"  >
										<label for="customRadio2" class=" ">NO</label>
										</div>
									</div>	
...
function filtrartodo()
	...
	console.log('losatributos'+ losatributos);
			...
			xhr2.open("POST", "searchcuicomponentfiltersinstr.php");
			xhr2.send(formData);
