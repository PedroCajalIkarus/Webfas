              ...
              $where_sn_add ="  and orders_sn.wo_serialnumber ='".$_REQUEST['encont']."' ";    
                    ...
                    if ( $typeisdo =="UP")
                      ...
                      else
                      {
                         ...
                         if ( $typeisdo =="WO")
                         {
                            ...
                            $sqltot =" SELECT distinct v_string , quantity
                	...
                	if( $_SESSION["g"] =='develop' || 'Productionadmin' == $_SESSION["g"] )
                                                        ...
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <p class="text-danger">No Passed </p>
                                                                    </th>
                                                                    <th>
                                                                        <p class="text-success">ACK SAP OK</p>
                                                                    </th>
                                                                    <th>
                                                                        <p class="text-danger">ACK Error SAP </p>
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                            ...
                            foreach ($data_wostep as $row_steps) 
                            {
                              ?>
                                                                <tr>
                                                                    <td><?php echo $row_steps['v_string']." - Q:[".$row_steps['quantity']."] "; ?>
                                                                    </td>
...
//echo "<hr>".$sql_sap_report;
             ...
             //      echo "<br>wO".   $idorderwo."---sO:".$v_idp;

                  //   echo "<br>query:".   $query_xml;
                   //  exit();
               ...
               /*
                "ENG-CAL"
                "QC-FINAL" - no lo tengo programado
                "RWKPRCHK"
                "2ND-ASSY"
                "RWKCAL" - no lo tengo programado
                "MODULE" - no lo tengo programado
                "FILT-CAL" - no lo tengo programado
                "PRECHECK"
                "ASSY"
                "A.BURN"
                "RWKPRECHECK"
                "FINALCAL"
                "RWKASSY"
                "2WAYASSY" - no lo tengo programado
                "BURNING"
                */
             ...
             //     echo "<br>-------".$arraysteps_name[$immt]." wo-->".$rowbuscawo['ref_wo']." -- so-> ". $ref_so." <-idso----".$v_idp." - idwo:".$idorderwo." ---haveSOasing:". $haveSOasing;
                        ...
                        if  ($arraysteps_name[$immt]  =="so_UPGRADELIC"  )
                        {
                         ...
                         crear_steps_so_UPGRADELIC($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                        ...
                        if  ($arraysteps_name[$immt]  =="so_FINALCAL"  )
                        {
                          ...
                          crear_steps_so_FINALCAL($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                        ...
                        if  ($arraysteps_name[$immt]  =="so_ENG-CAL"  )
                        {
                          ...
                          crear_steps_crear_steps_so_ENGCAL($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                          ...
                          if  ($arraysteps_name[$immt]  =="so_BURNING"  )
                            {
                              $tengofuncionecreada=1;
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: sO:'.$ref_so." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                             crear_steps_so_BURNING($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            ...
                            {
                              $tengofuncionecreada=1;
                           ///   echo "aca".$arraysteps_name[$immt];   
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: WO:'.$ref_wo." - SN: ".$rowbuscawo['wo_serialnumber'];   
                         ////     echo              "*******************".$vvnombre_a_mostrar_en_dvi."*******************";               
                              crear_steps_wo_ENG($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $idorderwo,$vvnombre_a_mostrar_en_dvi,$ref_wo,$model_ciu_wo, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }

                            ///crear_steps_wo_BURNING.
                            if  ($arraysteps_name[$immt]  =="wo_BURNING"  )
                            {
                              $tengofuncionecreada=1;
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: WO:'.$ref_wo." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                               crear_steps_wo_BURNING($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $idorderwo,$vvnombre_a_mostrar_en_dvi,$ref_wo,$model_ciu_wo, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                            ...
                            if  ($arraysteps_name[$immt]  =="wo_ASSY"  )
                            {
                             ...
                             crear_steps_woinfo_ASSY($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $idorderwo,$vvnombre_a_mostrar_en_dvi,$ref_wo,$model_ciu_wo, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                       ...
                       ///       echo "sssssssssssssssssssssssssssssssssssss";
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: '.$ref_so." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                               crear_steps_woinfo_ASSY($arraysteps_name[$immt] ,$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                            ...
                            if  ($arraysteps_name[$immt]  =="so_2ND-ASSY"  )
                            {
                              $tengofuncionecreada=1;
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: SO:'.$ref_so." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                               crear_steps_woinfo_2NDASSY($arraysteps_name[$immt],$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                            if  ($arraysteps_name[$immt]  =="wo_PRECHECK" || $arraysteps_name[$immt]  =="wo_RWKPRECHECK"  )
                            {
                              $tengofuncionecreada=1;
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: WO:'.$ref_wo." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                              crear_steps_woinfo_PRECHECK($arraysteps_name[$immt],$rowbuscawo['wo_serialnumber'], $idorderwo,$vvnombre_a_mostrar_en_dvi,$ref_wo,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                           ...
                           ///   echo "ssssssss222222222222222sssssssssssssssssssssssssssss";
                              $vvnombre_a_mostrar_en_dvi ='Order Detail :: SO:'.$ref_so." - SN: ".$rowbuscawo['wo_serialnumber'];                              
                              crear_steps_soinfo_FINALINSPEC($arraysteps_name[$immt],$rowbuscawo['wo_serialnumber'], $v_idp,$vvnombre_a_mostrar_en_dvi,$ref_so,$model_ciu, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                            if  ($arraysteps_name[$immt]  =="wo_A.BURN"    )
                            {
                             ...
                             crear_steps_wo_AFTERBURNING($arraysteps_name[$immt],$rowbuscawo['wo_serialnumber'], $idorderwo,$vvnombre_a_mostrar_en_dvi,$ref_wo,$model_ciu_wo, $arraysteps_name_refso[$immt], $enabled_attachfile_step);
                            }
                          ...
                          ?>
                                                            <div class="stepazulyamarillo active">
                                                                ...
                                                                <span class="text"><b><?php echo substr($arraysteps_name[$immt],3,22); ?>
                                                                        <br> </b>
                                                                </span>
                    ...
                    ///     echo "<br>-------".$arraysteps_name[$immt]." -->".$rowbuscawo['so_soft_external']." -- ". $ref_woso."----".$v_idp."----". $haveSOasing;
   ...
   ///        echo  "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<hr>".$sqlsoIF_old."<hr>";
                  ...
                  if ($cantrefres ==1 )
                  {
                    ?>
                                                            ...
                                                            nuevoref = nuevoref.replace("trackingorderssap",
                                                                "trackingorders");
...
function crear_steps_so_UPGRADELIC($vv_worcenter,$vv_sn, $vv_idp,$vvnombre_a_mostrar_en_dvi,$vv_soworam,$vv_modelciu,$temp, $v_enable_attachfile)
{
  ...
  ?>
                            ...
                            <span class='text text-left'>
                                ...
                                <br><a
                                    href="printokeyupgrade.php?vido=<?php echo $idorders_upgrde; ?>&sn=<?php echo $vv_sn; ?>"
 ...
 foreach ($data_wo as $rowwo) 
 {
  ...
  $psswdtkkey = substr( md5(microtime()), 1, 8);
    ...
    fas_outcome_integral.idtype= 13    
      ...
      ///
       ...
       if ( $ciuisenterprice =='Y')
             ...
             else
             {
               ...
               ?>
                                            <a href="#"
                                                onclick="show_info('finalchk','<?php echo $vv_sn; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchk; ?>','<?php echo $rowbuscawo['tienefinalchk_idruninfo']; ?>',0)"><span
                                                    class="icon"><i class="fa fa-box"></i> </span> <span
                                                    class="text"><b> <?php echo substr($vv_worcenter,3,12); ?> <br>
                                                        <?php
             }?>
                                        ...
                                        <br> <a
                                            href="<?php echo  $linkreportafter_burning_check; ?>?idsndib=<?php echo  $vv_sn; ?>&iduldl=0&idmb=0&idrun=<?php echo $rowbuscawo['tienefinalchk_idruninfo'];?>"
                                            target="_blank"> <i class='fas fa-file-pdf'></i> - View Report</a>
                                </a><br>
                                <?php if ( $v_enable_attachfile=="Y") { ?>
                                <a href="#"
     ...
     {
         ?>
                <div class="step <?php echo  $activo_paso4; ?>"> <span class="icon"><i class="fa fa-box"></i> </span>
                    <span class="text"><?php echo substr($vv_worcenter,3,12); ?> <br>
...
?>
                            <div class="step <?php echo  $activo_paso3; ?>"> <a href="#"
                                    ...
                                    <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text"><b>BURNING
                                            <br> <?php echo $activo_paso3_totalpass; ?></span></a></b> </div>
                            <?php
//////
...
fas_outcome_integral.idtype= 13
 ...
 foreach ($result_ifautotest as $row_autotest)
 {
  ...
  if ($row_autotest['tienecalibration_totalpass']==0 )
  {
...
/////
/////Buscamos el tipo de reporte para el SKU
 ///echo " select reporttype from products_webfas_report  where idproduct =  ".$vtempidproduct;
...
?>
                            <div class="step <?php echo  $activo_paso3; ?>">
                                <a href="#"
                                    onclick="show_info('<?php echo $name_js_report;?>','<?php echo $vv_sn; ?>','<?php echo $idorderwo; ?>','<?php echo $nombre_a_mostrar_en_dvi_calib; ?>','<?php echo $idruninfowo_ENG; ?>',0)">
                                    <span class="icon">
                                        <i class="fa fa-box"></i> </span> <span class="text"><b>ENG-CAL <br>
...
$("#txtlistcius").change(function() {
    ...
    window.location = 'trackingorderssap.php?isdo=' + datosmm[0] + '&typeisdo=' + datosmm[1] + '&encont=' +
        datosmm[2];
});
...
function show_info_stepidsap(desdedonde, snparam, soparam, sotextoamostrar, idruninfoparam, idparamafterburning,
    ...
    if (desdedonde == 'PrecheckBBUANN') {
        eModal.iframe('calibrationqualitychecklisallsurvery.php?elsn=' + snparam + '&elso=' + soparam + '&elciu=' +
            sotextoamostrar + '&stepidsap=' + stepidsap, 'BBU ANN Acceptance Test');
    ...
    if (desdedonde == 'Precheckultest') {
        ...
        eModal.iframe('electricstrengthchecklist.php?elsn=' + snparam + '&elso=' + soparam + '&elciu=' +
            sotextoamostrar + '&stepidsap=' + stepidsap + '&stepidsap=' + stepidsap, 'Quality UlTest');
...
function show_info(desdedonde, snparam, soparam, sotextoamostrar, idruninfoparam, idparamafterburning) {
    ...
    if (desdedonde == 'calibrationyburchkmms') {
        eModal.iframe('https://webfas.honeywell.com/autotestboxtimeline_mms.php?hidmenu=Y&idr=' + idruninfoparam,
            'Calibration & Burnin Check 1  ');
        eModal.iframe('https://webfas.honeywell.com/calibbburepot_mms_bbu.php?hidmenu=Y&idr=' + idruninfoparam +
            '&unitsn=' + snparam, 'Calibration & Burnin Check  2');
    ...
    if (desdedonde == 'picking') {
        eModal.iframe('wopickingsteps.php?elso=' + soparam + '&elsn=' + snparam + '&elciu=' + sotextoamostrar +
            '&typeworkc=' + idparamafterburning, ' ' + snparam + ' || ' + soparam + ' || ' + sotextoamostrar);
    }
    ////////////////////////////////////////////////////////////////////////////////////////
    if (desdedonde == 'orderinfo') {
