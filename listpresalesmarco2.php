        ...
        <div class="row">
          <section class="col-lg-6 connectedSortable ui-sortable">
			...
			<a href="generarsaleorders.php" style="color:#0053a1;"><i class='fas fa-plus-circle' style='font-size:24px;color:#0053a1;'></i>Create New PO / SO</a> &nbsp;&nbsp;
				...
				<a href="generarsaleordersupgrade.php" style="color:#0053a1;"><i class='fas fa-calendar-plus' style='font-size:24px;'></i> Create new Upgrade SO</a> &nbsp;&nbsp;
			</p>
			...
			<!-- aca form -->			
				...
				//		$queryquefiltramos=" and pre.date_approved > '".date(Y)."-01-01 00:00:00' ";
					...
					<!--- demo acordion--->
					&nbsp;<b>(*) -  <a href='listpresalesmarco.php?qqdays=30'>Show last 30 days</a>    ||  <a href='listpresalesmarco.php?qqdays=1500'>View All </a></b>
...
, orders_attributes.v_boolean::integer as isupgrade, products_upgrades.upgrcode ,min(orders_attributesrabbit.v_boolean::integer) as 	haverabbit  , products.active as activeprod
from orders as pre
...
where   orders_sn.so_soft_external like '%29929752%' and orders_sn.ponumber = 'A1-Firestone BDA PO1' 
and orders_sn.idcustomers= 241 and pre.idorders= 3817
group by products.idproduct , pre.idcustomers, namecustomers ,  orders_sn.ponumber ,orders_sn.so_soft_external, pre.active,fassrverror, pre.processfasserver, pre.idorders,pre.idrev,  products.modelciu , quantity,  pre.date_approved ,  orders_attributes.v_boolean, products_upgrades.upgrcode  
,products.active 
order by  datestate desc	");
					...
					//	{
					  ...
					  <td class="font-weight-bold"><a href="#" title="View - Edit" onclick="show_po(<?php echo  $idpresales; ?>, <?php echo $habilito_editar_so; ?>)"><?php echo $so_number;  ?> </a>&nbsp&nbsp <a href="#" onclick="show_po(<?php echo  $idpresales; ?>, <?php echo $habilito_editar_so; ?>)" title="View - Edit"><i class='far fa-edit' style='font-size:14px'></i></a > &nbsp&nbsp <a href="#" title="Delete?" onclick="delete_po(<?php echo  $idpresales; ?>, 2)"><i class='far fa-trash-alt' style='font-size:14px'></i></a >
						...
						{
							?>
							<td class="font-weight-bold"><a href="#" title="View - Edit" onclick="show_po(<?php echo  $idpresales; ?>, <?php echo $habilito_editar_so; ?>)"><?php echo $so_number;  ?> </a>&nbsp&nbsp 							
							</td>
							<?php	
						}
					 ...
					 <td class="font-weight-bold"><span class="badge badge-primary right" title="Quantity"><?php echo $quantityasignados." / ".$quantity; ?></span></td>
					  ...
					  //  echo $row['haverabbit']; //Estado BORRADOR
						...
						////	echo "PENDIENTE DIEGO";
							if ($row['haverabbit'] =="")
							{
								echo '<span class="text-warning">Missing Rabbit Specs </span>';
							}
							else
							{
							 ...
							 if (data.snasignados== null)
								...
								else
								{
									tabla_info_show_po=tabla_info_show_po+"<tr><th><b>SN LIST</b></th><td></td><td></td><td></td></tr>";		
										...
										{
											if( $("#qeneslogin").val() =='develop')
											{
												tabla_info_show_po=tabla_info_show_po+"<tr><th class='colorazulfiplex'><b>SN assigned: </b>  </th><th class='colorazulfiplex'><b>"+itemstock2.wo_serialnumber+"</b></th> <td colspan='2'> <a href='unlinksndevelop.php?snmm="+itemstock2.wo_serialnumber+"' target='_blank'> <span class='text-danger'>Develop::unlink sn </span> </a>  </td></tr>";			
											}
											else
											{
...
$.ajax({
										...
										success: function(respuesta) {
											...
											if (respuesta.value='ok')
											{
												...
												window.location.href= 'listpresalesmarco.php';
											}
