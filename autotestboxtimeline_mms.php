...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Auto Calibrate FLEX - MMS - TimeLine</h1>
          </div>
          <div class="col-sm-6">
...
function armar_graficos_stresslevelread()
{
     ...
     $.ajax
        ({ 
          url: 'ajax_graph_stresslevelread_mms.php?idruninfo='+params.get('idr'),
...
function armar_graficos_imdstress()
{
        ...
        $.ajax
        ({ 
          url: 'ajax_graph_imgstress_mms.php?idruninfo='+params.get('idr'),
          data: "idruninfo="+params.get('idr'),	
          type: 'post',
          async:true,
          cache:false,
  ...
  function armar_graficos_levelread()
  {
        ...
        $.ajax
        ({ 
          url: 'ajax_graph_lelveread_mms.php?idruninfo='+params.get('idr'),
          data: "idruninfo="+params.get('idr'),	
          type: 'post',
          async:true,
          cache:false,
  ...
  function armar_graficos_maxprw()
  {
        ...
        $.ajax
        ({ 
          url: 'ajax_graph_maxpwr_mms.php?idruninfo='+params.get('idr'),
          data: "idruninfo="+params.get('idr'),	
          type: 'post',
          async:true,
          cache:false,
