  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Process boms CSV files</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Process boms CSV files</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
//Print_r($row);
echo "<hr>";
echo "0:".$row[0]." -- 1:".$row[1]."-2:".$row[2]." -- 3:".$row[3]."--4:".$row[4]." -- 5:".$row[5]."--6:".$row[6]." -- 25:".$row[25]."<br>";
