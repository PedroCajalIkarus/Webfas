...
?>
  ...
  <a class="btn btn-primary btn-sm" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Replicate all data from</a>
</p>
<div class="row">
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body">
	  Select the product you want to use as replica template.<br>
	  <select class="js-example-basic-single col-sm-8" required  id="txtlistciusorig" name="txtlistciusorig">
						...
						<div class="container">
							<div class="row">
								<div class="col">
								 <br>
										<label for="inputEmail31" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="Firmware" checked="">     	
										Firmware  </label><br>
										<label for="inputEmail32" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="objectobanda " checked="">     	
										Object Band   </label><br>
										<label for="inputEmail33" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="RoutinesReferences" checked="">     	
										Routines References  </label><br>
										<label for="inputEmail34" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="RoutinesProcess" checked="">     	
										Routines Process  </label>		<br>				

										<label for="inputEmail35" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="RoutimeProduct" checked="">     	
										Routime Product  </label>	<br>
										<label for="inputEmail36" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="ScriptSetup" checked="">     	
										Script Setup  </label>	

								</div>
								<div class="col"><br>
										<label for="inputEmail37" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="FasTreeProduct" checked="">     	
										Fas Tree Product  </label>		<br>
										<label for="inputEmail38" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="ProductAttributes" checked="">     	
										Product Attributes  </label>		<br>

										<label for="inputEmail39" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="ProductLabel" checked="">     	
										Product Label  </label><br>

										<label for="inputEmail310" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="ProductPrintLabel" checked="">     	
										Product Print Label  </label><br>

										<label for="inputEmail311" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="FASTreeReferenceInstrument" checked="">     	
										FAS Tree Reference Instrument  </label><br>

										<label for="inputEmail312" class="col-sm-6 col-form-label">											
										<input type="checkbox" value="" name="todo2" id="FASIncomeIntegral" checked="">     	
										FAS Income Integral (ALL)   </label>
								</div>
							</div>	
						</div>
						...
						<br>
						<a class="btn btn-primary btn-sm"   href="#" onclick="replicame_income()"  >Replicate</a>
      </div>
    </div>
  </div>
...
function replicame_income()
{
	...
	if (($("#txtlistciusorig").val()  != $("#txtlistcius").val()))
	{
		if (envioareplicar == 'S')
		{
			...
			var namesfntrepli = $('input:checked').map(function () {
					return this.id;
				}).get();

//console.log(namesfntrepli);

			//console.log('Replicando');
			toastr.info("Starting replica");
			$.ajax
			({ 
				url: 'repliincomeintegral.php?idfrom='+$("#txtlistciusorig").val()+'&idto='+ $("#txtlistcius").val()+'&fntrepli='+namesfntrepli,			
				type: 'post',
				async:true,
                cache:false,
