<?php
 ...
 <th class="bg-primary "> Port IN UL </th>
 <th class="bg-primary "> Port IN DL</th>
 <th class="bg-primary "> Port OUT UL 	</th>
 <th class="bg-primary "> Port OUT DL  </th>
 ...
 <?php
   foreach ($data as $row2) 
   {
	...
	<td><input name="chkprod[]" id="chkprod<?php echo 	$row2['idbusiness']."#".$row2['idproduct']."#".$row2['idrevband']."#".$row2['idbandnn']  ; ?>" value="chkprod<?php echo $row2['idbusiness']."#".$row2['idproduct']."#".$row2['idrevband']."#".$row2['idbandnn'] ; ?>"  class="chkclassmarco" type="checkbox" > <?php echo  $row2['namebusiness'];  ?></td>
	   ...
	   echo "<td>".$row2['descriptioninul']."</td>";
	   echo "<td>".$row2['descriptionoutul']."</td>";
	   echo "<td>".$row2['descriptionindl']."</td>";
	   echo "<td>".$row2['descriptionoutdl']."</td></tr>";
   }
