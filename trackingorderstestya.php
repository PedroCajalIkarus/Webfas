                        ...
                        $sqlbusco ="select distinct  1 as orr, orders.idorders  ,
                            ...
                            ,        tienecalibracion.totalpass::int as tienecalibration_totalpass, tienecalibracion.calibrationscript::int as tienecalibration_calibrationscript,
                                        ...
                                        ,       0 as tienecalibration_totalpass, 0 as tienecalibration_calibrationscript,
                                         ...
                                         and products.idproduct in (select distinct idproduct from fnt_select_allproducts_maxrev() where iduniquebranchsonprod like '%001000010094%' )
                                  ...
                                  //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                if ( $rowbuscawo['tienecalibracion_idruninfo'] >0)
                                                {
                                                      if( $_if_auto_test_box_calibration == "N"  )
                                                      {
                                                            ...
                                                            <?php
                                                              ...
                                                              else
                                                              {
                                                                  ...
                                                                  {
                                                                    ?>
                                                                      <div class="step <?php echo  $activo_paso3; ?>">  <a href="#" onclick="show_info('calibrationentermater','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_calib; ?>','<?php echo $rowbuscawo['tienecalibracion_idruninfo']; ?>')"> <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Calibration  <br> <?php echo $activo_paso3_totalpass; ?></span></a></b> </div>
                                                                      <?php
                                                                  }
                                                                  else
                                                                  {
                                                      ...
                                                      else
                                                      {
                                                              ...
                                                              {
                                                                ?>
                                                                  <div class="step <?php echo  $activo_paso3; ?>">  <a href="#" onclick="show_info('calibrationyburchk','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_calib; ?>','<?php echo $rowbuscawo['tienecalibracion_idruninfo']; ?>')"> <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Calibration & Burnin Check<br> <?php echo $activo_paso3_totalpass; ?></span></a></b>
                                           ...
                                           if ($rowpasos['stepfunction']=="wo_calibrationent_analogbda")
                                           {
                                            ...
                                            ?>
                                            <div class="step "> 
                                            <a href='#' onclick='attachanalogbda(<?php echo  $v_idp ?>,"ANALOGBDA_<?php echo  $psswdtkkey;?>","<?php echo $rowbuscawo['wo_serialnumber']; ?>")'>
                                                
                                                <span class="icon">  
                                                <i class="fa fa-file"></i> </span> 
                                               <span class="text">Calibration <br></span>
                                               </a>
                                             </div>
                                            <?php
                                               }
                                               else
                                               {
                                                ...
                                                ?>
                                                <div class="stepverde  active "> 
                                                <a href='#' onclick='attachanalogbda(<?php echo  $v_idp ?>,"<?php echo $_tiene_attach_analogbda;?>","<?php echo $rowbuscawo['wo_serialnumber']; ?>")'>
                                               
                                                <span class="icon">  <i class="fa fa-file"></i> </span>
                                                   <span class="text">Calibration AnalogBDA<br></span> 
                                               </a>
                                                 </div>
                                                <?php
                                               }
                                                        ...
                                                        $Sql_ifautotesttotalpass = $connect->prepare(" select v_boolean::integer as vbooleanint  from fas_outcome_integral where reference in ( 
                                                         ...
                                                         //  echo "aaaaaaaaaaaaaaaaaaaaaa".$row_autotestmtotalpass['vbooleanint'];
                                                            ...
                                                            else
                                                            {
                                                              ...
                                                              ?>
                                                          <div class="step  active">  <a href="#" onclick="show_info('calibrationentremmth','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_calib; ?>','<?php echo   $idrun_ent_remoto_mth; ?>',0)"> <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Calibration <br> <?php echo $activo_pasoeth_calib; ?></span></a></b>
                                        ...
                                        //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                      if ( $rowbuscawo['tienecalibracion_idruninfo'] >0)
                                                      {
                                                        if( $digital_module_legacy == "N")
                                                        {
                                                                ...
                                                                ?>
                                                                <div class="step <?php echo  $activo_paso_digital_module_legacy; ?>">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Digital Module <br>  </span></a></b> </div>
                                                                <?php
                                                        ...
                                                        else
                                                        {
                                                          ?>
                                                              ...
                                                              <div class="step <?php echo  $activo_paso_digital_module_legacy; ?>">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Digital Module <br>  </span></a></b>
                                                              <a href='#' onclick='popuplogdb(<?php echo  $rowbuscawo['tienecalibracion_idruninfo']; ?>)'  style='color:#f39323;'> <i class='fas fa-eye'></i> - View Log </a> </div>
                                                            </div>
                                                        <br> 
                                                        </div>
                                                          <?php
                                                      ...
                                                      {
                                                        ?>
                                                        <div class="step <?php echo  $activo_paso_digital_module_legacy; ?> ">  <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text">Digital Module<br></span> </div>
                                                        <?php
                                                      }
                                            ...
                                            //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                          if ( $rowbuscawo['tienecalibracion_idruninfo'] >0)
                                                          {
                                                            if( $activo_paso_calib_legacy == "")
                                                            {
                                                                    ...
                                                                    ?>
                                                                    <div class="step  ">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Calibration 2 <br>  </span></a></b> </div>
                                                                    <?php
                                                            ...
                                                            else
                                                            {
                                                              ?>
                                                                  ...
                                                                  <div class="step active">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Calibration <br>  </span></a></b>
                                                                  <a href='#' onclick='popuplogdb(<?php echo  $rowbuscawo['tienecalibracion_idruninfo']; ?>)'  style='color:#f39323;'> <i class='fas fa-eye'></i> - View Log </a> </div>
                                                            <br> 
                                                            </div>
                                                              <?php
                                          ...
                                          ///      echo " select * from fnt_select_upgrade_finalsku_ia_detect_lic('".$nombre_ciu_amostrar."','".$elmodelcuiupgrade."') ";
                                              ...
                                              ?>
                                              <div class="stepazul active">
                                              <a href="#" onclick="show_info('orderinfoupgrade','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $idorders_upgrde; ?>','<?php echo $skucalculado; ?>',0,0)">
                                              ...
                                              ?>
                                                ...
                                                <span class='text text-left'>
                                            <a href="#"  onclick="Call_printlabel_upgrade('<?php echo $skucalculado; ?>', '<?php echo $rowbuscawo['wo_serialnumber']; ?>' ,'<?php echo $idorders_upgrde; ?>')">&nbsp; <i class="fas fa-print"></i> - Print Label</a>
                                            <br><a href="printokeyupgrade.php?vido=<?php echo $idorders_upgrde; ?>&sn=<?php echo $rowbuscawo['wo_serialnumber']; ?>" target='_blank' >&nbsp; <i class="fas fa-file-pdf"></i> - View PDF</a>
                                            <br>
                                            <br>   </span> </b>
                                            </a>
                                          </span>
                                             ...
                                             if ($rowpasos['stepfunction']=="auto_burnin" )
                                             {
                                              ...
                                              foreach ($result_ifautotestpp as $row_autotestpp)
                                              {
                                                ...
                                                if ($idruninfoautoburning <>"")
                                                {
                                                 ...
                                                 <a href="#" onclick="show_info('reportburnin','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchk; ?>','<?php echo $idruninfoautoburning; ?>',0)"><span class="icon"><i class="fa fa-box"></i> </span> <span class="text"><b>Auto Burnin<br>
                                                   <?php echo $activo_paso66_totalpass; ?></span></a> </b>
                                                   <a href='#' onclick='popuplogdb(<?php echo $idruninfoautoburning; ?>)'  style='color:#f39323;'> <i class='fas fa-eye'></i> - View Log </a>   </a><br> 
                                               ...
                                               {
                                                   ?>
                                                   <div class="step  "> <span class="icon"><i class="fa fa-box"></i> </span> <span class="text">Auto Burnin<br> </span></div>
                                                   <?php  
                                               }
                                         ...
                                         //  $activo_paso4_totalpass="";
                                              ...
                                              if ( $ciuisenterprice =='Y')
                                                    {
                                                      ...
                                                      $linkreportafter_burning_check="reportafbcoutcome.php";
                                                        ...
                                                        {
                                                          ?>
                                                          <a href="#" onclick="show_info('finalchkenterpriseremoto','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchk; ?>','<?php echo $rowbuscawo['tienefinalchk_idruninfo']; ?>',0)"><span class="icon"><i class="fa fa-box"></i> </span> <span class="text"><b>After Burning Check <br>
                                                          <?php
                                                        }
                                                        if ( $ciuismaster =="Y")
                                                        {
                                                          ?>
                                                          <a href="#" onclick="show_info('finalchkenterprisemaster','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $v_idp; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchk; ?>','<?php echo $rowbuscawo['tienefinalchk_idruninfo']; ?>',0)"><span class="icon"><i class="fa fa-box"></i> </span> <span class="text"><b>After Burning Check <br>
                                                          <?php
                                                        }
                                                      ?>
                                                ...
                                                <br> <a href="<?php echo  $linkreportafter_burning_check; ?>?idsndib=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&iduldl=0&idmb=0&idrun=<?php echo $rowbuscawo['tienefinalchk_idruninfo'];?>" target="_blank">  <i class='fas fa-file-pdf'></i> - View Report</a>
                                                </a><br> 
                                          ...
                                          if ($rowpasos['stepfunction']=="finalcheckrma" &&  $v_sn_have_rma =="Y")
                                          {
                                            ...
                                            ?>
                                                <div class="step "> <span class="icon"><i class="fa fa-box"></i> </span> <span class="text">Final Check <br> </span></div>
                                                <?php
                                                  }
                                                  else
                                                  {
                                                  ?>
                                                    <div class="step active  ">
                                                      <a href="#" onclick="show_info('<?php echo  $tipolinkweb; ?>','<?php echo  $rowbuscawo['wo_serialnumber']; ?>','<?php echo  $idorders_rma ; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchkso; ?>','<?php echo $idruninfo_rma_finalchk; ?>','<?php echo  "0";?>')">
                                                      <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Final Check   </span> <!-- <span class='badge bg-danger'>Not Passed</span> <br> -->
                                                      
                                                      <a href='#' onclick='popuplogdb(<?php echo $idruninfo_rma_finalchk; ?>)'  style='color:#f39323;'> <i class='fas fa-eye'></i>-  View Log </a>
                                                      <br> <a href="<?php echo $namephprma;?>?idsndib=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&amp;iduldl=0&amp;idmb=0" target="_blank">  <i class='fas fa-file-pdf'></i> - View Report</a>
                                                      </a><br> </div>
                                                  <?php
                                                  }
                                                ?>
                                          ...
                                          if ($rowpasos['stepfunction']=="finalinpectionrma" &&  $v_sn_have_rma =="Y")
                                          {
                                           ...
                                           //   echo "test:".$sqldetectchkeo3;
                                              ...
                                              <a href="#" onclick="show_info('Precheckfinalcheck','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo  $rma_nro; ?>','<?php echo $nombre_ciu_amostrar_rma; ?>','Quality Calibration Precheck',0)">
                                                <span class="icon"> <i class="fas fa-tasks"></i> </span> 
                                         ...
                                         //       	echo "test:".$sqldetectchkeo;
                                          ...
                                          if ($rowpasos['stepfunction']=="rma_info" &&  $v_sn_have_rma =="Y")
                                          {
                                            ...
                                            if(  $tiene_rma_laSO  == "Y")
                                            {
                                              ...
                                              ?>
                                              <a href="#" onclick="show_info('orderinfo','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $idorders_rma; ?>','<?php echo $nombre_a_mostrar_en_dvi_paraSO; ?>',0,0)">
                                              <div class="stepazul active "><span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"><b>RMA:<?php echo   $rma_nro; ?> <br>CIU : <?php echo   $nombre_ciu_amostrar; ?><br>SN Assign :  <?php echo $rowbuscawo['wo_serialnumber']; ?></b></span>
                                              </a>  
                                              <a href="#" onclick="Call_printlabel('<?php echo  $nombre_ciu_amostrar; ?>', '<?php echo $rowbuscawo['wo_serialnumber']; ?>' ,'<?php echo  $idorders_rma; ?>')">&nbsp; <i class="fas fa-print"></i> - Print Label</a>
                                              </div>
                                      <?php
                                            }
                                                   ...
                                                   /// echo "1,2,3,4";
                                                    //////////////////////////////////////////////////////////////////////////////////////
                                                      ...
                                                      if ( $steps_polypaste=="Y")
                                                      {
                                                         ...
                                                         <a href="#" onclick="show_info('polypaste','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $rowbuscawo['idordersso']; ?>','Poly Paste','<?php echo $rowbuscawo['tienefinalchk_idruninfo']; ?>',0)">
                                                   
                                                         <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Poly Paste</span>
                                                       </a>
                                                       </div>
                                                       <?php
                                                       }
                                                  ...
                                                  foreach ($resultsofinalchk as $rowspfinalchk)
                                                  {
                                                    ...
                                                    if ( $rowspfinalchk['totalpassso'] ==1)
                                                    {
                                                      ...
                                                      <a href="#" onclick="show_info('<?php echo  $tipolinkweb; ?>','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $rowbuscawo['idordersso']; ?>','<?php echo $nombre_a_mostrar_en_dvi_finalchkso; ?>','<?php echo $rowspfinalchk['idruninfo']; ?>','<?php echo  $idruninfoAfertburnung;?>')">
                                                        ...
                                                        <br><a href="<?php echo $namephp;?>?idsndib=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&amp;iduldl=0&amp;idmb=0&idrunaferbur=<?php echo $idruninfoAfertburnung;?>" target="_blank">  <i class='fas fa-file-pdf'></i> -  View Report </a>
                                                        <br>
                                                        </div>
                                                      <?php
                                                    }
                                                    else
                                                    {
                                                      ...
                                                      <br> <a href="<?php echo $namephp;?>?idsndib=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&amp;iduldl=0&amp;idmb=0" target="_blank">  <i class='fas fa-file-pdf'></i> - View Report</a>
                                                      </a><br> </div>
                                                      <?php
                                                    }
                                                    break;
                                     ...
                                     /*
                                       ...
                                       //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                       ...
                                                       if( $activo_paso_Final_Check == "")
                                                       {
                                                               ...
                                                               ?>
                                                               <div class="step ">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>BBU FAS Calibration<br>  </span></a></b> </div>
                                                               <?php
                                                        ...
                                                        else
                                                        {
                                                          ...
                                                          and fas_outcome_integral.idtype =13";
                                                            ...
                                                            <?php echo $bbU_pass;?>
                                                            <a href='#' onclick='popuplogdb(<?php echo $idruninfobbu; ?>)'  style='color:#f39323;'> <i class='fas fa-eye'></i>-  View Log </a><br >
                                                          <a href="calibbburepot.php?unitsn=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&amp;iduldl=0&amp;idmb=0" target="_blank">  <i class='fas fa-file-pdf'></i> - View Report</a>
                                                          </div>
                                                            <?php
                                                        }
                                       ...
                                       //           echo   "aaaaa".$_if_auto_test_box_calibration;
                                                       ...
                                                       if( $activo_paso_Final_Check == "")
                                                       {
                                                               ...
                                                               ?>
                                                               <div class="step ">   <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text"><b>Final Check <br>  </span></a></b> </div>
                                                               <?php
                                                        ...
                                                        {
                                                          ?>
                                                          <div class="step active ">  <span class="icon">  <i class="fa fa-box"></i> </span> <span class="text">Final Check <br></span>
                                                         <a href="calibrationtopdfconimg.php?idsndib=<?php echo  $rowbuscawo['wo_serialnumber']; ?>&amp;iduldl=0&amp;idmb=0" target="_blank">  <i class='fas fa-file-pdf'></i> - View Report</a>
                                                         </div>
                                                          <?php
                                                        }
                                               ...
                                               /////////////////// VAMOS POR LOS PASOS DE SO
                                                ...
                                                ///    tienesoasociada
                                                    ...
                                                    else
                                                    {
                                                     ...
                                                     {
                                                      ?>
                                                      <a href='#' onclick='attachanalogbda(<?php echo  $v_idp ?>,"soinfolegacy_<?php echo  $psswdtkkey;?>","<?php echo $rowbuscawo['wo_serialnumber']; ?>")'>
                                                      <?php
                                                     }
                                                     else
                                                     {
                                                      ?>
                                                      <a href='#' onclick='attachanalogbda(<?php echo  $v_idp ?>,"<?php echo  $_tiene_attach_legacy;?>","<?php echo $rowbuscawo['wo_serialnumber']; ?>")'>
                                                      <?php
                                                     }
                                                     ?>
                                         ...
                                         ///////////////// bbu_calibration //////////////////////////
                                          ...
                                          if ($rowpasos['stepfunction']=="bbu_ann_forms")
                                          {
                                            ...
                                            //   	echo "test:".$sqldetectchkeo;
                                                ...
                                                <a href="#" onclick="show_info('PrecheckBBUANN','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $rowbuscawo['so_soft_external']; ?>','<?php echo $rowbuscawo['modelciu']; ?>','Quality Calibration Precheck',0)">
                                                <span class="icon"> <i class="fas fa-tasks"></i> </span> 
                                                <span class="text">  <b>BBU ANN Acceptance Test <br>SN [<?php echo $rowbuscawo['wo_serialnumber']; ?>] <br></b></span>
                                                <?php
                                                $sqldetectchkeo="SELECT   status_sn  FROM public.fas_survey_responses_bysn where idsurvey in(5,6) and  sn = '".$rowbuscawo['wo_serialnumber']."' and  so = '".$rowbuscawo['so_soft_external']."' and modelciu = '".$rowbuscawo['modelciu']."'
                                                order by datetimecheck desc limit 1 ";
...
// fin// AutoComplete de CUIS version TOP	
  ...
  {
    eModal.iframe('attachfileprojectsoaddmoreanalogbda.php?idt='+lasemillita+'&idord='+vidord+'&vvsn='+vvsn,'Attach files to SN	'+vvsn);
  }
 ...
 //     $("#artSO").collapse("hide"); 
    ...
    {
      eModal.iframe('wopickingsteps.php?elso='+soparam+'&elsn='+snparam+'&elciu='+sotextoamostrar+'&typeworkc=ASSY',' ' + snparam + ' || ' + soparam + ' || ' + sotextoamostrar );
    }
    ////////////////////////////////////////////////////////////////////////////////////////
...
if (desdedonde =='finalchkso')
     ...
     if (desdedonde =='Precheck')
     {
      ...
      eModal.iframe('calibrationqualitychecklist.php?elsn='+snparam+'&elso='+soparam+'&elciu='+sotextoamostrar+'&typeworkm=wo_PRECHECK','Quality precheck');
