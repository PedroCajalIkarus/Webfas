                                                      ...
                                                      ?> <td>
                                                        <?php
                                                                 ...
                                                                 $splicattipo = explode("#", $value  );
                                                                      ...
                                                                      $callsql= " select fnt_select_excel_info_by_idcatidtype_lu('".$sheet->getCell("F".$row)->getValue() ."','".$sheet->getCell("G".$row)->getValue() ."',".$splicattipo[1].",".$splicattipo[2].")";
                                                              //  echo "<br>".$callsql;
                                                                     ...
                                                                     $datos="";
                                                                      foreach ($datadetect as $rowdetect) 
                                                                      {
                                                                          //  echo " ".$rowdetect[0]." ";
                                                                            ...
                                                                            echo $datos->v_string."\r\n";
                                                                           // echo "<br>".$datos->v_string;
                                                                           
                                                                            
                                                                      }
                                                                  //    exit();
                                                                      ?>
                                                        <?php // echo "<br>array:".$value;
