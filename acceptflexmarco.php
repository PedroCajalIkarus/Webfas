...
<!-- Site wrapper -->
  <!-- Navbar -->
   <p align="right"> <a href="acceptancesndib.php?sn=<?php echo  $vparam_vnrounitsn;?>" target="_blank"><img src="iconopdf.jpg" width="30px"></a>
								 </p>
									 ...
									 /// echo "Calibrator:". $obj_result_json->{'userruninfo'};
									  ...
									  $query_lista="SELECT distinct uldl, band ,fas_tree_measure,totalpass::int as totalpassconvert,  fas_tree_measure.iduniqueop,  fas_step.description as namebranch,  fas_tree_measure.iduniquebranch, fas_tree_measure.unitsn, fas_tree_measure.dibsn, fas_tree_measure.uldl, fas_tree_measure.band
										...
										where fas_tree_measure.iduniquebranch = '00E041044' and fas_tree_measure.uldl = ".$rowheaders['uldl']." and fas_tree_measure.band = ".$rowheaders['band']." and dibsn = '".$vparam_vnrounitsn."' and  idrununfo =".$vparam_idruninfo. " ";
												...
												echo "<br>AcceptDiB_Measure_Gain :".$query_lista_Adentro."<br>";
													 ...
													 foreach ($datalsgp as $rowlsgp1) 
														  {
															...
															//	echo $query_lista5a."<br>";
																echo  "<br>query gain:".$row['iduniquebranch']."-->".$query_lista5a;
													 ...
													 foreach ($datalsgp as $rowlsgp1) 
														  {
														   ...
														   echo "<br>query 2 Maxpwr:".$query_lista6;
