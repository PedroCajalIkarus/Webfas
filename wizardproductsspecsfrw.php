...
if($_POST)
	{
		...
		//levantamos los valores ingresamos para modificar
 		$v_txtfpgafile = $_REQUEST['txtfpgafiler'];
		$v_txtmicrofile = $_REQUEST['txtmicrofiler'];
		$v_txtethfile = $_REQUEST['txtethfiler'];
		$v_txtfpgafas = $_REQUEST['txtfpgafasr'];
		$v_txtmicrofas = $_REQUEST['txtmicrofasr'];
		$v_txtethfas = $_REQUEST['txtethfasr'];

		$v_txtcalrstring = $_REQUEST['txtcalrstringr'];
	...
	//	echo "HOla v_txtrfon1: ".$v_txtrfon1;
		...
		try {
				...
				//	echo "<br>chkprod valor de ".$clave2." es: ".$valor2;
					...
					{
					//	echo "1";
						$setear_sql1= " fpgafilename='".$v_txtfpgafile ."' ";
						$sumocoma="S";
					}
					if ($v_txtmicrofile <> "")
					{
						...
						$setear_sql2= $setear_sql2." microfilename='".$v_txtmicrofile ."' ";
						$sumocoma="S";
					}
					if ($v_txtethfile <> "")
					{
						...
						$setear_sql3= $setear_sql3." ethfilename='".$v_txtethfile ."' ";
						$sumocoma="S";
					}
					if ($v_txtfpgafas <> "")
					{
						...
						$setear_sql4= $setear_sql4." fpga_fas='".$v_txtfpgafas ."' ";
						$sumocoma="S";
					}
					if ($v_txtmicrofas <> "")
					{
						...
						$setear_sql5= $setear_sql5." micro_fas='".$v_txtmicrofas ."' ";
						$sumocoma="S";
					}
					if ($v_txtethfas <> "")
					{
						...
						$setear_sql6= $setear_sql6." eth_fas='".$v_txtethfas ."' ";
						$sumocoma="S";
					}
					...
					if ($v_txtcalrstring <> "")
					{
						...
						$setear_sql7= $setear_sql7." calrstring='".$v_txtcalrstring ."' ";
						$sumocoma="S";
					}

					$sqlreplico="insert into fas_confidential_fw
					SELECT idtypeband, idciu, fpgafilename, microfilename, ethfilename, active, customfw, fpga_fas, micro_fas, eth_fas, datelastmodif, usermodif, calrstring, idrevfw+1
						FROM public.fas_confidential_fw
						where idciu = ".$idproduct."  and idrevfw = ".$idrev." and idtypeband = ".$idtipoband;
			//			echo "<br>".	$sqlreplico;
					
					 	$connect->query($sqlreplico);
						$idrevnew=$idrev+1;	
				
					$slqbandupd ="UPDATE public.fas_confidential_fw set ".$setear_sql1.$setear_sql2.$setear_sql3.$setear_sql4.$setear_sql5.$setear_sql6.$setear_sql7." where idciu = ".$idproduct." and  idrevfw =  ".$idrevnew ." and idtypeband = ".$idtipoband;
			//		echo "<br>".$slqbandupd ;
					...
					$msjdegrabo= "Update OK.!";
						/////////////////////////////////////////////////////////////////////////////////////
							...
							$vaccionweb="Repli fas_confidential_fw";
							$vdescripaudit="Replicate fas_confidential_fw -".$valor2;
...
<form name="frma" id="frma" action="wizardproductsspecsfrw.php" method="post" class="form-horizontal">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Wizard Products Firmware</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Wizard Products Firmware</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
function buscardatosfirmware(idfirmware)
{
		$.ajax({
		url: 'ajax_list_fas_firmwarelist.php?id='+idfirmware,										
			cache:false,
		success: function(respuesta) {
			
	///	console.log('a' +respuesta.listfrw);
 		console.log('a' +respuesta.listfrw[0].namefirmware);
		$("#txtfpgafile").val(respuesta.listfrw[0].fpga_file);
		$("#txtfpgafiler").val(respuesta.listfrw[0].fpga_file);
		$("#txtmicrofile").val(respuesta.listfrw[0].micro_file);
		$("#txtethfile").val(respuesta.listfrw[0].eth_file);
		$("#txtfpgafas").val(respuesta.listfrw[0].fpga_fas);
		$("#txtmicrofas").val(respuesta.listfrw[0].micro_fas);
		$("#txtethfas").val(respuesta.listfrw[0].eth_fas);
		$("#txtmicrofiler").val(respuesta.listfrw[0].micro_file);
		$("#txtethfiler").val(respuesta.listfrw[0].eth_file);
		$("#txtfpgafasr").val(respuesta.listfrw[0].fpga_fas);
		$("#txtmicrofasr").val(respuesta.listfrw[0].micro_fas);
		$("#txtethfasr").val(respuesta.listfrw[0].eth_fas);

		$("#txtcalrstringr").val(respuesta.listfrw[0].calrstring);
		$("#txtcalrstring").val(respuesta.listfrw[0].calrstring);
...
//	var losuldl =  $("#losuldl").val().toString();
	...
	console.log('losatributos'+ losatributos);
		...
		//	formData.append("lasmediciones", lasmediciones);
			...
			xhr2.open("POST", "searchcuicomponentfiltersfrw.php");
			xhr2.send(formData);
