...
if ($pos === false) {
  ...
  //  echo "La cadena '$findme' fue encontrada en la cadena ";
   // echo " y existe en la posición $pos";
	...
	$content = $xmlData;
	$fp = fopen("D:\\Digboardlog\\Source\\SAPXMLQA\\".$name_file_po,"wb");
	fwrite($fp,$content);
	fclose($fp);
...
$xmlData= "SrvTest.".$xmlData;
 

$sentenciach = $connect->prepare("INSERT INTO audit_xml_postqa(datetimereceived, textxml)	VALUES (now(),  :textxmlll);");
