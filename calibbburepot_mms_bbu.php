...
///////////////////////////////////////////////////////////////////////////////////////////////		
					...
					where fas_outcome_integral.reference in ( 
						select reference from fnt_select_maxidrun_fas_outcome_integral_byidscrip('".$vparam_vnrounitsn."',54) 
 							)
								 ");
	...
	$idruninfom = $row2['reference'];
	 ...
	 if( $row2['idtype'] ==48)
	 {
		...
		$battery_current_sensor=$row2['v_string'];
			...
			{
				$Temperature_Sensor = $rowdesbattc['description'];
			}
...
?>
                                            ...
                                            <table
                                                class="table table-sm table-hover table-striped table-bordered text-center textotabla10">
                                                <tr>
                                                    <td style='width: 30%;text-align: left'>Calibrator:
                                                        <strong><?php echo $_userfas;?></strong>
                                                    </td>
                                                    <td style='width: 30%;text-align: left'>Datime:
                                                        <strong><?php echo substr($v_datetimeidrun,0,21);?></strong>
                                                    </td>
                                                    <td style='width: 30%;text-align: right'>FAS Version:
                                                ...
                                                <tr>
                                                    <td style='text-align: left'><b>FIP446</b> - FW uC:
                                                        <?php echo 	$_Fw_uC;?> </td>
                                                    <td style='width: 30%;text-align: left'>
                                                        <?php  echo  "<b>FIP446</b> - Fw FPGA:".	$_Fw_fpga;?>
                                                        <?php
if ($_Fw_eth <> '0.0.0')
{
	echo "<br><b>FIP446</b> - Fw Rabbit: ".$_Fw_eth;
}
?>
	...
	echo $idruninfomreq;
                                                ...
                                                <tr>
                                                    <td style='text-align: left'> <b>FIP519</b> - FW uC:
                                                        <?php echo $_Fw_fip519_uc;?> </td>
                                                    <td style='width: 30%;text-align: left'>
                                                        <?php  echo  "<b>FIP519</b> - HW:".	$_Fw_fip519_hw;?>
                                                        <?php
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='text-align: left'>Battery Charger: <strong>
                                                            <?php echo 	$battery_charger; ?> </strong></td>
                                                    <td style='width: 30%;text-align: left'>Temperature Sensor: <strong>
                                                            <?php echo $Temperature_Sensor; ?> </strong> </td>
                                                    <td style='width: 30%;text-align: right'></td>
 ...
 //section_create_table_system_voltage_BBUHP_by_idrun_sn($idruninfom,);
	...
	$elsqlvalue="
			select *, '' as instancem from fas_outcome_integral where reference in 
				...
				and  idfasoutcomecat in (11,5) and idtype in (201,202,204,203,200,207,101,102,11,100)
				union 
				select * , '' as instancem from fas_outcome_integral where reference in 
				(				
			...
			where  idfasoutcomecat in(5)  and idtype in (0,58,7,12,21,97)
	...
	///		echo "<hr><br>SYSTEM STATUS:<br>".$elsqlvalue3."<br><br>";
				...
				foreach ($resultdescmcbatt as $rowalarm) 
					{
						...
						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']==0 ) {    $v_alarm_normal_acpower_status_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']==0 ) {    $v_alarm_normal_acpower_status_off= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']==58 ) {    $v_alarm_normal_acpower_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']==58 ) {    $v_alarm_normal_acpower_off= $rowalarm['v_boolean'];    }	
					 
						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_lossnormal_acpower_status_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_lossnormal_acpower_status_off= $rowalarm['v_boolean'];   }
						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 7 ) {    $v_alarm_lossnormal_acpower_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 7 ) {    $v_alarm_lossnormal_acpower_off= $rowalarm['v_boolean'];   }

						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_lbatt_chr_fail_status_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_lbatt_chr_fail_status_off= $rowalarm['v_boolean'];   }
						if (   $rowalarm['instancem']=='0850A2104' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 12 ) {    $v_alarm_lbatt_chr_fail_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850A2105' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 12 ) {    $v_alarm_lbatt_chr_fail_off= $rowalarm['v_boolean'];   }

						if (   $rowalarm['instancem']=='085117118' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_battdisconect_status_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='085117119' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_battdisconect_status_off= $rowalarm['v_boolean'];   }
						if (   $rowalarm['instancem']=='085117118' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 21 ) {    $v_alarm_battdisconect_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='085117119' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 21 ) {    $v_alarm_battdisconect_off= $rowalarm['v_boolean'];   }

						if (   $rowalarm['instancem']=='0850C8112' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_annun_status_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850C8106' && $rowalarm['idfasoutcomecat']==1 && $rowalarm['idtype']== 0 ) {    $v_alarm_annun_status_off= $rowalarm['v_boolean'];   }
						if (   $rowalarm['instancem']=='0850C8112' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 97 ) {    $v_alarm_annun_on= $rowalarm['v_boolean'];    }	
						if (   $rowalarm['instancem']=='0850C8106' && $rowalarm['idfasoutcomecat']==5 && $rowalarm['idtype']== 96 ) {    $v_alarm_annun_off= $rowalarm['v_boolean'];   }
					}
...
?></td>
                                                        ...
                                                        <td style="text-align: left"><?php echo $v_VBAT1_value_5_101 ;?>
                                                            V</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left">
...
?></td>
                                                        ...
                                                        <td style="text-align: left"><?php echo $v_VBAT2_value_5_102 ;?>
                                                            V</td>
                                                    </tr>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo $v_Alarm_boardtemp_value_5_11 ;?> °C</td>
...
?></td>
                                                        ...
                                                        <td style="text-align: left">
                                                            <?php echo $v_Alarm_batterytemp_value_5_100;?> °C</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><?php if ( $v_alarm_normal_acpower_on ==0 && $v_alarm_normal_acpower_off==1 )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_alarm_normal_acpower_on ==0   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if (   $v_alarm_normal_acpower_off==1)
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?>
	 ...
	 inner join (
			...
			on fas_step.instance = fas_routines_steps.instance
			where idruninfodb = ". $idruninfom."   and iduniqueop > 0
			and fas_step.instance  in('08A','0C9'	)
		 ) as tdosmm
	 on tdosmm.iduniqueop = fas_outcome_integral.reference
...
(
 ...
 on fas_outcome_integral.reference =     todosm3.id_outcome
 where  idfasoutcomecat in(5)  and idtype in (50,51,52,53,54,55,56,57)
	 
	 
	  
		  
			 ";
	///	 echo "<br>a verrrrrr  ----->>  ". $elsqlvalueled;
		 ...
		 foreach ($resultleds as $rowbbuacpt4a) 
		 {
			 ...
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==0  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==50 ) {  $v_led_0_5_50_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==1  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==51 ) {  $v_led_1_5_51_forced_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==2  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==52 ) {  $v_led_2_5_52_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==3  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==53 ) {  $v_led_3_5_53_forced_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==4  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==54 ) {  $v_led_4_5_54_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==5  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==55 ) {  $v_led_5_5_55_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 																																						   
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==6  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==56 ) {  $v_led_6_5_56_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==7  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==57 ) {  $v_led_7_5_57_forced_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==50 ) {  $v_led_8_5_50_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==51 ) {  $v_led_8_5_51_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==52 ) {  $v_led_8_5_52_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==53 ) {  $v_led_8_5_53_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==54 ) {  $v_led_8_5_54_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==55 ) {  $v_led_8_5_55_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==56 ) {  $v_led_8_5_56_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='08A'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==57 ) {  $v_led_8_5_57_forced_on = $rowbbuacpt4a['v_booleanm'] ;}
...
?>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left">Normal AC Power </td>
                                                        <td style="text-align: center"><?php if ( $v_led_status ==1 )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_0_5_50_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_1_5_51_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_2_5_52_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_3_5_53_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_4_5_54_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_5_5_55_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_6_5_56_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
?></td>
                                                        ...
                                                        <td style="text-align: center">
                                                            <?php if ( $v_led_7_5_57_forced_on ==1   )
{
	?><span class="badge bg-green">Pass</span><?php
}
else
...
(
 ...
 on fas_outcome_integral.reference =     todosm3.id_outcome
 where  idfasoutcomecat in(5)  and idtype in (60,61,62,63,64,65,66,67)
	...
	///	 echo "<br>a verrrrrr  RELays ----->>  ". $elsqlvalueledrelays;
		 ...
		 foreach ($resultleds as $rowbbuacpt4a) 
		 {
			 ...
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==0  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==60 ) {  $v_relays_0_5_60_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==1  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==61 ) {  $v_relays_0_5_61_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==2  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==62 ) {  $v_relays_0_5_62_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==3  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==63 ) {  $v_relays_0_5_63_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==4  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==64 ) {  $v_relays_0_5_64_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==5  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==65 ) {  $v_relays_0_5_65_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==6  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==66 ) {  $v_relays_0_5_66_on = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==7  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==67 ) {  $v_relays_0_5_67_on = $rowbbuacpt4a['v_booleanm'] ;}

			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==60 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==61 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==62 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==63 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==64 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==65 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==66 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
			 if (   $rowbbuacpt4a['instancem']=='0C9'  && $rowbbuacpt4a['indexmeasure']==8  && $rowbbuacpt4a['idfasoutcomecat']==5 && $rowbbuacpt4a['idtype']==67 ) {  $v_relays_8_5_60_off = $rowbbuacpt4a['v_booleanm'] ;}
...
?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><?php if ( $v_relays_status ==1 )
	{
		?><span class="badge bg-green">Pass</span><?php
	}
	else
                                                    ...
                                                    <tr>
                                                        <td colspan="7" style="text-align: left">
                                                            <B> <br>* The system status values has been read under
                                                                ...
                                                                IBAT ≈ 0 and the BDA without any RF signal injection.
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12    " id="divgraph4" name="divgraph4">
                                                            ...
                                                            <p class="colorazulfiplex"
                                                                style="font-size:14px;  text-align: center;">
                                                                <b>INDIVIDUAL BATTERY VOLTAGE</b>
                                                            </p>
                                                            <div class="chart">
...
function armar_graficos_imdstress() {
    ...
    ///////////////////////
    $.ajax({
        url: 'ajax_graph_reportstressbbumms.php?unitsn=' + params.get('unitsn') + '&idrun=' + params.get(
            'idrun'),
        ...
        success: function(data) {
            ...
            data_values_Battery_Voltage_veload = data.values_Battery_Voltage_veload.split(",");
