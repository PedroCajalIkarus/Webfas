                ...
                <div class="step <?php echo  $activo_paso3; ?>">
                    <a href="#"
                        ...
                        <span class="icon">
                            ...
                            class="text"><?php echo '['.$vv_step_nro_ary.'] - '; ?><b>MMS [RF] <br>
...
else
{
  ?>
                    <div class="step ">
                        ...
                        <span class="icon">
                            <i class="fas fa-box"></i> </span> <span class="text">
                            <?php echo '['.$vv_step_nro_ary.'] - '; ?><b>MMS [RF] <br>
                            </b></span>
             ...
             //    echo $vv_worcenter."--".$vv_sn."--".$vv_idp."--".$vvnombre_a_mostrar_en_dvi."--".$vv_soworam."--".$vv_modelciu."--<br>";
                 ?>
                        ...
                        <a href="#"
                            ...
                            <span class="icon"> <i class="fas fa-tasks"></i> </span>
                            <span class="text"> <b><?php echo  '['.$vv_step_nro_ary.'] - '.substr($vv_worcenter,3,12);?>
                                    <br>SN
                                    [<?php echo $vv_sn; ?>]
                                    <br></b>
