...
$encontrealgo="N";
$query_lista="select distinct woparam,powersupply,coalesce(dlgain,'9999') as dlgain,coalesce(ulgain,'9999') as ulgain,coalesce(dlmaxpwr,'9999')as dlmaxpwr, coalesce(ulmaxpwr,'9999') as ulmaxpwr, objectband.idband, coalesce(objectband.idband,9999) as idbandifnull, fstartul, fstopul, fstartdl, fstopdl , idband.description , coalesce(fas_instruments_parameters.idproduct ,0) as haveconfiguration,
CASE  
