          ...
          <section class="col-lg-5 connectedSortable ui-sortable">
			<div class="card">
			   ...
			   <div class="container-fluid">
						   ...
						   <h3 class="card-title"> <span name="iconolog" id="iconolog"><i class="fa fa-fw fa-list-alt"></i></span>&nbsp; Modules / Branching
 list</h3>
	<br>						
<hr>
...
<div class="table-responsive"> 
			     <table class="table table-striped table-bordered table-sm table-response" name="example1" id="example1">
				  <thead>
					<tr>
					 <th class="bg-primary">BOMS</th>
		  ...
		  <?php
		  	...
		  	$query_lista = "select distinct  boms.idboms  , '000000' as iduniquebranchprod, 0, partnumber, partdescription,'a'
from boms
inner join boms_parts
on boms_parts.idbomsparts  = boms.idboms and
( boms_parts.partclass = 'null' or partclass='0-AS') and  vendor_id = 48  ";
	...
	foreach ($data as $row) {			
				...
				?>
				<tr>
					<td  class="text-center"> <?php echo $row['partnumber'];?></td>
					<td > <?php echo $row['partdescription'];?></td>
					<td  class="text-center"><?php echo $row['rev'];?>0</td>
					<td  class="text-center">
					
					<a href='#' onclick="mostramoscomponente(<?php echo $row['idboms']; ?>,'<?php echo $row['partnumber']; ?>')"><i class='far fa-eye'></i></a>
...
<?php				
		...
		<div class="card ">							
			 <div class="container-fluid">
			         <div class="card-header border-0">
						   <h3 class="card-title"> <span name="iconolog" id="iconolog"><i class="fa fa-fw fa-list-alt"></i></span>&nbsp;Component list 
						   
						   <span id="lblproductsearch" name="lblproductsearch" class="colorazulfiplex"> </span></h3>
	<br>						
<hr>
	...
	$( document ).ready(function() {
		...
		//FIN mostrar hora live
			...
			$("#detallelog").text("");
				...
				$('#example1').DataTable( {
				"order": [[ 0, "desc" ]],  "paging": true,  "pageLength": 20
				} );
...
function mostramoscomponente(splt_a_filtrar, labelshowinfo)
{
...
//	var ressultspli = splt_a_filtrar.split('#');
	...
	var armando_tabla= '';
								$.ajax({
										url: 'listbomsparts.php?p0='+splt_a_filtrar,										
										 cache:false,
