          ...
          <section class="col-lg-6 connectedSortable ui-sortable">
			...
			<!-- aca form -->			
				...
				//		$queryquefiltramos=" and pre.date_approved > '".date(Y)."-01-01 00:00:00' ";
					...
					<!--- demo acordion--->
					&nbsp;<b>(*) -  <a href='listpresales.php?qqdays=30'>Show last 30 days</a>    ||  <a href='listpresales.php?qqdays=1500'>View All </a></b>
...
, orders_attributes.v_boolean::integer as isupgrade,  products_attributes.idattribute , COALESCE(products_attributes.idattribute,0) as haveupgrade  ,min(orders_attributesrabbit.v_boolean::integer) as 	haverabbit  , products.active as activeprod
from orders as pre
...
where ".$filtrer_date_marco."  ( (pre.typeregister = 'PO' and pre.active <>'N'   ) or (pre.typeregister = 'SO' and pre.active <>'N'   ) or (pre.typeregister = 'UP'   ) 
".$queryquefiltramos." )
group by products.idproduct , pre.idcustomers, namecustomers ,  orders_sn.ponumber ,orders_sn.so_soft_external, pre.active,fassrverror, pre.processfasserver, pre.idorders,pre.idrev,  products.modelciu , quantity,  pre.date_approved ,  orders_attributes.v_boolean, products_attributes.idattribute   
,products.active 
order by  datestate desc	");
				...
				//		}
					...
					//	}
					 ...
					 <td class="font-weight-bold"><span class="badge badge-primary right" title="Quantity"><?php 
					 if( $row['activeprod']=="Y")
					 {
							   ...
							   <?php
								...
								else
								{
									...
									else
									{
										...
										{
											?>
										<div class="progress-bar bg-secondary" style="width: 0%"><span class="text-warning" > Pend. SN Asign for Upgrade  <i class="fas fa-solid fa-bell"></i></span></div>
										<?php
										}
										else
										{										
              ...
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
					...
					<li class="nav-item" name="diveq" id="diveq">
                      <a class="nav-link " href="#sosnupgrade" data-toggle="tab">SO / SN Assing for Upgrade </a>
                    </li> 		
                  </ul>
                </div>
              </div><!-- /.card-header -->
		 ...
		 $.ajax
			({ 
				...
				//	console.log('abc'+data.length+'----'+data.ps[0].descripcion+'////'+ data.ps[0].idpresales);
					 ...
					 {
						console.log('ABCCCCC');
						tabla_info_show_po=tabla_info_show_po+"<tr><td class='text-danger'>aaa</td><td>bbbbbbbbbbd</td><td></td><td></td></tr>";
					 }
