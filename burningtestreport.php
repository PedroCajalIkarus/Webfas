        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Burning Test </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="col-lg-12 connectedSortable ui-sortable">
   ...
   // Equalization --> Ripple
 	$sql= "select distinct  idband.*
		...
		where  idorders IN (  select  idorders from orders_sn where  wo_serialnumber = '".$v_sn."' order by typeregister limit 1 ) AND typedata = 'UNIT' limit 1  ";
...
///echo 	$sql;
		...
		///		section_create_graph_EQ_TOTAL_RX_TX($rowbandas['description'], 'm'.$rowbandas['idband'].$namedivxband,$vv_idrununfo,  $rowbandas['idbandforfas']) ;
           ...
           section_create_graph_LevelRead_burningtest($rowbandas['description'], 'm'.$rowbandas['idband'].$namedivxband,$vv_idrununfo,  $rowbandas['idbandforfas'],$v_sn) ;
