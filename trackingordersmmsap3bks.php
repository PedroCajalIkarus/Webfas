    ...
    <div class="card-footer">
       ...
       <hr>
           ...
           orders.quantity,orders_sn.so_soft_external, orders_sn.wo_serialnumber 
                       ...
                       where orders.idorders =".$v_idp."     and orders_sn.idnroserie >0    ";
            echo  $sqlbusco;
     ...
     //    echo  $query_xml;
       ...
       //           echo  "<br>a::".$rowxml['jsonmm'];
              ...
              //   echo "ojo aca la cant es;".$longitud;
                ...
                //        echo "<br>String contiene: ".$arrmmobj['v_string'];
                        ...
                        if ( $arrmmobj['idattribute_orders'] == 21)
                        {
                          ...
                          array_push($arraysteps_name,$arrmmobj['v_string']);
                          $qq_components_xml =  $qq_components_xml +1;
                      //    echo "<br>la Cantidad ". $qq_components_xml."es: ".$arrmmobj['v_string'];
                        }
                  ...
                  //    print_r($arraysteps_name);
                   ...
                   //   print_r($arraysteps_name);
                      for($immt=0; $immt< $qq_components_xml; $immt++)
                      {
                        ...
                        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ///////////////// wo_info_step1 //////////////////////////  
                                if  ($arraysteps_name[$immt]  =="ASSY" || $arraysteps_name[$immt]  =="2ND-ASSY")
                                {
                                 ...
                                 orders.quantity,orders_sn.so_soft_external, orders_sn.wo_serialnumber 
                                             ...
                                             where orders_sn.so_soft_external = '".$rowbuscawo['so_associed']."' and wo_serialnumber ='". $rowbuscawo['wo_serialnumber']."'"; 
                                         //    echo $query_wo;
                                  ...
                                  <a href="#" onclick="show_info('orderinfo','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo  $idorderwo ; ?>','<?php echo $nombre_a_mostrar_en_dvi; ?>',0,0)">
                                
                                  <span class="icon"> <i class="fa fa-check"></i> </span>
                                      <span class="text text-left">
                                    
                                      <b>  <?php echo "".$rowpasos['nametrackingstepsshow']."<br>"; ?>   
                                      WO: [<?php echo $rowbuscawo['so_associed']; ?>]<br>CIU: [<?php echo  $modelciuwo; ?>]</b> 
                                  ...
                                  <a href="#"  onclick="Call_printlabel('<?php echo  $modelciuwo; ?>', '<?php echo $rowbuscawo['wo_serialnumber']; ?>' ,'<?php echo  $idorderwo ; ?>')"><i class="fas fa-print"></i> - Print Label
                                ...
                                <br>
                                  ...
                                  ///  	echo "test:".$sqldetectchkeopicki;
                                      ...
                                      <a href="#" onclick="show_info('picking','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $elsowomarco; ?>','<?php echo $elmodelciu; ?>','Quality Calibration Precheck',   '<?php echo $arraysteps_name[$immt]  ; ?>'  )">
                                      <span class="icon"> <i class="fas fa-tasks"></i> </span> 
                                      <span class="text">  <b><?php echo  $arraysteps_name[$immt];?>  <br>SN [<?php echo $rowbuscawo['wo_serialnumber']; ?>] <br></b></span>
                                    <?php
                                    $sqlmaxhistory = " select * from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = '".$arraysteps_name[$immt]."' and
                                    runinfodate in (
                        select max(runinfodate) from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = '".$arraysteps_name[$immt]."')
                        ...
                        ";
                               ///     echo $sqlmaxhistory;
                                ...
                                {
                                  if  ($arraysteps_name[$immt]  =="PRECHECK")
                                  {
                                       /////**************PRE CHEQUEO************************************** 
                        ...
                        ";
                                  ...
                                  else
                                  {
                                    ...
                                    $mustroostrep='N';
                                     ///preguntasmos si es RWK.. 
                                     //--if (str_contains($string, 'lazy')) { 
                                      if (strpos($arraysteps_name[$immt],"RWK") !== false)                                      
                                      {
                                        $mustroostrep='N';
                                        if ($arraysteps_name_sn[$immt]==$rowbuscawo['wo_serialnumber'])
                                        {
                                          $mustroostrep='Y';
                                        }
                                      }
                                 ...
                                 //     echo $arraysteps_name[$immt]."a verrr".$mustroostrep;
                                ...
                                ?>
                                        ...
                                        <span class="icon"> <i class="fa fa-check"></i> </span>
                                          <span class="text text-center">
                                            ...
                                            <?php echo "".$arraysteps_name[$immt] ."<br>".$arraysteps_name_sn[$immt] ."<br>"; ?>   
                                    ...
                                    $sqlmaxhistory = " select * from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = '".$arraysteps_name[$immt]."' and
                                    runprocessdate in (
                        select max(runprocessdate) from fas_to_sap_xml where v_sn ='".$rowbuscawo['wo_serialnumber']."' and v_workcenetr = '".$arraysteps_name[$immt]."')
                        ...
                        ";
                                  //   echo $sqlmaxhistory;
                                      ...
                                      foreach ($datahist as $row2hh) 
                                      {
                                        ...
                                        $tooltipamostrar ="";
                                        $sqlackresult = "select * from fas_sap_filesxml_attribute where idruninfo in( 
                                          select idruninfoack from fas_to_sap_xml_history where idruninfo = ".$row2hh['idruninfo']." and runprocessdate in (
                                          select max (runprocessdate) from fas_to_sap_xml_history where idruninfo = ".$row2hh['idruninfo'].")
                                        
                                        ) and idattributeord in (56,57,59) ";
                                     ///   echo $sqlackresult;
                                        ...
                                        foreach ($dataack as $rowackm) 
                                        {
                                          ...
                                          if ($row2hh['v_state']==0)
                                          {
                                            echo "<span class='badge bg-secondary' title='". $tooltipamostrar."'>SAP::Pending RESORD</span>";
                                          }
                                          if ($row2hh['v_state']==1)
                                          {
                                            echo "<span class='badge bg-warning' title='". $tooltipamostrar."'>SAP::Run</span>";
                                          }
                                          if ($row2hh['v_state']==2)
                                          {
                                            echo "<span class='badge bg-warning' title='". $tooltipamostrar."'>SAP::Pending ACK</span>";
                                          }
                                          if ($row2hh['v_state']==3)
                                          {
                                            echo "<span class='badge bg-danger' title='".$tooltipamostrar."'>SAP::Error </span>";
                                          }
                                          if ($row2hh['v_state']==4)
                                          {
                                              echo "<span class='badge bg-info' title='". $tooltipamostrar."'>SAP::OK ACK</span>";
                                          }
                                          if ($row2hh['v_state']==5)
                                          {
                                              echo "<span class='badge bg-danger' title='". $tooltipamostrar."'>SAP::Error ACK</span>";
                                          }
                                         /// echo "<br>".$row2hh['v_state_result'];
                                      }  
                                    ?>
                ...
                else
                {
                  ...
                  $nombre_ciu_amostrar = $rowbuscawo['modelciu']
                  ?>
                  <a href="#" onclick="show_info('orderinfo','<?php echo $rowbuscawo['wo_serialnumber']; ?>','<?php echo $rowbuscawo['idorders']; ?>','<?php echo $nombre_a_mostrar_en_dvi_paraSO; ?>',0,0)">
                  <div class="stepazul active "><span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"><b>SO:<?php echo $rowbuscawo['so_soft_external']; ?> <br>CIU : <?php echo  $rowbuscawo['modelciu']; ?><br>SN Assign :  <?php echo $rowbuscawo['wo_serialnumber']; ?></b></span>
                  </a>  
                  <a href="#" onclick="Call_printlabel('<?php echo $rowbuscawo['modelciu']; ?>', '<?php echo $rowbuscawo['wo_serialnumber']; ?>' ,'<?php echo $rowbuscawo['idordersso']; ?>')">&nbsp; <i class="fas fa-print"></i> - Print Label</a>
                  </div>
